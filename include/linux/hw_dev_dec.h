...
enum hw_device_type {
    ...
    DEV_CONNECTIVITY_WIFI = DEV_CONNECTIVITY_START,// 31
    DEV_CONNECTIVITY_BT,// 32
    DEV_CONNECTIVITY_FM,// 33
    DEV_CONNECTIVITY_GPS,// 34
    DEV_CONNECTIVITY_GPU,// 35
    DEV_CONNECTIVITY_MAX,// 36
};
