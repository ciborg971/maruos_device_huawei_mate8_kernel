...
static inline int dwc3_otg_init(struct dwc3 *dwc) { return 0; }
static inline void dwc3_otg_exit(struct dwc3 *dwc) {}
static inline int dwc3_otg_work(struct dwc3_otg *dwc_otg, int evt) { return 0; }
static inline int dwc3_otg_resume(struct dwc3 *dwc) { return 0; }
static inline int dwc3_otg_suspend(struct dwc3 *dwc) { return 0; }
static inline int dwc3_otg_id_value(struct dwc3_otg *dwc_otg) { return 0; };
#endif
