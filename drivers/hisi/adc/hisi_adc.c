...
static void adc_complete_func(rproc_msg_t *ack_buffer,
...
static int adc_send_ipc_to_lpm3(int channel)
{
	...
	do {
		ret = RPROC_ASYNC_SEND(ADC_RPROC_SEND_ID, (mbox_msg_t *)hisi_adc_dev->tx_msg, ADC_IPC_CMD_LEN, ASYNC_MSG, adc_complete_func, NULL);
		loop--;
