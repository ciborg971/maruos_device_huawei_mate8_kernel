...
extern VOS_UINT32  At_CheckNdisIpv4AddrPara(
           VOS_UINT8                          *pData,
           VOS_UINT16                          usLen);
extern VOS_UINT32 AT_CheckNdisIpv6AddrPara(
           VOS_UINT8                          *pData,
           VOS_UINT16                          usLen
       );
...
extern VOS_UINT32 AT_NdisIpv6AddParaProc(
           VOS_UINT8                          *pData,
           VOS_UINT16                          usLen,
           VOS_UINT8                          *pDesData,
           VOS_UINT32                         *pulFlag
...
extern VOS_UINT32  AT_SetNdisIpv4v6AddPara(
           VOS_UINT8                           ucIndex
       );
extern VOS_UINT32 AT_SetNdisIpv6AddPara(
           VOS_UINT8                           ucIndex
       );
extern VOS_VOID AT_SetNumAttribute(
