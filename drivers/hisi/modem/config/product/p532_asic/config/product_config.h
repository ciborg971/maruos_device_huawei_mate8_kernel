/* MD5: 049cc33ef74ee2fc43475b82cca0f8b0*/
...
#define LPHY_TOTAL_IMG_SIZE ((LPHY_PUB_DTCM_SIZE)+(LPHY_PUB_ITCM_SIZE)+(LPHY_LTE_DTCM_SIZE)*1+(LPHY_LTE_ITCM_SIZE)*1+(LPHY_TDS_DTCM_SIZE)+(LPHY_TDS_DTCM_SIZE)) 
#endif 
...
#define PRODUCT_CFG_FLASH_DSP_LEN  		 0x300000 
#endif 
