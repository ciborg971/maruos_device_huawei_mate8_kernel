...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_NEW_RF_INTERFERE_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 控制TDS/LTE的天线开关,目的是避免B39和B3的干扰(NEW)
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                  uhwFuncOn;                      /* 0-不使能，1-使能 */
    ...
    VOS_UINT32                                  uwGpioRxValue;                  /* 关闭TDS/LTE发射的线控 */
    VOS_UINT32                                  uwGpioDefaultValue;             /* TDS/LTE发射的线控默认值 */
    VOS_INT16                                   shwStartFuncRssi;               /* 低于此门限，则启动功能的rssi能量值(dbm) */
    VOS_INT16                                   shwStopFuncRssi;                /* 高于此门限，则关闭功能的rssi能量值(dbm) */
}UCOM_NV_GSM_NEW_RF_INTERFERE_CTRL_STRU;
...
typedef struct
{
    VOS_UINT16                          uhwEtDpdIndexMode;                      /* 0: 功率模式; 1:Apc setting  */
    UCOM_NV_W_DPD_LUT_THRESHOLD_STRU    stDpdThreshold;                         /* DPD LUT切换门限 */
}UCOM_NV_W_DPD_LUT_INDEX_STRU;
...
typedef struct
{
    ...
    VOS_INT16                           shwSweetOffset;                         /* ET Time Delay校准步进值 */
