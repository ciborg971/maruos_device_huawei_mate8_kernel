...
typedef struct
{
    ...
    VOS_UINT32              ucBitNotBandScanFlg      :1; /* 接入层发起的搜索,OOS等是否进行 band搜索*/
    VOS_UINT32              ucBitBandScanAll         :1; /* 如果需要扫频，是否扫所有UE支持频段*/
    VOS_UINT32              ucBitTddOrFddorNoPrio    :2; /* 频点和频段搜索优先级,TDD优先还是FDD优先*/
    VOS_UINT32              ucBitReestabNotBandScan  :1; /* 重建立不扫频，只搜历史*/
    VOS_UINT32              ucBitReestabBandScanAll  :1; /* 重建立扫频扫全频段*/
    VOS_UINT32              ucBitRsv2                :1;
...
typedef struct
{
    ...
    VOS_UINT32              ucBitRsv0                :1;
    VOS_UINT32              ucBitRsv1                :1;
    VOS_UINT32              ucBitRsv2                :1;
    VOS_UINT32              ucBitRsv3                :1;
    VOS_UINT32              ucBitRsv4                :1;
    VOS_UINT32              ucBitRsv5                :1;
...
typedef struct
{
    ...
    VOS_UINT32              ucBitNotBandScanFlg      :1;  /* 接入层发起的搜索,OOS等是否进行 band搜索*/
    VOS_UINT32              ucBitOnlyScanKnowBand    :1;  /* 接入层发起的搜索,OOS等如果扫频是否只扫已知频段*/
    VOS_UINT32              ucBitReestabNotBandScan  :1;  /* 重建立不扫频，只搜历史*/
    VOS_UINT32              ucBitReestabScanKnownBand:1;  /* 重建立扫频只扫已知频段*/
    VOS_UINT32              ucBitRsv4                :1;
    VOS_UINT32              ucBitRsv5                :1;
    VOS_UINT32              ucBitRsv6                :1;
    VOS_UINT32              ucBitRsv7                :1;
...
typedef struct
{
    ...
    VOS_INT16               sB1UtraEcn0;         /* B1事件私有的UTRA的Ecn0最低上报门限，单位1dB*/
...
typedef struct
{
    ...
    VOS_INT16               sReselDeltaRsrq;          /* LTE模内重选，服务小区RSRQ低于绝对门限，并且邻区比服务小区好usReselDeltaRsrq个DB时重选*/
    VOS_UINT16              usRsv0;
    VOS_UINT16              usRsv1;
    VOS_UINT16              usRsv2;
    VOS_UINT16              usRsv3;
