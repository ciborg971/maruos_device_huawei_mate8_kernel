...
typedef struct
{
    UINT08                              ucReserved;                 /*CTU通道号*/
    UINT08                              ucUlRfChIndex;          /*此band使用的RF通道号*/
    UINT16                              usFreqInfo;             /*频点*/
    RFE_RF_BAND_WIDTH_ENUM_UINT16       enBandWidth;            /*带宽*/
    //LPHY_RFIN_SAMPLE_RATE_ENUM_UINT16   enSampleRate;           /*采样率*/
    UINT16 usApcCode;
...
typedef struct
{
 	UINT08                              ucActRecvAntNum;            /*接收天线数*/
    UINT08                              ucRficClearInd;                 /*CTU通道号*/
    UINT16                              usReserved;
