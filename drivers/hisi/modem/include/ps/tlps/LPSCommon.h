...
enum PS_MSG_ID_SECTION_ENUM
{
    ...
    /* wangnengfei 00316385 begin for dhcp 2015-06-18 */
    /*CDS和Dhcp之间的消息接口取值范围*/
    PS_MSG_ID_DHCP_TO_CDS_BASE = PS_MSG_ID_TL_DT_BASE + 0x100,
    PS_MSG_ID_CDS_TO_DHCP_BASE = PS_MSG_ID_DHCP_TO_CDS_BASE + 0x20,
    /* wangnengfei 00316385 end for dhcp 2015-06-18 */
    /* ... ... */

    /* m00352332 begin 2015-09-28 for LPP ,begin */
    /* LPP和LRRC之间的消息借口取值范围 */
 ...
 */
    ...
    /* Add by wangensheng 00324863 FOR LPP begin */
    UE_MODULE_LPP_ID           = 0xF218
    /* Add by wangensheng 00324863 FOR LPP end */
};
