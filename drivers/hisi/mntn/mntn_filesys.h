...
#define MNTN_FILESYS_DEFAULT_MODE 0660  /*default mode when creating a file or dir if user doesn't set mode*/
 ...
 ***************************************************************************
*/
extern int mntn_filesys_chmod(const char *filename, umode_t mode);
...
extern int mntn_filesys_write_log(const char *pname, void *pbuf, unsigned int ulen, umode_t mode);
