...
#ifndef HI6555_COUL_REGS_UNLOCK
#define HI6555_COUL_REGS_UNLOCK
#endif
...
#ifndef HI6555_COUL_REGS_UNLOCK
#define HI6555V100_REGS_READ(regAddr,buf,size)   hisi_pmic_array_read((int)(regAddr),(char*)(buf),(int)(size))
#else
#define HI6555V100_REGS_READ(regAddr,buf,size)   \
do{\
    if (regAddr > HI6555_COUL_REGS_UNLOCK_START){\
