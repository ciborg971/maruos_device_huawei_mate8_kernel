                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->test_start_flag);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_exist);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_capacity);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_temp);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_full);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_volt);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_cur);
    return status;
}
                  ...
                  const char *buf, size_t count)
{
    ...
    hwlog_info("set %s is %d\n",__FUNCTION__,di->input_batt_fcc);
    return status;
}
