...
enum AUDIO_RECORD_TYPE_ENUM
{
    ...
    AUDIO_RECORD_TYPE_AUDIOCALL = 7,                            /*通话时录音*/
    AUDIO_RECORD_TYPE_BUT
};
typedef unsigned short  AUDIO_RECORD_TYPE_ENUM_UINT16;          /*_H2ASN_Replace typedef VOS_UINT16 AUDIO_RECORD_TYPE_ENUM_UINT16; */
...
enum AUDIO_MSG_ENUM
{
    /*lwx26324 add for external modem @20140327,begin*/
    ...
    /*lwx26324 add for external modem @20140327,end*/
    ...
    ID_AUDIO_BSD_TRIGGER_REQ            = 0xDDC7,           /* 消息转发，BSD语音检测开始or停止 */ /*_H2ASN_Skip */
    ID_AUDIO_BSD_GET_RESULT_REQ         = 0xDDC8,           /* BSD语音检测结果获取 */ /*_H2ASN_Skip */
 ...
 typedef struct
{
    ...
    unsigned short                          uhwReserve;         /*_H2ASN_Replace VOS_UINT16 uhwReserve;*/
    AUDIO_RECORD_TYPE_ENUM_UINT16           enRecordType;       /* 录音类型 */ /*_H2ASN_Replace VOS_UINT16 enRecordType;*/
