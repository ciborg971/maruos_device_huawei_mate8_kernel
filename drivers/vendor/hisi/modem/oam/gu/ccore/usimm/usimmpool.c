...
VOS_UINT32 USIMM_InitUsimEccFile(VOS_VOID)
{
    ...
    pData = (VOS_UINT8 *)VOS_MemAlloc(WUEPS_PID_USIM, DYNAMIC_MEM_PT,
                        USIMM_CCB_GetCurEFInfo(USIMM_GUTL_APP)->usFileLen);/*分配数据存储空间*/
    ...
    VOS_UINT8                           ucChannelID)
{
    ...
    USIMM_EccNumberInd(ucEccType, USIMM_CCB_GetCurEFInfo(USIMM_GUTL_APP)->usFileLen, ucRecordNum, pData);/*上报当前的Ecc号码内容*/
