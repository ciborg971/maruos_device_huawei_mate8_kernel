...
/*****************************************************************************
函 数 名  :USIMM_UICC_InitStoreMeid
...
)
{
    ...
    {
        USIMM_ClearCurEFInfo(USIMM_CCB_GetCurFileInfo(USIMM_GUTL_APP));/*选中DF文件后，上次选中的EF文件置为无效值*/
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitUsimADF: Select File Error");/*打印错误*/
...
)
{
    ...
    if(USIMM_SW_OK == ulResult) /*判断AID选择结果*/
    {
        USIMM_ClearCurEFInfo(USIMM_CCB_GetCurFileInfo(USIMM_CDMA_APP));/*选中DF文件后，上次选中的EF文件置为无效值*/
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitCsimADF: Select File Error");/*打印错误*/
...
)
{
    ...
    if(USIMM_SW_OK == ulResult) /*判断AID选择结果*/
    {
        USIMM_ClearCurEFInfo(USIMM_CCB_GetCurFileInfo(USIMM_IMS_APP));/*选中DF文件后，上次选中的EF文件置为无效值*/
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitIsimADF: Select File Error");/*打印错误*/
...
)
{
    ...
    pData = (VOS_UINT8 *)VOS_MemAlloc(WUEPS_PID_USIM,
                                      DYNAMIC_MEM_PT,
                                      USIMM_CCB_GetCurEFInfo(USIMM_CDMA_APP)->usFileLen);/*分配数据存储空间*/
