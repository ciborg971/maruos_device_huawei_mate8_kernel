...
OBC_LOCAL_SRC_FILE += \
    ...
    $(BSP_DIR)/drivers/pmu_new/pmu_test.c  \
...
#pa_rf
ifeq ($(strip $(CFG_CONFIG_PA_RF)),YES)
OBC_LOCAL_SRC_FILE += \
...
#rtc
ifeq ($(strip $(CFG_CONFIG_RTC_BUILD_CTRL)),YES)
OBC_LOCAL_SRC_FILE += \
...
OBC_LOCAL_SRC_TEST_FILE += \
	$(BSP_DIR)/drivers/watchpoint/watchpoint_test.c
endif
...
# mbxhifi
ifeq ($(strip $(CFG_CONFIG_HIFI_MAILBOX)),YES)
OBC_LOCAL_SRC_FILE += \
