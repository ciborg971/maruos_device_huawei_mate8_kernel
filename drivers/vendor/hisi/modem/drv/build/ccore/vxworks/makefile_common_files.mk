...
ifeq ($(strip $(CFG_CONFIG_UART_ARM)),YES)
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/uart/balongv7r2_uart_arm.c
else
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/uart/balongv7r2_uart_synopsys.c
endif
...
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/of/base.c \
	$(BSP_DIR)/drivers/of/fdt.c \
	$(BSP_DIR)/drivers/of/of_balong.c
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/of/of_balong_test.c
endif
...
ifeq ($(strip $(CFG_CONFIG_SYSCTRL_TEST)),YES)
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/sysctrl/sc_interface_test.c
endif
...
ifeq ($(strip $(CFG_CONFIG_S_MEMORY_TEST)),YES)
OBC_LOCAL_SRC_FILE += \
...
OBC_LOCAL_SRC_FILE += \
	$(BSP_DIR)/drivers/psam/psam_balong_ccore.c
endif
...
OBC_LOCAL_SRC_FILE += \
	...
	$(DRV_DIR)/common/osl/osl_ioremap.c \
	$(DRV_DIR)/common/osl/test_osl_ioremap.c
...
OBC_LOCAL_INC_DIR += \
	...
	$(BALONG_TOPDIR)/include/drv/ccore \
	$(BALONG_TOPDIR)/include/drv/common \
