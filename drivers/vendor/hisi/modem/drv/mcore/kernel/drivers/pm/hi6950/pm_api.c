...
#if 0
        writel(DDRC_CFG_TIMING[0][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING0);
        writel(DDRC_CFG_TIMING[1][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING1);
        writel(DDRC_CFG_TIMING[2][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING2);
        writel(DDRC_CFG_TIMING[3][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING3);
        writel(DDRC_CFG_TIMING[4][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING4);
        writel(DDRC_CFG_TIMING[5][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING5);
        writel(DDRC_CFG_TIMING[6][timingmode], M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING6);/* todo part of reg*/
#else
#ifdef BSP_CONFIG_LPDDR2
        /* 533 */
        writel(0x677B6718, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING0);
        writel(0x1E82A071, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING1);
        writel(0x9502107E, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING2);
        writel(0xAF50C057, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING3);
        writel(0x600000  , M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING4);
        writel(0x3181908 , M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING5);
        writel(0x44      , M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING6);/* todo part of reg*/
#elif defined(BSP_CONFIG_LPDDR3)
        /* 533 */
        writel(0xB77B6718, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING0);
        writel(0x1D82A071, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING1);
        writel(0x9501C07E, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING2);
        writel(0xAF50C255, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING3);
        writel(0x10B00000, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING4);
        writel(0x13181908, M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING5);
        writel(0x44      , M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING6);/* todo part of reg*/
        writel(0x0       , M3PM_MDDRC_BASE+0x8000 + DDRC_CFG_TIMING6+4);/*part of reg*/
#endif
