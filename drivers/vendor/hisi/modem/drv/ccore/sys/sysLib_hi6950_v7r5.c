...
PHYS_MEM_DESC sysPhysMemDesc [] =
	...
	{
    HI_CS_SYS_REGBASE_ADDR_VIRT, /* MPCore functions including SCU */
    HI_CS_SYS_REGBASE_ADDR,
    ROUND_UP (HI_CS_SYS_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
    {
    HI_SYSCTRL_AO_REG_BASE_ADDR_VIRT,    /* system AO registers */
    HI_SYSCTRL_AO_REG_BASE_ADDR,
    ROUND_UP (HI_SYSCTRL_AO_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
    {
    HI_SYSCTRL_PD_REG_BASE_ADDR_VIRT,    /* system PD registers */
    HI_SYSCTRL_PD_REG_BASE_ADDR,
    ROUND_UP (HI_SYSCTRL_PD_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
	{
	HI_SYSCTRL_PCIE_REG_BASE_ADDR_VIRT,	 /* system PD registers */
	HI_SYSCTRL_PCIE_REG_BASE_ADDR,
	ROUND_UP (HI_SYSCTRL_PCIE_REG_SIZE, PAGE_SIZE),
	MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
	MMU_ATTR_VALID	   | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
	},
    {
	...
	{
    HI_TIMER_00_REGBASE_ADDR_VIRT,    /* timer 0~5 */
    HI_TIMER_00_REGBASE_ADDR,
    ROUND_UP (HI_TIMER_00TO05_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
    {
    HI_TIMER_06_REGBASE_ADDR_VIRT,    /* timer6-23 */
    HI_TIMER_06_REGBASE_ADDR,
    ROUND_UP (HI_TIMER_06TO23_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
    {
    HI_TIMER_24_REGBASE_ADDR_VIRT,    /* timer24-35 */
    HI_TIMER_24_REGBASE_ADDR,
    ROUND_UP (HI_TIMER_24TO35_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
#if 0
	...
	{
    HI_IOS_AO_REGBASE_ADDR_VIRT,  /* IOS  ao*/
    HI_IOS_AO_REGBASE_ADDR,
	ROUND_UP (HI_IOS_AO_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },    
	{
    HI_IOS_PD_REGBASE_ADDR_VIRT,  /* IOS  pd*/
    HI_IOS_PD_REGBASE_ADDR,
	ROUND_UP (HI_IOS_PD_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
	{
    HI_GPIO1_REGBASE_ADDR_VIRT,  /* GPIO1~3 */
    HI_GPIO1_REGBASE_ADDR,
	ROUND_UP (HI_GPIO1_REG_SIZE * 3, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
	{
	...
	{
    HI_AMON_CPUFAST_REGBASE_ADDR_VIRT,  /* AMON CPUFAST */
    HI_AMON_CPUFAST_REGBASE_ADDR,
	ROUND_UP (HI_AMON_CPUFAST_REG_SIZE, PAGE_SIZE),
    MMU_ATTR_VALID_MSK | MMU_ATTR_PROT_MSK | MMU_ATTR_DEVICE_SHARED_MSK,
    MMU_ATTR_VALID     | MMU_ATTR_SUP_RWX  | MMU_ATTR_STRONGLY_ORDERED
    },
	{
    HI_AMON_SOC_REGBASE_ADDR_VIRT,  /* AMON SOC */
...
#ifndef BSP_CONFIG_V7R2_SFT  /* nothing to be done for v7r2 sft version, cipher/ipf/cimo0/cicom1/hdlc/upacc */
	{
