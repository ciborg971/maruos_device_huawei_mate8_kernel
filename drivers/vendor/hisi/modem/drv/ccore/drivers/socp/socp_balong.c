...
s32 bsp_socp_drx_bak_reg(void)
{
    ...
    Socp_Memcpy(g_aSocpDrxGlobal, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_GBLRST), sizeof(g_aSocpDrxGlobal)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxInitStat, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_GBL_INTSTAT), sizeof(g_aSocpDrxInitStat)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxIntMask, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_DEC_CORE0MASK0), sizeof(g_aSocpDrxIntMask)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxEncSrc, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_ENCSRC_BUFWPTR(0)), sizeof(g_aSocpDrxEncSrc)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxEncDst, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_ENCDEST_BUFWPTR(0)), sizeof(g_aSocpDrxEncDst)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxDecSrc, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_DECSRC_BUFWPTR(0)), sizeof(g_aSocpDrxDecSrc)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy(g_aSocpDrxDecDst, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_DECDEST_BUFWPTR(0)), sizeof(g_aSocpDrxDecDst)); /* [false alarm]:屏蔽Fortify错误 */
...
s32 BSP_BBPDMA_DrxBakReg(void)
{
	...
	Socp_Memcpy(g_aSocpDrxBBPEncSrc, (void *)SOCP_REG_ADDR_DRX(SOCP_REG_ENCSRC_BUFWPTR(16)), sizeof(g_aSocpDrxBBPEncSrc)); /* [false alarm]:屏蔽Fortify错误 */
#endif
...
void bsp_socp_drx_restore_reg(void)
{
    ...
    /*恢复全局状态寄存器*/
    Socp_Memcpy((void *)SOCP_REG_ADDR_DRX(SOCP_REG_GBLRST), g_aSocpDrxGlobal, sizeof(g_aSocpDrxGlobal)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy((void *)SOCP_REG_ADDR_DRX(SOCP_REG_GBL_INTSTAT), g_aSocpDrxInitStat, sizeof(g_aSocpDrxInitStat)); /* [false alarm]:屏蔽Fortify错误 */
    Socp_Memcpy((void *)SOCP_REG_ADDR_DRX(SOCP_REG_DEC_CORE0MASK0), g_aSocpDrxIntMask, sizeof(g_aSocpDrxIntMask)); /* [false alarm]:屏蔽Fortify错误 */
