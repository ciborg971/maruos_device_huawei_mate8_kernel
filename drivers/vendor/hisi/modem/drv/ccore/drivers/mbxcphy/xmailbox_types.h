...
/*system error modid*/
#define     DRV_ERRNO_XMBX_WR_FULL       0x1070   /* 下行邮箱满 */
#define     DRV_ERRNO_XMBX_DSP_IPC       0x1071   /* 上行邮箱满，DSP IPC通知ARM */
#define     DRV_ERRNO_XMBX_PS_TIMEOUT    0x1072   /* PS等DSP消息超时 */
#define     DRV_ERRNO_XMBX_UP_WR         0x1073   /* 上行邮箱写指针异常 */
#define     DRV_ERRNO_XMBX_DL_MOD        0x1074   /* 下行邮箱读指针MOD异常 */
