 ...
 */
const int g_ulChTimeOffset = 12; /*PC-Lint, 2006-10-25*/
...
SCI_ATRINFO_S g_sci_atr_info = {T0_PROTOCOL_MODE,32,32,T1_ERR_DETECT_MODE_LRC};
                   ...
                   || (pState->sATRParams.NumHist == 1))))
        {
            ...
            */
            ...
            if ((g_Pl131_pps_state.ucModeOfOperation == PL131_NEGOTIABLE_MODE)    \
               && (g_Pl131_pps_state.ucTA1Flag) && (g_Pl131_pps_state.PL131_PPS_ACTIVATION <= 3))
            {
...
void pl131_pps_process(SCI_STATE_STRU * parapState, u32 CharATR)
{
    ...
    sci_print_info("We are in PPS process, input PPS data = %l#x\n",
              (int)CharATR, 0, 0, 0, 0, 0);/*PC-Lint,2006-10-25*/
