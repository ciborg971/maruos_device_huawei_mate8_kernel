...
void sci_get_log_name(SCI_LOG_MODE log_mode,char* dir_path,char* control_path, char** logname)
{
    ...
    if(fd != BSP_ERROR)/* [false alarm]:fortify */
    {
         ...
         {
            /* [false alarm]:fortify */
            sci_combine_log_name(*logname,"%s%s%s%d%s%s%04d_%02d_%02d_%02d_%02d_%02d.txt",dir_path,log_name_head,"index",0,"_",logpath,(tm.tm_year + 1900), (tm.tm_mon + 1), tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
         }
