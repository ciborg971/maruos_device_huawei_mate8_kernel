...
s32 coresight_perctrl2_memmap(void)
{
    ...
    cs_error("g_perctrl2_reg.phy_addr = 0x%x,g_perctrl2_reg.virt_addr = 0x%x,g_perctrl2_reg.offset = 0x%x",g_perctrl2_reg.phy_addr ,g_perctrl2_reg.virt_addr,g_perctrl2_reg.offset );
    cs_error("g_perctrl2_reg.pclkdbg_clkoff_sys = 0x%x",g_perctrl2_reg.pclkdbg_clkoff_sys);
    cs_error("g_perctrl2_reg.atclkoff_sys = 0x%x",g_perctrl2_reg.atclkoff_sys);
    cs_error("g_perctrl2_reg.pclkdbg_to_modem_clk_off_sys = 0x%x",g_perctrl2_reg.pclkdbg_to_modem_clk_off_sys);
    cs_error("g_perctrl2_reg.modem_cssys_rst_req = 0x%x",g_perctrl2_reg.modem_cssys_rst_req );    
    cs_error("g_perctrl2_reg.atclk_to_modem_clkoff_sys = 0x%x",g_perctrl2_reg.atclk_to_modem_clkoff_sys);
...
s32 coresight_modem_sysctrl_memmap(void)
{
    ...
    cs_error("g_modem_sysctrl_cfg.mdm_ctrl_sys_phy_addr = 0x%x,g_modem_sysctrl_cfg.mdm_ctrl_sys_virt_addr = 0x%p",g_modem_sysctrl_cfg.mdm_ctrl_sys_phy_addr,g_modem_sysctrl_cfg.mdm_ctrl_sys_virt_addr);
    cs_error("g_modem_sysctrl_cfg.clk.offset = 0x%x,g_modem_sysctrl_cfg.clk.mcpu_dbg_clk_en = %d,g_modem_sysctrl_cfg.clk.mcpu_pd_clk_en=%d\n",g_modem_sysctrl_cfg.clk.offset,g_modem_sysctrl_cfg.clk.mcpu_dbg_clk_status,g_modem_sysctrl_cfg.clk.mcpu_pd_clk_status);
    cs_error("g_modem_sysctrl_cfg.rst.offset = 0x%x,g_modem_sysctrl_cfg.rst.mdma9_pd_srst_en= %d,g_modem_sysctrl_cfg.rst.moda9_cpu_srst_en =%d\n",g_modem_sysctrl_cfg.rst.offset,g_modem_sysctrl_cfg.rst.mdma9_pd_srst_status,g_modem_sysctrl_cfg.rst.moda9_cpu_srst_status);
    cs_error("g_modem_sysctrl_cfg.mtcmos.offset=0x%x,g_modem_sysctrl_cfg.mtcmos.cpu_mtcmos_strl_dis =%d\n",g_modem_sysctrl_cfg.mtcmos.offset,g_modem_sysctrl_cfg.mtcmos.cpu_mtcmos_strl_status);
