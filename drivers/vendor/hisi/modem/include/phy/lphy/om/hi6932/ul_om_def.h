...
/* BEGIN: Added by yushujing, 2015/1/28   PN:V7R5_MODIFY*/
#define MAX_PHR_SIZE        7
/* END:   Added by yushujing, 2015/1/28 */
...
typedef enum __LPHY_IND_MSGID_UL__
{
    ...
    /* BEGIN: Added by yushujing, 2015/1/29   PN:V7R5_MODIFY*/
    ...
    /* END:   Added by yushujing, 2015/1/29 */
...
typedef struct
{
    ...
    UL_ENABLE_ENUM_UINT16 enPrachEn;
    UL_ENABLE_ENUM_UINT16 enSrsEn;
    /* BEGIN: Added by xueqiuyan, 2015/3/26   PN:v7r5_modify*/
    UL_ENABLE_ENUM_UINT16 enPusUciEn;
    /* END:   Added by xueqiuyan, 2015/3/26 */
    UL_STATE_ENUM_UINT16  enUlCurState;
    UL_VALID_ENUM_UINT16  enSrsSchedValid; /*SRS周期调度有效标识*/
    UL_VALID_ENUM_UINT16  enSrsApSchedValid; /*SRS非周期调度有效标识*/
    /* BEGIN: Added by xueqiuyan, 2015/3/26   PN:v7r5_modify*/
...
typedef   struct
{
    ...
    /* BEGIN: Added by yushujing, 2015/2/2   PN:V7R5_MODIFY*/
    //UINT16                 usRev;
    UINT8                       ucCellIndex;  /*dci0中带CqiReq的载波索引,非周期时cqi有效*/
    UINT8                       enCc;
    /* END:   Added by yushujing, 2015/2/2 */
...
//    UINT8   ucPMIValue[25];         /*PMI值*/
    ...
    UINT16  usCqiChSel;
    UINT16  usRevd;
    /* BEGIN: Added by yushujing, 2015/1/19   PN:V7R5_MODIFY*/
    UINT8  ucAckCcSel;
    UINT8  ucCqiCcSel;
    UINT8  ucRiCcSel;
    UINT8  ucRsv;
    /* END:   Added by yushujing, 2015/1/19 */
}UL_CUR_UCI_STRU;
...
typedef struct
{
    /* BEGIN: Added by xueqiuyan, 2014/9/10   PN:v7r5_modify*/
    //UINT32 aulModReg[9];
    UINT32 aulModReg[10];
    /* END:   Added by xueqiuyan, 2014/9/10 */
    #if 0
    /*PUSCH_SCRAMBL_REG*/
...
/* BEGIN: Added by xueqiuyan, 2014/9/12   PN:v7r5_modify*/
/*****************************************************************************
 结构名    : UL_TB_STRU
 协议表格  :
 ASN.1描述 :
...
/* END:   Added by xueqiuyan, 2014/9/12 */
...
typedef enum __UL_DCI_TYPE_ENUM__
{
    UL_DCI0 = 0,
    UL_DCI4,
    /* BEGIN: Added by yushujing, 2014/12/19   PN:V7R5_MODIFY*/
    UL_RAR
    /* END:   Added by yushujing, 2014/12/19 */
}UL_DCI_TYPE_ENUM;
...
typedef struct
{
    ...
    /* BEGIN: Added by yushujing, 2013/11/13   PN:3_3a_mod*/
