...
{
    LTE_CHAN_SPACE_CORR_ENUM_UINT8  ucNonWtRecCorr[CQI_MAX_CA_NUM+1];      /*0,???ì?¨¨??¨?a??¨?o?|??ì???¨?a???¨???§?§1????ìo?1???ìo????ì?¨¨??¨?a??¨?o??D???¨???§?§1????ìo?2???ìo????ì?¨¨??¨?a??¨?o??????¨???§?§1?*/
    LTE_CHAN_SPACE_CORR_ENUM_UINT8  ucNonWtCorr[CQI_MAX_CA_NUM+1];         /*0,???ì?¨¨??¨?a??¨?o?|??ì???¨?a???¨???§?§1????ìo?1???ìo????ì?¨¨??¨?a??¨?o??D???¨???§?§1????ìo?2???ìo????ì?¨¨??¨?a??¨?o??????¨???§?§1?*/
    LTE_CHAN_SPACE_CORR_ENUM_UINT8  ucWtRecCorr[CQI_MAX_CA_NUM+1];        /*0,???ì?¨¨??¨?a??¨?o?|??ì???¨?a???¨???§?§1????ìo?1???ìo????ì?¨¨??¨?a??¨?o??D???¨???§?§1????ìo?2???ìo????ì?¨¨??¨?a??¨?o??????¨???§?§1?*/
    LTE_CHAN_SPACE_CORR_ENUM_UINT8  ucWtCorr[CQI_MAX_CA_NUM+1];           /*0,???ì?¨¨??¨?a??¨?o?|??ì???¨?a???¨???§?§1????ìo?1???ìo????ì?¨¨??¨?a??¨?o??D???¨???§?§1????ìo?2???ìo????ì?¨¨??¨?a??¨?o??????¨???§?§1?*/
