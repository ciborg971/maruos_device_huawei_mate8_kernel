...
typedef struct
{
    ...
    PHY_GAS_INTERRAT_TO_GSM_TIMING_INFO_STRU    stInterRat2GsmTimingOffset;     /* 异系统到GSM的定时折算信息，CCO使用，重选流程不使用 */
...
typedef struct
{
    ...
    VOS_UINT32                                  ulFNOffset;                     /* 有效值范围[0,2715647],无效值:0xFFFFFFFF */
    VOS_UINT16                                  usTimeAlignmt;                  /* 有效值范围[0,4999],无效值:0xFFFF */
    VOS_UINT16                                  usReserved;                     /* 保留位 */
    VOS_RATMODE_ENUM_UINT32                     enHo2GsmRatType;                /* HO到GSM的接入模式类型 */
    PHY_GAS_INTERRAT_TO_GSM_TIMING_INFO_STRU    stInterRat2GsmTimingOffset;     /* 异系统到GSM的定时折算信息 */
    VOS_UINT16                                  usTA;
    VOS_UINT16                                  usNCI;
...
/*****************************************************************************
 结构名    : MPH_CAMP_SCELL_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GAS停止搜索之后，指定驻留某个小区。
...
typedef struct
{
    ...
    VOS_UINT16                          usReserve;                              /* 保留位 */
    PHY_GAS_CELL_CGI_DESCR_STRU         stCgi;                                  /* 小区的CGI信息 */
} MPH_CAMP_SCELL_REQ_STRU;

/*****************************************************************************
 结构名    : MPH_CAMP_SCELL_CNF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MPH_CAMP_SCELL_REQ的确认原语。
