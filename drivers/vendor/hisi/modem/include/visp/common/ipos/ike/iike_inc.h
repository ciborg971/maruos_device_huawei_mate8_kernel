 ...
 ******************************************************************************
  File Name     : iike_inc.h
  Version       : Initial Draft
  Author        : Karthik/70713
  Created       : 2006/01/30
  Last Modified : Sumit/71754
  Others        :
  Description   : To define IKE component interfaces
  Function List :
*****************************************************************************
   Modification History
-----------------------------------------------------------------------------
   DATE      VERSION         NAME/ID              DESCRIPTION
 2006/01/30   1.0       Karthik/70713               Created

 2006/11/8    1.0       Sumit/71754             Added new component interface in
                                                CFG IKE_GetVersion
 2007/07/04   1.0       Sumit/71754             Modified for defect AC4D03031
 2008/01/25   1.0                               V1R3 New API's Added
 2008/05/02   1.0        Wanlu/39621      Updated for VISPV1R7 integration
******************************************************************************/
...
------------------------------------------------------------------------*/
    ...
    /*2007-09-21: Samson:added to support new command reset ike sa all*/
