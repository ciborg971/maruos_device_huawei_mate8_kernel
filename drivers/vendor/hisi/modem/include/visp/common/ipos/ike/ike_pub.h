 ...
 ******************************************************************************
  ...
  Author        : Kathik/70713
  Created       : 2006/02/15
  Last Modified : Sumit/71754
  Description   : This file contains all the public definitions
  Function List :

  History       :
------------------------------------------------------------------------------
   DATE      VERSION         NAME/ID              DESCRIPTION
 2006/02/15   1.0          Karthik/70713           Created

 2006/11/8    1.0          Sumit/71754            Added ulPhase1SACount,
                                                    and ulPhase2SACount
                                                    in stIKEGlobalContent.

 2006/11/13   1.0          Sumit/71754            Added new variable for log
                                                        error in
                                                   IKE_Log_identification
                                                   for exchange timeout.

 2006/11/15   1.0          Sumit/71754            Added new variable for
                                                        log error in
                                                  IKE_Log_identification for sa
                                                        delete.

2007/01/18    1.0          Smitha/71796           AC4D01565, Added new cfg
                                                  opmode - IKE_MODE_VPN_SET
2007/02/09    1.0          Sumit/71754            AC4D02046: Added Enum for new
                                                  logs
2007/02/09    1.0          Ruchir/71603           Defect ID:AC4D02063,
                                                  to display for SPI List
                                                  Negotiated or not
2007/11/13    1.0          Anoop/72161            Modified for V1R3 feature.
******************************************************************************/
...
/* Begin : AC4D01565, Added new cfg opmode */
