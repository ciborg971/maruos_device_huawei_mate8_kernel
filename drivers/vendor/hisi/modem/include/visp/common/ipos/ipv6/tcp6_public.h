...
typedef struct tagTCP6CONNSTAT
{
    ...
    /* Modified by Srinivas (s00900781) for TCP6 Per Connection Ststiatics */
    ULONG    ulClosed;
    ULONG    ulDrops;
    ULONG    ulKeepDrops;
    ULONG    ulPersistDrops;
...
/* Begin : modifier Srinivas (s00900781) for TCP6 statistics */
...
/*End : modifier Srinivas (s00900781) for TCP6 statistics */
...
/* Begin : Added by KLSRINI for supporting old mib */
