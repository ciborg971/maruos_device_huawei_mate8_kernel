...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_MCMemAlloc
* Date Created: 2010-03-25
*       Author: zhangchunyu(62474)
*      Purpose: Alloc multicore share memory
*  Description: Alloc multicore share memory
*        Input: UINT32 u32Size: Memory size<All int>
*       Output: 
*       Return: Output memroy address
*      Caution: This function only alloc share memory, not add to name database and init the memory.
*        Since: V200R003C01
*    Reference: 
*------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_MCMemAllocByName
* Date Created: 2010-03-25
*       Author: zhangchunyu(62474)
*      Purpose: Alloc multicore share memory by name
*  Description: Alloc multicore share memory by name, this memory have add to name database
*        Input: UINT8 *pszName: Memory name<Not null pointer>
*               UINT32 u32Size: Memory size<All int>
*       Output: 
*       Return: Output memroy address
*      Caution: 1. If malloc memory by this function, the name same memory address is same.
*               2. The memory will set to zero
*        Since: V200R003C01
*    Reference: 
*------------------------------------------------------------------------------
*  Modification History
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_MCMemNameDBAdd
* Date Created: 2010-03-29
*       Author: zhangchunyu(62474)
*      Purpose: Add share memory add to name database
*  Description: Add share memory add to name database
*        Input: UINT8 *pszName: Share memory name<Not null pointer>
*               VOID *pVAddr: Share memory address<Not null pointer>
*       Output: 
*       Return: 0: Success
*               1: Fail
*      Caution: 
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_SpinLockDelete
* Date Created: 2010-03-25
*       Author: zhangchunyu(62474)
*      Purpose: Delete spin lock
*  Description: Delete spin lock.
*        Input: UINT8 *pszName: Spin lock name<Not null pointer>
*               IPSAFE_SPINLOCK_ID *pLockID: Pointer to spin lock id<Not null pointer>
*       Output: 
*       Return: 0:Success
*               1:Fail
*      Caution: 
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_RWLockDelete
* Date Created: 2010-03-25
*       Author: zhangchunyu(62474)
*      Purpose: Delete the read-write lock
*  Description: Delete the read-write lock
*        Input: UINT8 *pszName: read-write lock<Not null pointer>
*               IPSAFE_RWLOCK_ID *pLockID: Lock ID<Not null pointer>
*       Output: 
*       Return: 0: Success
*               1: Fail
*      Caution: 
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_MemCmp
* Date Created: 2010-08-20
*       Author: Arjun(a00900868)
*      Purpose: Compare two blocks of memory for a particular size
*  Description: Compare two blocks of memory for a particular size
*        Input: VOID *pvDestAddr: A valid pointer to a memory block<Not null pointer>
*               VOID *pvSrcAddr: A valid pointer to a memory block<Not null pointer>
*               UINT32 u32Size:  Number of bytes to be compared   
*       Output: 
*       Return: 0: Success, the contents of memory are same
*               Other: Fail
*      Caution: 
*        Since: V200R003C01
*    Reference: 
...
/*******************************************************************************
*    Func Name: IPSAFE_ADP_DelLoopTimer
* Date Created: 2010-06-25
*       Author: zhangchunyu62474
*      Purpose: Delete loop timer
*  Description: Delete loop timer
*        Input: UINT32 *pu32TimerID: Timer ID<Not null>
*       Output: 
*       Return: Successful: 0
*      Caution: 
*        Since: V200R003C01
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-06-25   zhangchunyu62474        Create the first version.
*
*******************************************************************************/
UINT32 IPSAFE_ADP_DelLoopTimer(UINT32 *pu32TimerID);

/*******************************************************************************
*    Func Name: IPSAFE_ADP_WaitListDelFromList
* Date Created: 2010-07-26
*       Author: Anish a72338
*      Purpose: Used for deleting an entry from a waitlist
*  Description: Used for deleting an entry from a waitlist
*        Input: UINT32 ulType: The ID of the waitlist
*               VOID *pDataToDel: Pointer to the data to be deleted
*       Output: 
*       Return: Successful: 0
*      Caution: 
*        Since: V200R003C01
