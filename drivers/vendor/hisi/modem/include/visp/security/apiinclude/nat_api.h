...
/*******************************************************************************
*    Func Name: NAT_AddAddrPool
*    Date Created: 2010-04-15
*    Author: v71873
*    Purpose: This function adds a new address pool
*    Description: This function adds a new address pool.
*                 IP/Port allocation will be done through this address pool itself.
*    Input:  UINT32 u32StartAddress: Start address range of the global IPs <All valid uint>
*            UINT32 u32EndAddress: End address range of the global IPs <All valid uint>
*            UINT16 u16MinPortValue: Min port value to be allocated to a NAPT session <All valid short exlcuding 0>
*            UINT16 u16MaxPortValue: Max port value to be allocated to a NAPT session <All valid short exlcuding 0>
*            UINT32 u32AddrPoolIndex: New address pool which must be added
*    Return: NAT_ADDADDRPOOL_ERR_INVALID_ADDR_POOL_INDEX: Address pool index is not valid
*            NAT_ADDADDRPOOL_ERR_POOLALREADY_EXISTS: Address pool with input index already exists
*            NAT_ADDADDRPOOL_ERR_MAXIPLIMIT_PER_RULE: Cannot configure more than 256 addresses per rule
*            NAT_ADDADDRPOOL_ERR_INVALID_IP_FORMAT: Start Address is larger than End Address
*            NAT_ADDADDRPOOL_ERR_INVALID_PORT_RANGE: Min Port is larger than Max Port
*            NAT_ADDADDRPOOL_ERR_CREATE_ADDR_POOL: Unable to create Address Pool at the index
*            NAT_ADDADDRPOOL_ERR_CREATE_SESSIONARRAY: Unable to create NAT session array
*            NAT_ADDADDRPOOL_ERR_CREATE_PORTQUEUE: Unable to create port queue
*            NAT_SUCCESS: Address pool added successfully
*    Since: V200R003C01
*    Caution:u16MinPortValue and u16MaxPortValue will not be effective if the g_pu32NatMode_Share is set as NAT
*    Reference: 
*------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME             DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-04-15   v71873         Added this function
*
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: NAT_DelAddrPool
*    Date Created: 2010-04-15
*    Author: v71873
*    Purpose: This function deletes an address pool.
*    Description: This function deletes an address pool specified in the pool index.
*                 If no rules are attached to the pool then only it will be deleted.
*    Input:  UINT32 u32AddrPoolIndex: This is the index of the pool which must be 
*                                       deleted <all valid uint>
*    Output: 
*    Return: NAT_DELADDRPOOL_ERR_INVALID_ADDR_POOL_INDEX: Address pool index is invalid
*            NAT_DELADDRPOOL_ERR_VCPU_NOT_INITIALIZED: Global variables not initialized
*            NAT_DELADDRPOOL_ERR_POOL_NOT_EXISTS: Address pool is not present
*            NAT_DELADDRPOOL_ERR_RULES_ATTACHED: Rules are still attached to the address pool
*            NAT_SUCCESS: Deletion of the address pool success
*    Since: V200R003C01
*    Caution: 
*    Reference: 
*------------------------------------------------------------------------------
...
*  ----------------------------------------------------------------------------
*  2010-04-15   v71873          Added this function
*  2010-05-14   v71873          Fixed the bug [Basic NAT]Del address pool cause reboot.
*                               NAT or PAT mode is checked in NAT_DelAddrPool before 
*                               deletion of the memory allocated in the NAT_AddAddrPool
*******************************************************************************/
UINT32 NAT_DelAddrPool(UINT32 u32AddrPoolIndex);

/*******************************************************************************
*    Func Name: NAT_IsPoolAddr
*    Date Created: 2010-04-15
*    Author: v71873
*    Purpose: This function checks whether an address is present in the address pools or not
*    Description: This function checks whether an address is present in the address pools or not
*                 based on the Input .
*    Input:  UINT32 u32Address: Address to be searched in the address pools <All valid uint>
*            INTF_HANDLE intfHandle: Interface <NAT_ALL_INTERFACE value for Interface means for
*                                               all the Interfaces>
*    Output: 
*    Return: NAT_ADDRESS_USED - If address belongs to address pool
*            NAT_ADDRESS_NOT_USED - If address does not belong to the address pool
*            Failure:NAT_ISPOOLADDR_ERR_UNABLE_TOGET_INTRFC
*                    NAT_IPOOLADDR_ERR_NO_RULE_IN_INTERFACE
*    Since: V200R003C01
*    Caution: 
*    Reference: 
*------------------------------------------------------------------------------
...
*  DATE         NAME             DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-04-17   v71873         Added this function
*  2010-05-24   a00900872      Added per Interface binding
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: NAT_ShowALGStatus
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to show the ALG configuration parameters.
*  Description: This function displays the ALG configuration parameters.
*        Input: UINT32 u32Protocol: The ALG from the enumNAT_ALG.<NAT_ALG_FTP to 
*                                                                NAT_ALG_MAX>
*
*       Output: The Different ALG configuration parameters like Port,ALGOutFuncID,
*               ALGInFuncID,Protocol,Statuswill get displayed for the ALG passed.
*       Return: VOID
*      Caution: None
*        Since: V200R003C01
*    Reference: 
...
*  DATE         NAME             DESCRIPTION    
*  ----------------------------------------------------------------------------
*  2010-5-03    a00900872         Create the first version.
*******************************************************************************/

extern VOID NAT_ShowALGStatus(UINT32 u32Protocol);

/*******************************************************************************
*    Func Name: NAT_GetALGStatus
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to get the ALG configuration parameters.
*  Description: This function gets the ALG configuration parameters inside
*               structure ALG_STATUS_S that user will pass.
*        Input: UINT32 u32Protocol: The ALG from the enumNAT_ALG.<NAT_ALG_FTP>
*                                                                   to
*                                                                <NAT_ALG_MAX>
*               ALG_STATUS_S *pstgetAlg: Pointer to the structure GET_RULE_S
*                                    with memory already created.<valid pointer>
*
*       Output: The Different ALG configuration parameters like Port,ALGOutFuncID,
*               ALGInFuncID,Protocol,Statuswill get filled inside the ALG_STATUS_S 
*               structure that has passed.
*       Return: VOID
*      Caution: 
*        Since: V200R003C01
*    Reference: 
...
/*******************************************************************************
*    Func Name: NAT_ShowAllALGStatus
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to show the ALG configuration parameters.
*  Description: This function displays the ALG configuration parameters.
...
*
*       Output: The Different ALG configuration parameters like Port,ALGOutFuncID,
*               ALGInFuncID,Protocol,Statuswill get displayed for All the ALGs.
*       Return: VOID
*      Caution: 
*        Since: V200R003C01
*    Reference: 
...
/*******************************************************************************
*    Func Name: NAT_ShowNextRule
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User Exposed API to display the next rule for the interface passed.
*  Description: This function is used to display the next rule for the interface passed.
*        Input: UINT16 u16Interface: Interface Number.<ANY Integer>
*               VOID *Handle: Any valid Pointer<Handle received after calling NAT_OpenRuleList>
*               UINT32 Number: Number of Rules user want to display at one call <Any Integer>
*       Output: The Different Rule Parameters like StartAddress;EndAddress;Ports etc.
*               ACL Number ACL Count Interface Handle will get displayed.               
*       Return: VOID
*               
*      Caution: 
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: NAT_GetNextRule
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User Exposed API used to get the next rule for the interface passed 
*  Description: This function is used to get the next rule for the interface passed 
*               in the GET_RULE_S structure that will be passed here. The elements of 
*               the structure GET_RULE_S that has been passed during initialization will 
*               be returned back in the structure pointer passed here.
*        Input: UINT16 u16Interface: For Single Interface.<Interface Number like 514>
*                                    for all the interfaces<NAT_ALL_INTERFACE>
*               GET_RULE_S *pstGetRule: Pointer to the structure GET_RULE_S with memory already created.<valid pointer>
*               VOID *Handle: Any valid Pointer<Handle received after calling NAT_ShowFirstRule>
*               UINT32 Number: Number of Rules user want to display at one call <Any Integer>
*       Output: GET_RULE_S *pstGetRule: Rule information <>
*       Return: NAT_SUCCESS: Successful
*               Other:Fail
*               
*      Caution: 
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: NAT_ShowAllSupportedAlg
* Date Created: 2010-5-13
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to show the ALGs supported.
*  Description: This function displays the ALGs supported.
*        Input: VOID
*       Output: The Different ALGs will get displayed as output.
*       Return: VOID
*      Caution: 
*        Since: V200R003C01
*    Reference: 
...
/*******************************************************************************
*    Func Name: NAT_ShowAllEnabledAlg
* Date Created: 2010-5-13
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to show the ALGs enabled.
*  Description: This function is used to display the ALGs that are enabled.
*        Input: VOID
*       Output: The Different ALGs will get displayed as output.
*       Return: VOID
*      Caution: 
...
/*******************************************************************************
*    Func Name: NAT_GetAllEnabledAlg
* Date Created: 2010-5-13
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to get the ALGs enabled.
*  Description: This function gets Names of the ALGs which are enabled in an array of strings 
*               which is one filed inside the GET_ALG_S structure.
*        Input: GET_ALG_S *pstAlgNames: points to the structure which holds the array of 
*                                       ALGs Names which are Enabled<VALID Pointer >
*       Output: 
...
/*******************************************************************************
*    Func Name: NAT_GetAllSupportedAlg
* Date Created: 2010-5-13
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to get the ALGs supported.
*  Description: This function is used to get all the supported ALGs.
*        Input: GET_ALG_S *pstAlgNames: Pointer to structure that contains
*                array of strings that will get filled with names of ALGs supported
*       Output: 
*       Return: NAT_SUCCESS: On Success
*      Caution: 
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: NAT_ShowPreConfig
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: To Show the Pre Configuration Parameters.
*  Description: This function is used to display the pre-configuration parameters 
*               from the structure NAT_PRE_CFG_S that has been passed during initialization.
*        Input: VOID
*       Output: The elements of the structure NAT_PRE_CFG_S that has been passed
*               during initialization time will get displayed.
*       Return: VOID
*               
*      Caution: 
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: NAT_GetPreConfig
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: User exposed API to Get the Pre Configuration Parameters in the structure 
*               passed.
*  Description: This function is used to get the pre configuration parameters in the 
*               structure NAT_PRE_CFG_S that has been passed during initialization.
*        Input: NAT_PRE_CFG_S *pstGetConfig: Pointer to the structure NAT_PRE_CFG_S with memory already created.<valid pointer>
*               
*       Output: The elements of the structure NAT_PRE_CFG_S that has been passed
*               during initialization time will get back in the structure pointer 
*               passed here.            
*       Return: NAT_SUCCESS: Successful
*               Other:Fail
*               
...
/*******************************************************************************
*    Func Name: NAT_OpenRuleList
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: To create the handle in reference of the interfaces and 
*  Description: This function is used to create the handle in reference of the interfaces. 
*               The different Rule Parameters like StartAddress, EndAddress, Ports, 
*               ACL Number, ACL Count, Interface Handle will get displayed.
*        Input: UINT16 u16Interface: Interface Number <All int>
*               VOID **pHandle: Any valid Pointer <Valid Pointer>
*               
*       Output: The Different Rule Parameters like StartAddress,EndAddress,Ports,
*               ACL Number ACL Count Interface Handle will get displayed.               
*       Return: VOID
*               
*      Caution: 
...
/*******************************************************************************
*    Func Name: NAT_CloseRuleList
* Date Created: 2010-5-03
*       Author: ABHISHEK MISHRA (a00900872)
*      Purpose: To free the handle in reference of the interfaces.
*  Description: This function is used to free the handle in reference of the interfaces.
*        Input: VOID *pHandle: Any valid Pointer <Valid Pointer>
*               
*               
*       Output: This will free the handle.              
*       Return: NAT_SUCCESS: On Success
*      Caution: 
*        Since: V200R003C01
*    Reference: 
...
*    Func Name: NAT_DeleteSessions
*    Date Created: 2010-5-24
*    Author: a00900872
*    Purpose: User Exposed API used to delete the sessions associated with either 
*             Interface or the Source IP according to the Input Oper type.
*    Description: This will delete all the sessions associated with an Interface or source IP 
*                  based on input operation type.
*    Input:  UINT32 u32OperType: Operation Type <NAT_DEL_SESS_FOR_INTERFACE:Delete sessions per Interface,
*                                                NAT_DEL_SESS_FOR_SOURCE_IP:Delete sessions per Source IP>
*            UINT32 u32Data:  <Valid Interface Number or Valid Source IP>
*    Output:
*    Return:
*    Since: V200R003C01
*    Caution: 
...
*  DATE         NAME             DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-5-24    a00900872     Create the first version.
*
*******************************************************************************/
