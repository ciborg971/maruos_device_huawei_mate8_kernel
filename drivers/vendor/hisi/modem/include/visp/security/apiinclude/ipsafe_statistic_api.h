...
/*******************************************************************************
*    Func Name: IPSAFE_SetFlowStatisticSwitch
* Date Created: 2010-05-05
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will disable or enable the flow statistics 
*               module depending on the value that is passed to the function.

*  Description: This must be called only after initializing flow statistics 
*               successfully.
*               Disabling flow statistics will not clear auto or manual flow statistics
*               or free any memory, it will simply make flow stat module stop any further
*               calculation of flow statistics. Separate API will have to be called 
*               to clear all statistics.
*        Input: UINT32 u32FlowStatSwitch: Indicates whether flow statistics is on or off.
*                                         <IPSAFE_FLOWSTAT_SWITCH_ON,
*                                         IPSAFE_FLOWSTAT_SWITCH_OFF>
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS
*               Failure: IPSAFE_FLOWSTAT_SETSWITCH_ERR_SHAREVAR_FLOWSTAT_INFO_NULL, 
*                       IPSAFE_FLOWSTAT_SETSWITCH_ERR_FLOWSTATSWITCH_INVALID
*      Caution: There is no significance of calling this function if flowstatics 
*               is not initialized.
*        Since: V200R003C01
*    Reference: IPSAFE_GetFlowStatisticSwitch
*------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-05-05   Arjun Sachdeva 00900868  Create the first version.
*
*******************************************************************************/
extern UINT32 IPSAFE_SetFlowStatisticSwitch(UINT32 u32FlowStatSwitch);

/*******************************************************************************
*    Func Name: IPSAFE_GetFlowStatisticSwitch
* Date Created: 2010-05-05
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API provides the current status of Flow Statistics switch
*  Description: This API will store the status in the input parameter and return 
*               success or failure.
*        Input: UINT32 *pu32FlowStatSwitch: Indicates pointer to the location where 
*                                           flow statitics information is stored. <>
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS
*               Failure: IPSAFE_FLOWSTAT_GETSWITCH_ERR_SHAREVAR_FLOWSTAT_INFO_NULL, 
*                        IPSAFE_FLOWSTAT_GETSWITCH_ERR_FLOWSTAT_SWITCH_PTR_NULL
*      Caution: None
*        Since: V200R003C01
*    Reference: IPSAFE_SetFlowStatisticSwitch
*------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: IPSAFE_ClearAllFlowStatistic
* Date Created: 2010-05-10
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will clear all the flow statistics. It will not free any 
*               memory.
*  Description: It should be used when the counters for existing flows need to be 
*               re-set. It does not delete the rules or disable flowstatistics, 
*               it only clears the counters for all the rules and modules.
*        Input: VOID
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS    
*               Failure: IPSAFE_FLOWSTAT_CLEARALL_ERR_MANUAL_SHAREVAR_NULL
*                        IPSAFE_FLOWSTAT_CLEARALL_ERR_AUTO_SHAREVAR_NULL
*      Caution: None
*        Since: V200R003C01
*    Reference: None
*------------------------------------------------------------------------------
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-05-10   Arjun Sachdeva 00900868  Create the first version.
*
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: IPSAFE_GetFlowStatisticRuleNum
* Date Created: 2010-05-05
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will provide the number of rules currently configured.
*  Description: This API could be used to get the value of the number of rules currently configured
*                   in NAT and store it in a variable and make its further for any purpose.
*        Input: UINT32 *pu32FlowStatRuleNum: Indicates pointer to the location 
*                                            storing the flow statistics rule 
*                                            number. <>
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS
*               Failure: IPSAFE_FLOWSTAT_GETRULENUM_ERR_SHAREVAR_FLOWSTAT_INFO_NULL
*                       IPSAFE_FLOWSTAT_GETRULENUM_ERR_RULENUM_PTR_NULL
*      Caution: None
*        Since: V200R003C01
*    Reference: None
*------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: IPSAFE_ConfigFlowStatisticRule
* Date Created: 2010-05-05
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will add or delete a rule.
*  Description: If operation type is IPSAFE_FLOWSTATISTIC_DELALL, then all the rules will be deleted. 
*               In this case, pstFlowStatisticRule can be kept null. If operation type is 
*               IPSAFE_FLOWSTATISTIC_DEL, then only one rule will be deleted, whose values are 
*               provided in pstFlowStatisticRule. If operation type is IPSAFE_FLOWSTATISTIC_ADD, 
*               then one rule will be added.
*        Input: UINT32 u32OperType: Indicates the type of operation <IPSAFE_FLOWSTATISTIC_RULE_OPER_TYPE_E>
*               IPSAFE_FLOWSTATISTIC_RULE_S *pstFlowStatisticRule: Pointer to structure of 
*                       type IPSAFE_FLOWSTATISTIC_RULE_S with all parameters correctly filled in<>
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS
*      Caution: None
*        Since: V200R003C01
...
/*******************************************************************************
*    Func Name: IPSAFE_GetFlowStatisticAllInfo
* Date Created: 2010-05-07
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API provides the addresses of all the global variables that 
*               are used for flow based statistics.
*  Description: The structure that is passed as input to this API will hold all 
*               the values in its elements but for maximum rule number, it will 
*               store the maximum rules that are allowed to be configured (as 
*               provided at as part of PreCfg structure).
*        Input: IPSAFE_FLOWSTATISTIC_ALLINFO_S *pstFlowStatAllInfo: Pointer to structure of the type IPSAFE_FLOWSTATISTIC_RULE_S<>
*       Output: 
*       Return: Success: NAT_STAT_SUCCESS
*               Failure: IPSAFE_FLOWSTAT_GET_ALLINFO_ERR_INPUT_PTR_NULL
*      Caution: None
*        Since: V200R003C01
*    Reference: None
*------------------------------------------------------------------------------
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-05-07   Arjun Sachdeva 00900868  Create the first version.
*
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: IPSAFE_ShowFlowStatisticSwitch
* Date Created: 2010-05-07
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will display the status of the FlowStatistic Switch 
*  Description: It will only display the status of the switch and does not return anything.
*        Input: VOID
*       Output: 
*       Return: VOID
*      Caution: None
...
/*******************************************************************************
*    Func Name: IPSAFE_ShowAllFlowStatisticRule
* Date Created: 2010-05-06
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will display all the flow statistic rules that are 
*               currently configured.
*  Description: This API will display all the rules. If any error occurs, it does 
*               not return anything, but the error messages would be displayed 
*               only if the IPSAFE_SetOutputToCOMSwitch switch is enabled.
*        Input: VOID
*       Output: 
*       Return: VOID
*      Caution: None
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-05-06   Arjun Sachdeva 00900868  Create the first version.
*
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: IPSAFE_ShowFlowStatisticRuleByFlowId
* Date Created: 2010-05-13
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API will display the rule for which the flow ID is provided
*  Description: This function displays the information of the rule corresponding to the 
*               flow ID entered. A valid flow ID that is assigned to the rule by NAT 
*               should be provided as input. If the Flow ID does not exist, an error log will be displayed.
*        Input: UINT32 u32FlowId: Valid ID of a currently existing rule.<>
*       Output: 
*       Return: VOID
*      Caution: None
*        Since: V200R003C01
...
*  DATE         NAME                    DESCRIPTION
*  ----------------------------------------------------------------------------
*  2010-05-13   Arjun Sachdeva 00900868  Create the first version.
*
*******************************************************************************/
VOID IPSAFE_ShowFlowStatisticRuleByFlowId(UINT32 u32FlowId);

/*******************************************************************************
*    Func Name: IPSAFE_ShowAllFlowStatistic
* Date Created: 2010-05-07
*       Author: Arjun Sachdeva 00900868
*      Purpose: Use this API to display all the values for manual and auto flow statistics.
*  Description: This API displays all the information currently held in Manual
*               Statistics and Auto statistics for each rule.
*        Input: VOID
*       Output: 
*       Return: VOID
*      Caution: None
...
/*******************************************************************************
*    Func Name: IPSAFE_ShowFlowStatisticByFlowRule
* Date Created: 2010-05-07
*       Author: Arjun Sachdeva 00900868
*      Purpose: Input a valid rule and this API will display the number of passed, error and dropped
*           packets for that rule.
*  Description: This API displays the Manual and auto flow statistics values for 
*               the rule entered by the user. All parameters of the rule should be filled in correctly, 
*               though the flow statistics ID can be provided as 0, as NAT will match the parameters
*               for the rules and identify the correct flow ID.
*        Input: IPSAFE_FLOWSTATISTIC_RULE_S *pstFlowStatisticRule: Pointer to structure of the type 
*                   IPSAFE_FLOWSTATISTIC_RULE_S with valid values corresponding to a currently existing 
*                   rule.<>
*       Output: 
*       Return: VOID
*      Caution: All values of the rule being input should be valid, else error 
*               would be displayed.
*        Since: V200R003C01
*    Reference: None
*------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: IPSAFE_ShowFlowStatisticByFlowId
* Date Created: 2010-05-07
*       Author: Arjun Sachdeva 00900868
*      Purpose: This API is used to display the number of passed, error, and dropped 
*               packets for the rule corresponding to that flow ID provided as input.
*  Description: This API displays the manual and auto flow statistics values for 
*               the flow ID entered by the user. A valid flow ID that is assigned to the rule by NAT 
*               should be provided as input. If the Flow ID does not exist, an error log will be displayed.
*        Input: UINT32 u32FlowId: Valid ID of a currently existing rule.<>
*       Output: 
*       Return: VOID
*      Caution: The flow ID can vary between 0 and *g_pu32IpsafeFlowStatMaxNum_Share.
*        Since: V200R003C01
*    Reference: None
*------------------------------------------------------------------------------
*  Modification History
