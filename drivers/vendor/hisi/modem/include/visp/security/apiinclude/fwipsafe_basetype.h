...
*   Module Name: Header file containing Security subsystem  basetype definitions.
*   Date Created: 2010-02-25
*   Author: v71873
*   Description: Base type header
*
*-------------------------------------------------------------------------------
*  Modification History
*  DATE         NAME                      DESCRIPTION    
*  -----------------------------------------------------------------------------
*  2010-02-25   v71873                  Create the first version.
*  2010-03-03   Arjun   00900868    Update to suit adapter requirements.
*
*******************************************************************************/
