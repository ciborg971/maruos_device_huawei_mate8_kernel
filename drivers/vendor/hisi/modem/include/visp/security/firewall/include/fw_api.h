...
Description: Header file for firewall interface file in dataplane
Function List:
    FW_Init
    FW_EnableFWModuleByType
    FW_IsEnableFWModuleByType
    FW_ShowFirewallModuleStatus    
History:<author>                        <date>          <desc>
         Ramalingeswara Reddy 72335     2009-08-12      Create
         Varun L A 71873                2009-10-13      Added functions 
                                                         FW_EnableFWModuleByType
                                                         FW_IsEnableFWModuleByType
                                                         FW_ShowFirewallModuleStatus
*************************************************************************/
