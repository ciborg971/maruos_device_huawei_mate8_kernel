...
/**
* @defgroup tagAdFloodPara AD_FLOOD_PARA_S
* @ingroup ADS Attack Defense Structures
* @par Prototype
* @code
...
*
* @par Description
* This structure contains the parameters that can be configured for Flood Attack defense.
* 
* @datastruct u32EnableDefense Indicates whether to enable or disable the defense. 
* This field will not work on global level.
* @datastruct u32MaxRate Indicates maximum packet rate. It can have the following range and default values:
*	- Value range: [1-1000000]
*	- Default value: 1000
* @datastruct u32EnableBlkList Indicates whether to add source IP to blacklist when flooding happens.
* Once the IP is added to blacklist, firewall will drop all recieved packets from that IP before it reaches
* attack module. It will increase system performance. 
* @datastruct u32BlkTimeout Indicates the blacklist timeout. When any IP added to blacklist from attack 
* module, it will be deleted from blacklist after configured time. Range is 1-1000 mins. 
* A value of 0 mins indicates, it has no timeout feature. The entry will not be deleted from blacklist.
* It can be deleted manually.
* @datastruct u32EnableLog Indicates whether to log when a configured flood attack is found.
* If enabled,this will provide the details of the flood attack detected.
* The values can be the following:
*	- 1 to enable logging.
*	- 0 to disable logging.
*/
