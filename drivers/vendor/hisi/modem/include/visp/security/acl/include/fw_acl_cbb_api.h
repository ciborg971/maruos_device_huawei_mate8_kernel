...
/**
* @defgroup ACL_DeleteNode ACL_DeleteNode
* @ingroup accssf ACL Functions
* @par Prototype
* @code
* ULONG ACL_DeleteNode(ULONG ulGroupNum, ULONG ulRuleIndex);
* @endcode 
* 
* @par Description
* This function is used to delete a specific ACL rule or all the ACL rules belonging to 
* the specified group.
* 
* @param[in] ulGroupNum The ACL rule group number. The value for this parameter should lie in between 
* the range for the group numbers provided as the second and third fields of the structure ACL_TYPE_S. []
* @param[in] ulRuleIndex The rule number to delete. If ulRuleIndex is set to 
* ACL_DELETE_ALL_RULE, 0xFFFFFFFF, all the rules under the specified group will be deleted. []
* @param[out]   []
* 
* @retval ULONG On success [Help_ACL_OK|]
* @retval ULONG Indicates error in group number [Help_ACL_GroupNumError|]
...
* @retval ULONG Indicates failure to open ACL interface configuration [ACLFW_ERR_NULL|]
...
* @retval ULONG Indicates failure to open the table [ACLFW_ERR_IF_TABLE|]
* @retval ULONG Indicates memory allocation error [ACLFW_ERR_MEM|]
* 
* @par Dependency
* fw_acl_cbb_api.h
* 
