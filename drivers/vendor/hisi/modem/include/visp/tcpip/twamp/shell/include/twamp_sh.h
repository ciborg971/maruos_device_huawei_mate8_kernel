...
*        Author: a00900872
*   Description: Twamp shell include files
*
*-------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: TWAMP_AllocateClientConfigData
* Date Created: 2013-04-25
*       Author: a00902361
*  Description: TWAMP Allocate Client config data
*        Input: TCPIP_TWAMP_CTRLCLIENT_CONFIG_S *pstClientConf
*
*       Output: 
*       Return:
*
...
*  DATE            NAME             DESCRIPTION
*  ----------------------------------------------------------------------------
*  2013-04-25      a00902361       Create first version
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: TWAMP_FreeClientConfigData
* Date Created: 2013-04-25
*       Author: a00902361
*  Description: TWAMP Free Client config data
*        Input: TCPIP_TWAMP_CTRLCLIENT_CONFIG_S *pstClientConfigData
*
*       Output: 
*       Return:
*
