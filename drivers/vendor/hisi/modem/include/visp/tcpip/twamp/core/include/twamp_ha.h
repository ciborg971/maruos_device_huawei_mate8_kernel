...
*   Module Name: TWAMP HA
*  Date Created: 2013-03-13
*        Author: a00900872
*   Description: Twamp Module HA Functionality
*
*-------------------------------------------------------------------------------
*  Modification History
*  DATE            NAME                DESCRIPTION
*  -----------------------------------------------------------------------------
*  2013-05-03      a00900872       Create first version
*******************************************************************************/
...
/*******************************************************************************
*    Func Name: TWAMP_HA_REGISTER
* Date Created: 2013-05-03
*       Author: a00900872
*  Description:Twamp HA Module Registration
*        Input: 
*       Output: 
*       Return: VOID
*      Caution:
...
/*******************************************************************************
*    Func Name: TWAMP_HA_BatchBackup
* Date Created: 2013-05-03
*       Author: a00900872
*  Description:Twamp HA Module Registration
*        Input: 
...
/*******************************************************************************
*    Func Name: TWAMP_BuildReflectorAddConfigMSG
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Build the Reflector Add Config Message
*        Input:
*                  ULONG ulResponderId Contains the Responder Id[]
...
/*******************************************************************************
*    Func Name: TWAMP_ParseReflectorAddConfigMSG
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Build the Reflector Add Config Message
*        Input:
...
/*******************************************************************************
*    Func Name: TWAMP_BuildReflectorNotifyMSG
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Build the Reflector Notify Message
*        Input:
*
*
*       Output: 
...
/*******************************************************************************
*    Func Name: TWAMP_ParseReflectorNotifyMSG
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Parse the Reflector Notify Message
*        Input:
*
*       Output: 
*       Return:
