...
*        Author: a00900872
*   Description: Twamp base type include files
*
*-------------------------------------------------------------------------------
...
/*TWAMP Events*/
#define TWAMP_REFLECTOR_ADD           0X00000001
#define TWAMP_REFLECTOR_DEL            0X00000002
#define TWAMP_REFLECTOR_LISTEN       0X00000004
#define TWAMP_CLIENT_CONFIG              0X00000008
#define TWAMP_CLIENT_LISTEN               0X00000010
#define TWAMP_REFLECTOR_TIMER          0X00000020
...
/*******************************************************************************
*    Func Name: TWAMP_Begin_PT
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Get global semaphore of visp
*        Input:
*
*
*       Output: 
...
/*******************************************************************************
*    Func Name: TWAMP_End_PT
* Date Created: 2013-03-07
*       Author: a00902361
*  Description: Release global semaphore of visp
*        Input:
*
*
*       Output: 
...
/*******************************************************************************
*    Func Name: TWAMP_ShowAllClients
* Date Created: 2013-06-24
*       Author: s72256
*  Description:
*  TWAMP_ShowAllClients displays the all the clients information within this range.
*  Following fields will be displayed
*   ClientId
*   src_ip
*   peer_ip
*        Input:
*                  UINT32 ulStartIndex: Start index in list
*                  UINT32 ulEndIndex: End Index in list
*
*       Output: 
*       Return:
*
...
*  DATE            NAME             DESCRIPTION
*  ----------------------------------------------------------------------------
*  2013-04-25     a00900872       Create first version
*******************************************************************************/
