...
DECLARE_INTERFACE( IIF_IPV4_IP_PP4_ComIntFUN ) 
{
    ...
    /* method dealing with the UnKown IPv4 packet, called by Queue dispatcher */
    ...
    /* Modified by Sunmo 44939 2006-04-27 */
...
DECLARE_INTERFACE( IIF_IPV4_IP_PP4_ComIntCFG )
{
    ...
    METHOD_(VOID, pfIP_PP4_ClearIpInterface)(struct tagIPIFNET * pstIpIf);
