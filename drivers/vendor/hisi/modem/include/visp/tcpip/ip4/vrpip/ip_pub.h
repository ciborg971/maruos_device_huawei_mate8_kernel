...
typedef struct tagRTENTRY
{
    ...
    /* added by dengqiulin for n*tstre**m 2004.09.11*/
...
/*added by huzhiyong for prefix sync 2002/07/06*/
#define Del_Prefix      1
#define Add_Prefix      2
...
typedef struct tagRTMSG
{
    ...
    #define rtMsg_bNAT              Msg_un.RtInfo_S.bNAT_ext /*added by sunyanfeng for NE20_V5 on 2004.1.3*/
    ...
    /* wuxiaoqian */  
    /* end modified by Robin, 2003.11.12 */
