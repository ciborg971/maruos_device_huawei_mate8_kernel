...
*        Author: a00900892
*   Description: Vtable definitions for atk client component interfaces
*                module VISP
*
*-------------------------------------------------------------------------------
...
/*******************************************************************************
*    Func Name: ATK_InitCom
* Date Created: 2014-08-07
*       Author: a00900892
*  Description: ATK query of Vtable of other modules.
*        Input: COM_ID_INFO_S *pstComInfo:
*               ULONG  ulComLen:
*       Output: 
*       Return: VOS_OK  success
*               VOS_ERR error
...
/*******************************************************************************
*    Func Name: ATK_SetModuleInfo
* Date Created: 2014-08-07
*       Author: a00900892
*  Description: Set ATK module information 
*        Input: ATK_MOD_INFO_S *pstMInfo:Pointing a pointer to the module
