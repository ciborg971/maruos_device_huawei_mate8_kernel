 ...
 ******************************************************************************
  ...
  Created       : 2003/06/25
  Last Modified :
  Description   : Defines prototype for ND function
  Function List :
  History       :
  ------------------------------------------------------------------------------
...
*  ----------------------------------------------------------------------------
Note: HCC ERROR:->19% comments only, in source file  - it is obvious
*******************************************************************************/
#ifndef      _ND_FUNC_H_
#define      _ND_FUNC_H_
...
/* BEGIN : Added by Anand on 07-08-08 for Defect ID: AC4D06540 */
ULONG IP6_ND_FetchNBEntry(ULONG ulIfnetIndex, IN6ADDR_S *pstIPv6Addr,
                                                ND_NBENTRY_INFO_S *pstNBInfo);
/* END : Added by Anand on 07-08-08 for Defect ID: AC4D06540 */
...
/* Begin : Modified prototye by SurajR (72063) for defect AC4D05470 */
ULONG IP6_ND_FindExactMatchCliPrefix(ULONG ulIfnetIndex,
                                              IN6ADDR_S *pstPrefix,
                                              ULONG ulPrefixLength,
                                              ND_PREFIX_S **ppstOutPrefix);

/* End : Modified prototye by SurajR (72063) for defect AC4D05470 */
...
/* BEGIN : Modified By Ahmed for Defect ID: AC4D05729 */
...
/* END : Modified By Ahmed for Defect ID: AC4D05729 */

/* BEGIN: Added by karthik70713,2006/12/5 PN:AC4D01204*/
VOID IP6_ND_ResetDadAttempts (ULONG ulIfnetIndex);

/* END:   Added by karthik 70713, 2006/12/5 */
