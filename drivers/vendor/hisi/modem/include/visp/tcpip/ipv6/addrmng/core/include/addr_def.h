...
*  Author      :        luoli                                          *
*  Modify Date :                                                       *
*  Description :       Header file containing Macros and Data          *
                       Structures                                      *
*  Function    :                                                       *
*  Others      :                                                       *
*----------------------------------------------------------------------*
...
*   Description   : Exception with router restart when change          *
*                   Controller interface mode with IPv6 debug          *
***********************************************************************/
...
/* Begin Modify : For Parasoft Compliance MISRA2004-14_9-3 by Suraj+72063 */
...
/* End Modify : For Parasoft Compliance MISRA2004-14_9-3 by Suraj+72063 */
...
/*  Add begin: 2006-09-14, Rajat Phull R71638, for IPBIRV100R002.IP.E001  */
...
/*Begin:In some case,interface has been deleted after task switch.
       We should add interface protection to make sure ifnet is still exist.
       Added by renjianpeng for SWFD18982 2005-11-9*/
...
/*End of add by renjianpeng for SWFD18982 2005-11-9*/
...
/******************************************************************************
BEGIN : Modified By Rajat Phull for ND-Host, 26/10/2007
For Stateful/Stateless Address Configuration
******************************************************************************/
...
/******************************************************************************
END : Modified By Rajat Phull for ND-Host, 26/10/2007
******************************************************************************/

/* Begin : Add by Suraj_R for NP Support */
...
/*add by wuling for VRF6 project 2013-10-09 --start*/
...
/*add by wuling for VRF6 project 2013-10-09 --end*/
