 ...
 *         Author  : Surya PC
 *     Description : All the definitions could be given in this file
 *------------------------------------------------------------------------------
 ...
 *  2006-09-14     Sandeep          Modify           IPBIRV1R2
       Problem Number: AC4D00997     Author:Sandeep71635,   Date:2006/11/10
       Description    : SetResSpecs APIs Input validation not complete
 ******************************************************************************/
