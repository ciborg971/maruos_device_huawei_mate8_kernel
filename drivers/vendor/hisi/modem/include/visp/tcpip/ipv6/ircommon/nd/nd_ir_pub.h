 ...
 ******************************************************************************
  File Name     : nd_ir_pub.h
  Version       : Initial Draft
  Author        : Sandeep71635
  Created       : 2007/11/26
  Last Modified :
  Description   : nd_ir_pub.h header file
  Function List :
  History       :
  1.Date        : 2007/11/26
    Author      : Sandeep71635
...
typedef struct tagIP6_ND_NHInputParam
{
    ...
    /* Begin:VISP V3R2C10 VRF: added to work Self ping with VRF6 chandra , 2014-05-16 */
    ULONG ulVrfIndex;
    /* End:VISP V3R2C10 VRF: added to work Self ping with VRF6 chandra , 2014-05-16 */
