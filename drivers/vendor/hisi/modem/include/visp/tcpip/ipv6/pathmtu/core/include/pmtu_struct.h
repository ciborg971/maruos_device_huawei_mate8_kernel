...
*
*    Project Code   :  VRP5.0
*    Module Name    :  IP6 PathMTU
*    Version        :  Initial Draft
*    Create Date    :  2003/06/11
*         Author    :  Surya Prakash (surya_pc)
*     Description   :  Header file for declaring all IPV6-Path MTU related
                       Structures.
*------------------------------------------------------------------------------
*  Modification History
*  DATE           NAME             DESCRIPTION
*  -----------------------------------------------------------------------------
*  2003-06-11     Surya            Create
*  2006-09-14     Sandeep          Modify           IPBIRV1R2
   Problem Number : AC4D01274     Author:Sandeep71635,   Date:2006/11/30
   Description    : entry is not deleted after 10 mins when slave switchover
                    is done
*******************************************************************************/
