...
ULONG IP6_Addr_EnableDisableIntfAutoconfig(ULONG ulIfIndex,
                                                        ULONG ulOperation);
/*add by wuling for VRF6 project --start*/
...
/*add by wuling for VRF6 project --end*/
...
/* Added by a00900892 on 2014-09-30 for same subnet address addition */
IP6IFADDR_S *IP6_Addr_IF_FindNetAddrWithPrefix(IN6ADDR_S *pstIn6Addr,
                                             IN6ADDR_S *pstPrefixMask,
                                             IP6IFNET_S *pstIp6If);
/* End of Added by a00900892 on 2014-09-30 for same subnet address addition. */
