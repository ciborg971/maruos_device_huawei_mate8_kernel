...
typedef enum tagIP6_Addr_IClogID
{
    ...
    /* Begin: Added by Santhosh 71702, 2007/12/28
       Description: To display address addition/deletion notification logs */
    ...
    /* End: Added by Santhosh 71702, 2007/12/28 */
...
enum enum_Ip6Addr
{
    ...
    /* Begin : Modify by SurajR (72063) for IAS Support */
    Ip6Addr_Prefix_1_TO_128,

    /* End : Modify by SurajR (72063) for IAS Support */

    /* Begin : Add by SurajR (72063) for IAS Support */
    Ip6Addr_Prefix_1_TO_64,

    /* End : Add by SurajR (72063) for IAS Support */
...
typedef struct tagIP6_ADDR_SH_CALLBACK_FUNC_S
{
    ...
    /***************************************************************************
    BEGIN : Modified By Rajat Phull for ND-Host, 05/11/2007
    ***************************************************************************/
    ULONG (*pfIP6_Addr_SH_Tm_BootInSec)(ULONG *pulSecond, ULONG *pulUSecond);

    /***************************************************************************
    END : Modified By Rajat Phull for ND-Host, 05/11/2007
    ***************************************************************************/
