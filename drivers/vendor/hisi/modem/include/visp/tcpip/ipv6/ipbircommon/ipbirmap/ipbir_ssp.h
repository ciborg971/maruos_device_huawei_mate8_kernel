...
/* Begin : Added by KLSRINI for IPOS */
...
/* Begin: Modified by Guru for DHCP6 Integration;
==> defined PAf/LCS macros*/
#define IPBIR_PAF_GetResource  PAF_GetResource
#define IPBIR_LCS_GetResource  LCS_GetResource

#else                                                           /* for VISP */
#include "ipbircommon/ipbirmap/visp/visp_ssp.h" /*Modified by wan for VISPV1R7,20080501*/
#include "common/visp/tcpip_log.h"  /*Added for VISPV1R7 integration by wan, 2008-05-02*/
...
/* End: Added by Guru for DHCP6 Integration */
