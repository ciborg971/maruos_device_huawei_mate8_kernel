...
/*add by xuying for BYDD00152 2003-10-31 for dopra mib*/
#define SID_MEMSHOWMIB  0x129
#define SID_BUFSHOWMIB  0x117
#define SID_TASKSHOWMIB 0x124
#define SID_CPUSHOWMIB  0x127
/*add over by xuying for BYDD00152 2003-10-31 for dopra mib*/
...
/*added by anhongjie 29671 2002-09-13 for dopra adaption*/
#define SID_SYSCMD 0x122
/*added by anhongjie 29671 2002-09-14 for dopra adaption*/

/*add by anhongjie for D21775*/
#define SID_MON_ASSERT 0x123
/*add by anhongjie for D21775*/

/* add by yangwei24078, 2002/05/08 */
#define SID_VOS_MON_BUF  0x125
#define SID_VOS_MON_LOGFILE_BUF  0x126
/* end of add by yangwei24078 */
...
#if (VRP_VERSION_5 == VRP_YES) /* terry added 2003-07-30 for PAF/LICENSE/SYSTRACE SID */
...
/* Modify-by-David 2000-06-24 */
#define SID_IFNET_CFA_S 0x157
/* End Modify-by-David 2000-06-24 */
...
#endif
/*end modified by yuhui for MFR Project 2003-01-05*/
...
/* added by chenwenjun for optimizing subinterface on 2001/10/30 */
...
/* Robin Check it */
/* #if( VRP_MODULE_MPLS_TE == VRP_YES ) */ /* deleted by Robin, 2003.11.13 */
...
/* #endif */  /* deleted by Robin, 2003.11.13 */
#endif
...
/*added by songyizhen for X25ENH,2002-12-16,VRPV3R001M07*/
...
/*  Added by Leiyikang for X25sw hunt group,2002-12-15,VRPV3R001M07*/
#define SID_X25_HG_IPC_REQ      0x3BA
/*  Added by Leiyikang end */

/*added by jiangxiaobo for X25ENH,2002-12-16,VRPV3R001M07*/
...
/* temporarily added by Panning 2003-05-19 for IPX */
...
#endif
/* end of temporarily added by Panning 2003-05-19 for IPX */
...
/*add by anhongjie 2002-11-29 for oss*/
...
/*added by luoli for IP statistic project 20010905 */
#define MID_IP_STATISTIC        0x11C0000 /* IP--IP_Statistic*/
/*added by guoning 20011109  D12719*/
...
/*Added begin by wangkaixiong for URPF transplan 8070->VRP 2004-04-20*/
#if (VRP_MODULE_IP_URPF == VRP_YES )
#define MID_IP_URPF    0x1580000
#endif
/*Endof added by wangkaixiong 2004-04-20*/

/*Added begin by wangkaixiong for DNS Client transplan 8070->VRP 2004-03-29*/
/* #if ( VRP_MODULE_DNS_CLIENT == VRP_YES ) */
#define MID_DNS_CLIENT    0x1590000
/* #endif */
/*Endof added by wangkaixiong 2004-03-29*/
...
/* Added by GongQianDong(Gade) for MPLS Ping/Traceroute. 2004/08/23 */            
...
#endif
/*YuanLi19850 add 20030618 for SaN*/
...
/*add by chenxia for D23781, 2003/06/25 */
...
#define MID_MPLS_LSPM_SHOW                0x08900000
 /*add by fanying 2002-12-23 for show mpls statistics*/
...
/* #endif */ /* To be deleted - Satya 20040224*/
...
/*added by wangyue 2003.6.10 from 8070-->vrp*/
...
/*added by wangyue 2003.6.21 for medium mib*/
...
/*endof added by wangyue 2003.6.10 from 8070-->vrp*/
...
/* maohongsen change  20040129 add MODULE_NATPT_8011*/
...
/*2003/06/02 zhangwei29537,add for 8070 sync driver,begin*/
#define MID_8070DRVIE_ATME1          0xde150000
#define MID_8070DRIVE_ATME3           0xde160000 /*added by wxf on 2002.11.13*/
#define MID_8070DRIVE_ATM622           0xde170000 /*added by lhm29307 for atm622*/
#define MID_8070DRIVE_GTETH            0xde180000 /*added by llw on 2003.07.16*/
#define MID_8070DRIVE_SETDEVLINK       0xde190000 /*added by llw on 2003.08.26*/
#define MID_8070DRIVE_SD701           0xde1a0000 /*added by h29206 on 2003.10.25*/
/*2003/06/02 zhangwei29537,add for 8070 sync driver,end*/
/*8040产品驱动ID*/
...
#endif
#endif
/*begin added by yanghua at 2002-01-30 for arp proxy */
...
#endif
/*end added by yanghua at 2002-01-30 for arp proxy */
#if (VRP_VERSION_5 == VRP_YES)
...
/*END*/
#define  MID_IP_PBR                      0xe0000000    /* Added for PBR case  20040326 */
/*********************IPC/VP channel id************************************/
/*IPC Tunnel IDs*/
...
/*#endif*/
/* DDR */
/* VRPV3R001M07 Added by Zhangrui 2002/10/24 */ 
#define TID_IPC_DDR        38
/* VRPV3R001M07 Added end */

/*added by sangyuesong for X25ENH,2002-12-16,VRPV3R001M07*/
...
#if((MODULE_GRE_8011 == VRP_YES)||(MODULE_TUNNEL_8011 == VRP_YES)) /* Added by Guo yuedong for GRE, 2002/10/17 */
...
/*yinyuanbin add for blacklist 2003/11/20*/
...
/* Modified by Surya 2004-04-20 Defect BYAD09444 
   Asserts observed in PMTU  */
#if (VRP_MODULE_IPV6 == VRP_YES)
...
/* added by dengqiulin for system level GR 20031203 */
...
/* add by yangwei24078, 2002/05/15 */
#define TID_VP_ASSERT   14
/* end of add by yangwei */

/* add by yuanjie, 2002/09/16 */
#define TID_VP_MEMMON   15
/* end of add by yuanjie */
...
#if( R8070_MODULE_SECP == VRP_YES )
#define MBUF_TR_SECP_IO             0x00000011   /*add by chenruining 2002.11.18 for 3171*/
...
/* end of add for D16109 */


/* added by caozhengbin for D16046 begin */
/*VRF*/
#define WAITLIST_VRF_DETAIL           1067
#define WAITLIST_INTERFACE            1068
#define WAITLIST_ROUTETARGET          1069
/* added by caozhengbin for D16046 end */
...
#if(R8070_MODULE_SECP == VRP_YES)
/*add by chenruining 2002.12.03 for 3171*/
...
/*added by liuxueqin for IPXRM on 2003/05/19*/
...
#define WAITLIST_NE80_QOS_CARBAK_TYPE   2004    /**added by tshi 2003-9-24 for D22782**/
#endif
...
/* Added by Guo yuedong, 2003/9/24 */
...
/* begin added by fengsu VRP3V300R001-PLT-D019 RMON2 */
#if( VRP_MODULE_RMON2 == VRP_YES )
...
#endif
/* end added by fengsu VRP3V300R001-PLT-D019 RMON2 */

#define WAITLIST_PBROUTEMAP_NODE   2511   /* Added for PBR case  20040326 */
