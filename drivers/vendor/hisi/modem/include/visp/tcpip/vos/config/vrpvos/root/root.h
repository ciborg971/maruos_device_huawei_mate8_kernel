...
/* XOT 任务 */
/* added by songyizhen for D24798 , 2003-08-27 */
...
/* LOAD Task: added by yaowang 2001/2/17*/
...
/*add by hanbin for vfs task 2001/09/28*/
#if (VRP_MODULE_VOS_VFS == VRP_YES )
...
/*end add by hanbin for vfs task 2001/09/28*/
...
/*yinyuabin add for bas 2003-06-12*/
...
/* added by yangjianjun for bas web module  2003-06-05 */
...
/* added by yanghua for bas ucm module  2003-06-16 */
...
/* added-by-hurui for 8060 srm 20030110 */
...
#endif
/* end of added-by-hurui 20030110 */

/* added by luoli for 8060 diag 20021209 */
#if( VRP_PRODUCT_8060 == VRP_YES )
...
/* 公共事件位:异步socket事件      */
/*--------------------------------*/
#define VRP_EVENT_ASOCKETREQ        0X00004000
/*--------------------------------*/
/* 公共事件位:配置事件            */
/*--------------------------------*/
#define	VRP_EVENT_CONFIGREQ         0X00002000
/*--------------------------------*/
/* 公共事件位:运行指示事件        */
/*--------------------------------*/
#define	VRP_EVENT_RUNINDICATION     0X00001000
/*--------------------------------*/
/* 公共事件位:任务释放完毕事件    */
/*--------------------------------*/
#define	VRP_EVENT_STANDBYOVER       0X00000800
...
/*--------------------------------*/
#define VRP_SOCK_EVENT_TICK         0X00000400
#define RSTP_PACKET_RECV            0x00010000
#define RSTP_EVENT_NOTIFY           0x00020000

#if (VRP_PRODUCT_GSR==VRP_YES)
/*------------------------------------*/
/* SockRun任务的私有事件:端口状态变化通知事件  */
/*-----------------------------------*/
#define VRP_EVENT_NOTIFY            0X00000800

#define SOCK_PACKET_RSTP            0X00010000
#endif
...
/*added by liuxueqin on 2003/04/24*/
#if( VRP_MODULE_LINK_IPX == VRP_YES )
...
/* BYDD04093 END */
extern   VOID	FIB_RegCmd( VOID ); /*added by guoning 20011109 D12719*/
#endif
#endif
...
/* added by mayun 2001-3-21 */
/* DHCPPRJ:Modified begin by ShuaiKe at 2003/03/22 */
#if ( VRP_IO_BOARD == VRP_NO )
...
/* added by luoli for 8060 diag 20021209 */
/* add-by-hurui for 8060 srm 20030111 */
#if ( VRP_PRODUCT_8060 == VRP_YES )
...
/*Added by wangkaixiong for URPF 8070->VRP 2004.04.20*/
...
/* deleted by LinYongHua, 2000-08-15 */
/* extern  VOID LAPB_Intr( VOID ); */
/* deleted by LinYongHua, 2000-08-15 */
/* added by LinYongHua, 2000-08-15 */
#endif
...
#if( VRP_MODULE_LINK_IPX == VRP_YES )
/* temporarily modified by Panning 2003-05-19 for IPX */

extern ULONG IPXCORE_AllInit(VOID);
/* end of temporarily modified by Panning 2003-05-19 for IPX */
#endif
...
/* yinyuanbin add for bas 2003-06-12 */
#if( VRP_MODULE_BAS_AAA == VRP_YES )
#if( VRP_IO_BOARD == VRP_NO )
...
/*ADDED BY SUNYANFENG FOR TACACS ON 2003.06.18*/
#if( VRP_MODULE_BAS_HWTACACS == VRP_YES )
#if( VRP_IO_BOARD == VRP_NO )
...
/* added by yanghua for bas cm module  2003-06-16 */
#if( VRP_MODULE_BAS_CM == VRP_YES )
#if( VRP_IO_BOARD == VRP_NO )
...
/*added by chenruining 2002.12.24 for 3171*/
...
/*modified by wangchang 2002/06/05 vlan_centeralization*/
...
#endif
#endif
/*endof added by wangyue 2003.6.9 from 8070-->vrp*/

/*added by wangyue 2003.7.23*/
#if(VRP_MAIN_BOARD == VRP_NO && R8070_MEDIUMMIB == VRP_YES)
extern VOID IFMD_Init(VOID);
#endif
/*endof added by wangyue 2003.7.23*/
...
/* added by zhangyilong 27499 for bydd02761 2004-01-30 */
#if( VRP_PRODUCT_GSR == VRP_YES )
