...
#define SCM_CODER_DST_IND_SIZE      (128*1024)      /* 主动上报编码目的通道空间大小 */
...
typedef struct
{
    VOS_CHAR        pucChanName[8];
    VOS_UINT32      ulSendPacketNum;
    VOS_UINT32      ulSendPacketLength;
    VOS_UINT32      ulLastSlice;
}SCM_CODER_DST_DEBUG_STRU;
...
extern VOS_UINT8* SCM_GetDebugLogInfo(VOS_VOID);
