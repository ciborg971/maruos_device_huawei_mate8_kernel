...
/* Added by h00300778 for CDMA 1X SMS, 2014-11-04, begin */
typedef struct
{
...
/* Added by h00300778 for CDMA 1X SMS, 2014-11-04, end */
...
typedef struct
{
    ...
    VOS_UINT8                           ucReserved2;
    VOS_UINT8                           ucReserved3;
}TAF_NVIM_1X_DATA_GENERIC_CONFIG_STRU;
...
/*****************************************************************************
结构名    : TAF_NVIM_EVDO_DATA_GENERIC_CONFIG_STRU
结构说明  : 从NV中读取EVDO数据业务最大无服务的时间
...
typedef struct
{
    VOS_UINT8                           ucEvdoPktDtInactivityTmrLen;

    VOS_UINT8                           ucReserved1;
    VOS_UINT8                           ucReserved2;
    VOS_UINT8                           ucReserved3;
}TAF_NVIM_EVDO_DATA_GENERIC_CONFIG_STRU;
