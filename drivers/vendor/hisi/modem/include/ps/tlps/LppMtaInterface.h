...
typedef struct
{
    ...
    */
    ...
    MTA_LPP_MEAS_REF_TIME_STRU          stMeasRefTime;/*AT中没有找到对应的结构*/
...
typedef struct
{
    ...
    LPP_MTA_AGNSS_REQ_LOCATION_INFO_STRU        stGnssReqLocationInfo; /*AT中没有找到对应的结构*/
...
typedef struct
{
    ...
    */
    ...
    LPP_MTA_GNSS_REALTIME_INTERGRITY_STRU   stGNSSRealTimeIntergrity;/*AT中没有找到对应的接口*/
    LPP_MTA_GNSS_DATA_BIT_ASSIST_STRU       stGNSSDataBitAssistance;/*AT中没有找到对应的接口*/
    LPP_MTA_GNSS_ACQUISIT_ASSIST_STRU       stGNSSAcquisitAssit;/*AT中没有找到对应的接口*/
    LPP_MTA_GNSS_ALMANAC_STRU               stGNSSAlmanac;/*AT中没有找到对应的接口*/
    LPP_MTA_GNSS_UTC_MODEL_STRU             stGNSSUtcModel;/*AT中没有找到对应的接口*/
    LPP_MTA_GNSS_AUX_INFO_STRU              stGNSSAuxInfo;/*AT中没有找到对应的接口*/
...
typedef struct
{
    ...
    */
    ...
    MTA_LPP_GNSS_DIFF_CORRECT_REQ_STRU          stGNSSDiffCorrectReq;/*AT手册中没有找到*/
    MTA_LPP_GNSS_NAVIGATION_MODEL_REQ_STRU      stGNSSNavigationModelReq;
    MTA_LPP_GNSS_REALTIME_INTERGRITY_REQ_STRU   stGNSSRealTimeIntergrityReq;/*AT手册中没有找到*/
    MTA_LPP_GNSS_DATA_BIT_ASSIST_REQ_STRU       stGNSSDataBitAssistanceReq;/*AT手册中没有找到*/
    MTA_LPP_GNSS_ACQUISIT_ASSIST_REQ_STRU       stGNSSAcquisitAssitReq;/*empty*/
    MTA_LPP_GNSS_ALMANAC_REQ_STRU               stGNSSAlmanacReq;/*AT手册中没有找到*/
    MTA_LPP_GNSS_UTC_MODEL_REQ_STRU             stGNSSUtcModelReq;/*AT手册中没有找到*/
    MTA_LPP_GNSS_AUX_INFO_REQ_STRU              stGNSSAuxInfoReq;/*AT手册中没有找到*/
...
typedef struct
{
    ...
    */
    ...
    MTA_LPP_GNSS_SUPPORT_LIST_STRU                  stGnssSupportList;      /*FIXME:AT接口中没有对应的描述*/
    MTA_LPP_ASSISTANCE_DATA_SUPPORT_LIST_STRU       stAssistanceDataSupportList;
    LPP_MTA_COMMON_LOCATION_COORDINATE_TYPE_STRU    stLocationCoordinateTypes;/*FIXME:AT接口中没有对应的描述*/
    MTA_LPP_VELOCITY_TYPES_STRU                     stVelocityTypes;/*FIXME:AT接口中没有对应的描述*/
