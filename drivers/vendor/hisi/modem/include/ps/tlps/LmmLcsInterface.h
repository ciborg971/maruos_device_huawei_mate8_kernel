...
enum LMM_LCS_EST_RESULT_ENUM
{
    ...
    LMM_LCS_EST_RSLT_FAIL_3411_RUNNING              = 7,/* 3411在运行，可以过10s再尝试 */
    LMM_LCS_EST_RSLT_FAIL_SERVICE_FAIL              = 8,/* SERVICE失败，建议2s后再尝试 */
...
enum LMM_LCS_SEND_RSLT_ENUM
{
    ...
    LMM_LCS_SEND_RSLT_RSLT_FAIL_3411_RUNNING        = 7,/* 3411在运行，可以过10s再尝试 */
    LMM_LCS_SEND_RSLT_FAIL_LOW_LAYER                = 8,/* 底层发送失败，建议1s后再尝试 */
