...
enum WPHY_TOOL_MNTN_SLAVE_CS_STATUS_ENUM
{
    ...
    WPHY_MNTN_SLAVE_CS_STATUS_STEP23_RUNNING        = 0x2,                      /* 从模step23运行标记 */
    WPHY_MNTN_SLAVE_CS_STATUS_FINISH                = 0x4,                      /* 从模小区搜索完成标记 */
...
typedef struct
{
    VOS_UINT16                                      uhwScramCodeNum;            /* 扰码 */
    VOS_UINT16                                      uhwFreqInfo;                /* 频点 */
