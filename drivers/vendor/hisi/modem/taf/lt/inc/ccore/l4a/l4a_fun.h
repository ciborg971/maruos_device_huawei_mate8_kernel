...
extern VOS_UINT32 l4a_FunPsCgactSetCnf(L4A_PS_MSG_STRU* pData,L4A_FW_MSG_FUN_TABLE_STRU* pstTable,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_FunPsCgactSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
extern VOS_UINT32 l4a_FunPsCgansSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
...
extern VOS_UINT32 l4a_FunPsCgcmodSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
extern VOS_UINT32 l4a_FunPsCgcmodSetCnf(L4A_PS_MSG_STRU* pData,L4A_FW_MSG_FUN_TABLE_STRU* pstTable,VOS_UINT16 usClientId);
...
extern VOS_UINT32 l4a_FunPsDialEndSetCnf(L4A_PS_MSG_STRU* pData,L4A_FW_MSG_FUN_TABLE_STRU* pstTable,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_FunPsDialEndSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
...
extern VOS_UINT32 l4a_FunPsNdisconnSetCnf(L4A_PS_MSG_STRU* pData,L4A_FW_MSG_FUN_TABLE_STRU* pstTable,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_FunPsNdisconnSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
...
extern VOS_UINT32 l4a_FunPsPPPDialSetCnf(L4A_PS_MSG_STRU* pData,L4A_FW_MSG_FUN_TABLE_STRU* pstTable,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_FunPsPPPDialSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid);
...
extern VOS_UINT32 l4a_PktPdpModifyCnf2Aps(L4A_PS_MSG_STRU* pData, VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_PktPdpModifyRej2Aps(L4A_PS_MSG_STRU* pData, VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_PktActivateCnf2Aps(L4A_PS_MSG_STRU* pData,VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_PktActivateRej2Aps(L4A_PS_MSG_STRU* pData, VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_PktDeactivateCnf2Aps(L4A_PS_MSG_STRU* pData, VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
extern VOS_UINT32 l4a_PktDeactivateRej2Aps(L4A_PS_MSG_STRU* pData, VOS_UINT32 ulAtCnfMsgId,VOS_UINT16 usClientId);
...
extern LIST_S* l4a_GetNodeHead(VOS_VOID);
