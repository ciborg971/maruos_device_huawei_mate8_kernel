...
VOS_UINT32 l4a_FunPsNdisconnSetReq(L4A_DATA_MSG_STRU* pData,VOS_UINT32 ulPsReqMsgId,VOS_UINT32 ulPsReqPid)
{
    ...
    if(0 != pstReq->stDialPara.usAuthType)
    {
       ...
       (VOS_VOID)VOS_MemCpy(stReq.stGwAuthInfo.aucUserName,pstReq->stDialPara.aucUserName,APP_ESM_MAX_USER_NAME_LEN); /* [false alarm]: 屏蔽Fortify错误 */

       /* PASSWORD*/
       stReq.stGwAuthInfo.ucPwdLen = pstReq->stDialPara.ucPwdLen;
       (VOS_VOID)VOS_MemCpy(stReq.stGwAuthInfo.aucPwd,pstReq->stDialPara.aucPassword,APP_ESM_MAX_PASSWORD_LEN); /* [false alarm]: 屏蔽Fortify错误 */
