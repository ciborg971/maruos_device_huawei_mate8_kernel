...
/*****************************************************************************
 Func Name    : TAF_XPDS_SndControlPlaneLinkStart_CpLinkCtrl
 Description  : function for sending ID_TAF_XPDS_XPDS_CP_LINK_START_REQ
...
/*****************************************************************************
 Func Name    : TAF_XPDS_SndInternalCpLinkResultMsg_CpLinkCtrl
 Description  : function for sending ID_TAF_XPDS_XPDS_CP_LINK_START_RESULT
