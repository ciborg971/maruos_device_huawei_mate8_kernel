...
*****************************************************************************/
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGetValue
 Description  : Common function for decoding,
                - Process on 32 bit buffer and decodes the desired number of bits
                  and outputs the 32 bit value
 Input        : ucNumOfBits - The number of bits to decode
                pulTotalBitsPrc - Total number of bits already processed.
                                    This is incremented within the function
                pucCurrBuf  - The buffer memory to decode
                pulCurIdx - The byte index of the buffer being decoded
                                Can be useful to determine the pucCurrBuf address
 Output       : ulTempVal - The 32 bit decoded output.
                                need to typecast to the desired data type after getting

 Usage Example : - No need to increment any values outside, direct use.
                     Only take care of the buffer memory address and the index before the fist call
...
)
{
    ...
    ucOffset    = (VOS_UINT8)(0x01 << (7 - ucBitPos));
...
)
{
    ...
    for (ucIndex = 0; ucIndex < ucBitNum; ucIndex++)
    {
        ...
        if (0 != ucTheBitNum)
        {
            ulResult += 0x01 << (ucBitNum - ucIndex - 1);
        }
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGetRespHandler
 Description  : get the response handler function address based on resp type
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGetReqHandler
 Description  : get the request handler function address based on req type
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGPSEphimeries
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_PROV_GPS_EPHM
                    - The message could be in parts,
                    if any new message is recieved, a timer is started till all messages are recieved

 Input          :   pucHeadBuf
                    - The buffer containing the GpsEphimeris data
 Output         :   The decoded values are stored in context
                    The response flag is set only if all parts are recieved.
                        - Its concidered that the parts will come in order from part number 0 to ucTotalParts
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGpsAlmanac
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_PROV_GPS_ALM
                     - The message could be in parts,
                     if any new message is recieved, a timer is started till all messages are recieved

  Input          :   pucHeadBuf
                     - The buffer containing the GpsAlmanac data
  Output         :   The decoded values are stored in context
                     The response flag is set only if all parts are recieved.
                         - Its concidered that the parts will come in order from part number 0 to ucTotalParts
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGpsAcqAssist
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_PROV_GPS_AQU_ASSIS

 Input          :   pucHeadBuf
                    - The buffer containing the GpsAquiAssis data
 Output         :   The decoded values are stored in context
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvLocResp
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_PROV_LOC_RESP

 Input          :   pucHeadBuf
                    - The buffer containing the LocResp data
 Output         :   The decoded values are stored in context
                    The response flag is set
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeReject
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_REJECT

 Input          : pucHeadBuf
                  - The buffer containing the Reject data
 Output         : TODO
                   The response flag is set
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestCancellation
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_REQ_CANCEL
  Input          : pucHeadBuf
                   - The buffer containing the Cancellation data
  Output         : The decoded values are stored in context
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestPilotPhaseMeas
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_REQ_PILOT_PHASE_MEAS

  Input          :  pucHeadBuf
                    - The buffer containing the PilotPhaseMeas req data
  Output         :  The decoded values are stored in context
                    The req flag is set
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestLocResp
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_REQ_LOC_RESP

 Input          :   pucHeadBuf
                    - The buffer containing the LocResp req data
 Output         :   The decoded values are stored in context
                    The req flag is set
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestPseudoRangeMeas
 Description  : Function to decode the message
                TAF_XPDS_FWDLINK_PSUERANGE_MEAS

 Input          :   pucHeadBuf
                  - The buffer containing the PseudoRangeMeas req data
 Output         :   The decoded values are stored in context
                    The req flag is set
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodePdeHeaderInfo
 Description  : decode functions for forward link messages header

  Input          :      pucHeadBuf
                        - The buffer containing the PdeHeader data
                        pstPdeHeader
                        - The pointer for the output values
  Output         :      The decoded values are stored in context
                        ulTotHdrLen - total header length
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGetRespIndex
 Description  : get the index from where the respnse elements begin

 Input          :   pucOneMsgBuf - The buffer to check
                    pstPdeHeader - for the number of requests
 Output         :   The index of the the first response after the req parts in the buffer
...
/* Added by A00903922 for CDMA AGPS Phase2, 2015-8-17, begin */
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeExtReject
 Description  : Function for decoding the message
                TAF_MTA_AGPS_FWDLINK_RSP_EXT_REJECT_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvExtLocResp
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeExtBsCapabilities
 Description  : Function for decoding the message
                TAF_MTA_AGPS_FWDLINK_RSP_EXT_BS_CAP_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeEnhBsAlmanac
 Description  : Function for decoding the message
                TAF_MTA_AGPS_FWDLINK_RSP_ENH_BS_ALM_STRU
...
/* Added by A00903922 for CDMA AGPS Phase2, 2015-8-17, end */

/* Added by l00902690 for CDMA AGPS Phase2, 2015-8-17, begin */

/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestExtLocResp
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_REQ_EXT_LOC_RESP_STRUs
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestExtMsInfo
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestGenLocMeas
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_REQ_EXT_LOC_RESP_STRUs
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestExtCancellation
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestMsgDelayMeas
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestServSysInfo
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeRequestCoarseLocResp
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGpsRealTimeIntInfo
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvDgpsAssis
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGpsCoarAquiAssis
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGpsCoarLocAssis
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvExtGpsHealthInfo
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvExtGpsAlmCorr
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvExtGpsNavBits
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvExtGpsSensiAssis
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGenAquiAssisGlobInfo
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGenAquiAssisSatRec
 Description  : Function for decoding the message
                TAF_XPDS_BS_GLOBAL_INFO_REC_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGenAquiAssisPilotRecTypeSpc
 Description  : Function for decoding the message
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGenAquiAssisPilotRec
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_GEN_AQUI_ASSI_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeGenAquiAssisFreqRec
 Description  : Function for decoding the message
                TAF_XPDS_FWDLINK_RSP_GEN_AQUI_ASSI_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_DecodeProvGenAquiAssis
 Description  : Function for decoding the message
                TAF_MTA_AGPS_FWDLINK_RSP_PROV_GEN_AQUI_ASSI_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_RcvCasDataBurstMsgInd
 Description  : Function for decoding the message
...
/* Added by l00902690 for CDMA AGPS Phase2, 2015-8-17, end */
