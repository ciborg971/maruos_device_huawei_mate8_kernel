...
)
{
    ...
    pstCallStartNtf->ulMsgName          = ID_TAF_MMA_CDMA_MO_CALL_START_NTF;
...
)
{
    ...
    pstCallEndNtf->ulMsgName            = ID_TAF_MMA_CDMA_MO_CALL_END_NTF;
...
)
{
    ...
    pstCallSuccNtf->ulMsgName           = ID_TAF_MMA_CDMA_MO_CALL_SUCCESS_NTF;
...
)
{
    ...
    pstCallRedialNtf->ulMsgName         = ID_TAF_MMA_CDMA_CALL_REDIAL_SYSTEM_ACQUIRE_NTF;
