...
#if (FEATURE_ON == FEATURE_LTE)
/* TAF_APS_MS_ACTIVATING_SUBSTA_WAIT_L4A_ACTIVATE_CNF动作表 */
...
/* TAF_APS_MS_ACTIVATING_SUBSTA_WAIT_L4A_ACTIVATE_CNF_SUSPEND动作表 */
...
#if (FEATURE_ON == FEATURE_LTE)
    /*****************定义TAF_APS_MS_ACTIVATING_SUBSTA_WAIT_L4A_ACTIVATE_CNF的状态转移表**********************/
    TAF_STA_TBL_ITEM( TAF_APS_MS_ACTIVATING_SUBSTA_WAIT_L4A_ACTIVATE_CNF,
                      g_astTafApsMsActivatingSubStaWaitL4aActivateCnfActTbl ),

    /*****************定义TAF_APS_MS_ACTIVATING_SUBSTA_WAIT_L4A_ACTIVATE_CNF_SUSPEND的状态转移表**********************/
