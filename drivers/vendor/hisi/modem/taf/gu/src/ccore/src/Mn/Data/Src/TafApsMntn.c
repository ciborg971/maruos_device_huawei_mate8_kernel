...
/* Added by y00322978 for CDMA Iteration 17, 2015-8-6, begin */
#include "msp_diag_comm.h"
/* Added by y00322978 for CDMA Iteration 17, 2015-8-6, end */
...
)
{
    ...
    pstMsg->ulFinishClSearch         = TAF_APS_GetFinishClSearch();
#endif
