...
/* TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF动作表 */
...
/* TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF_SUSPEND动作表 */
...
TAF_STA_STRU g_astTafApsMsModifyingStaTbl[] =
{
    ...
    /*****************定义TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF的状态转移表**********************/
    TAF_STA_TBL_ITEM( TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF,
                      g_astTafApsMsModifyingSubStaWaitL4aModifyCnfActTbl ),

    /*****************定义TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF_SUSPEND的状态转移表**********************/
