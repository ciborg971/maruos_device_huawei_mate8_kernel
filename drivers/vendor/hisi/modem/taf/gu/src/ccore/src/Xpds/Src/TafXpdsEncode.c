...
/*****************************************************************************
 Func Name    : TAF_XPDS_GetMaskValue
 Description  : mask value to get the specified number of bits left
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeSetValue
 Description  : append number of bits value specified to the output buffer
                - Input is a 4 byte value.
                First append the MSB byte then till byte 4 and then append 5th byte if needed.

 Input          : ulValueToSet - value to be set
                  ucNumOfBits  - The number of bits the value should be encapsulated
                  pulTotalBitsPrc - The bits processed till now
                  pucCurrBuf - The buffer address
                  pulCurIdx - the byte index from the buffer pointer
 Output         : The encoded bit sequence is stored in the pucCurrBuf[pulCurIdx]
  ...
  2.Date        : 03-08-2015
    ...
    Modification: Reduced complexity
*****************************************************************************/
...
)
{
    ...
    if (ucNumOfBits > 24)
    {
        ...
        {
            pucCurrBuf[4]    = (VOS_UINT8)(ucLSBPart << ( 8 - TAF_XPDS_ABS_DIFF(ucBitsProcessedinMSB, ucShiftVal)));
        }
    }
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqGpsAcqAssist
 Description  : encode function for Request GPS aqui assistance, refer 2.2.4.1.3.

 Input          : pstGpsAqui - The values to be encoded is present in this structure
                  pucDestBuf - The destination buffer
                  pulLength  - The resulting bytes length
 Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqLocRsp
 Description  : encode function for Request location response, refer 2.2.4.1.1.

 Input          : pstReqLocRsp - The values to be encoded is present in this structure
                  pucDestBuf - The destination buffer
                  pulLength  - The resulting bytes length
 Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqGpsAlmanac
 Description  : encode function for Request GPS almanac, refer 2.2.4.1.3.

  Input          : pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqGpsEphimeries
 Description  : encode function for Request GPS ephimeries, refer 2.2.4.1.5.

  Input          : pstReEphi  - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReject
 Description  : encode function for reject, refer 2.2.4.2.1.

  Input          : pstReject  - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvMSInfo
 Description  : encode function for provide MS information, refer 2.2.4.2.3.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvPseudoRangMeas
 Description  : encode function for provide psuedo range measurement, refer 2.2.4.2.5.

  Input          : pstProvPr  - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvPilotPhaseMeas
 Description  : encode function for provide pilot phase measurement, refer 2.2.4.2.6.

  Input          : pstProvPp  - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeRspLocRsp
 Description  : encode function for provide location response, refer 2.2.4.2.2.

  Input          : pstLocResp - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeStartDeliverData
 Description  : encode function for start deliver data message.

  Input          : pstStartDl - The values to be encoded is present in this structure
                   pucDestBuf - The destination buffer
                   pulLength  - The resulting bytes length
  Output         : Success/fail
...
#if 0
/* Added by A00903922 for CDMA AGPS Phase2, 2015-8-10, begin */

/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqExtLocRsp
 Description  : encode function for Request location response, refer 2.2.4.1.8
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqEnhBsAlmanac
 Description  : encode function for Request enhanced Bases station almanac,
                    refer 2.2.4.1.9.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqGenAcqAssist
 Description  : encode function for Request general acquisition assistance,
                    refer 2.2.4.1.10.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqExtGpsSensitivityAssist
 Description  : encode function for Request extended GPS Sensitivity assistance
                    refer 2.2.4.1.11.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqExtGpsEphimeris
 Description  : encode function for Request extended GPS ephimeris
                    refer 2.2.4.1.12.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqExtGpsNavMsgBits
 Description  : encode function for Request extended GPS navigation message bits
                    refer 2.2.4.1.13.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeReqDgpsAssistance
 Description  : encode function for Request DGPS Assistance
                    refer 2.2.4.1.14.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeExtReject
 Description  : encode function for Extended reject, refer 2.2.4.2.9.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvExtLocRsp
 Description  : encode function for provide Extended location response,
                refer 2.2.4.2.10.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvExtMsInfo
 Description  : encode function for provide MS information, refer 2.2.4.2.11
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeGenLocGlobalInfoRec
 Description  : sub function of TAF_XPDS_EncodeGenLocMeas
                for encoding TAF_XPDS_GLOBAL_INFO_REC_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeGenLocPrRec
 Description  : sub function of TAF_XPDS_EncodeGenLocMeas
                for encoding TAF_XPDS_PSUEDO_RAND_REC_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeGenLocPrFreqPilotRec
 Description  : sub function of TAF_XPDS_EncodeGenLocMeas
                for encoding TAF_XPDS_PP_FREQ_PILOT_REC_STRU
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvGenLocMeas
 Description  : encode function for Extended reject, refer 2.2.4.2.12.
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeProvExtCancelAck
 Description  : encode function for provide Extended cancelation ack
                refer 2.2.4.2.13
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeGpsCoarseLoc
 Description  : encode function for provide Gps coarse location rsp
                refer 2.2.4.2.14
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeMsgDelayMeas
 Description  : encode function for provide messaging delay measurements
                refer 2.2.4.2.15
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeBearingMeas
 Description  : encode function for provide bearing measurements
                refer 2.2.4.2.16
...
/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeServSysInfo
 Description  : encode function for provide serving system info
                refer 2.2.4.2.17
...
/* Added by A00903922 for CDMA AGPS Phase2, 2015-8-19, end */

#endif

/*****************************************************************************
 Func Name    : TAF_XPDS_EncodeDataBurstMsg
 Description  : encode function for encoding Dtata burst Msg
                refer 3.7.3.3.2.4 of C.S0005-A
...
)
{
    ...
    ulS2        = ((aucImsiData[3] & 0x03) << 8) + aucImsiData[2];
