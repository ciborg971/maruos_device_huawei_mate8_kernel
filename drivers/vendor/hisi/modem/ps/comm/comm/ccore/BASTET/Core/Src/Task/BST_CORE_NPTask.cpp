    ...
    BST_VOID   *const pData )
{
    ...
    {
        BST_DBG_LOG("InquiredSocketProperty BST_SCKT_CMD_SYNC_PROPERTY_START");
        enIpErr                     = m_pSocket->IoCtrl ( BST_SCKT_CMD_SYNC_PROPERTY_START, pData );
    }
    else
    {
        BST_DBG_LOG("InquiredSocketProperty BST_SCKT_CMD_GET_PROPERTY");
