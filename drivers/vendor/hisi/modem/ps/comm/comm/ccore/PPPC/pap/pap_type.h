...
typedef struct tagPppPapInfo
{
    ...
    RELTMR_T ulServerTimeoutID;         /* Server 超时定时器 ID */
    RELTMR_T ulClientTimeoutID;	/* Client 超时定时器 ID*/
    ...
    ULONG ulWaitAuthRspTimeout;             /* 等待AAA鉴权响应超时时间 */
    ULONG ulAuthMaxTransmits;/* 验证请求最大传送次数 */
