...
{
    ULONG ulIndex = 0;
/* BEGIN: Added by jixiaoming at 2011-04-26 */
    ULONG ulIter = 0;
    ULONG ulTotalNum = 0;
/* END: Added by jixiaoming at 2011-04-26 */
...
VOID DHCPS_ShowStateTIMER(  ULONG argc, CHAR * argv [] )
{
    ...
    (VOID)vos_printf ( "\r\n----------------The information of MachineStateTimer-----------------"); /* Modified by jixiaoming at 2011-05-10 for pclint */
...
/* Added start by dongmingzhou 42828 at 2008-12-02 UGW9811V900R001C01 for ADDRESS SUBSYSTEM */
...
/* Added end by dongmingzhou 42828 at 2008-12-02 UGW9811V900R001C01 for ADDRESS SUBSYSTEM */
