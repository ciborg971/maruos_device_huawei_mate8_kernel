...
typedef struct 
{        
    ULONG ulPdpIndex;       /* RP 上下文索引 */
    ULONG ulTeidc;           
    ULONG ulPcfKey;         /* PCF标识 */
    ULONG ulHaAddr;
    ULONG ulCoAAddr;
    ...
    USHORT usFailureCause;    /* 激活或更新失败原因值 */
    USHORT usReleaseCause;    /* 去活原因值 */

    USHORT usIriTargetMap;    /*用于填充到上下文中的bitmap 值*/
    USHORT usIdpTargetMap;    /*用于填充到上下文中的bitmap 值*/
