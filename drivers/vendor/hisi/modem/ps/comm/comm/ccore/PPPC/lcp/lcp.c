...
VOID PPP_LCP_ReceivePacket (VOID *pstLcpInfo, UCHAR* pHead, UCHAR* pPacket, ULONG ulLen)
{
    ...
    PPP_FSM_ReceivePacket(pstFsm, pHead, pPacket, ulLen, ucPppId);/* Modified by liutao 38563 at 2004-09-22 V800R002 for PPP压缩移植 */
    return;
...
USHORT PPP_LCP_extcode(PPPFSM_S *pstFsm, UCHAR ucCode, UCHAR ucId, UCHAR *pHead, UCHAR *pPacket, ULONG
                       ulLen, ULONG ulUserIndex)/* Added by liutao 38563 at 2004-10-08 V800R002 for PPP压缩移植 */
{
    PPP_LCP_OPTION_S *pstGotOptions;
    ULONG ulMagicNumber;
