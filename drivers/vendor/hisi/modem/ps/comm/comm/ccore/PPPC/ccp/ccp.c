...
UCHAR ucCompType;/* Added by liutao 38563 at 2004-09-28 V800R002 for PPP压缩移植 */
...
VOID PPP_CCP_ReceivePacket (VOID *pstCcpInfo, UCHAR* pHead, UCHAR* pPacket, ULONG
                            ulLen, ULONG ulRPIndex)/* Modified by liutao 38563 at 2004-09-22 V800R002 for PPP压缩移植 */
{
    PPPFSM_S *pstFsm;
