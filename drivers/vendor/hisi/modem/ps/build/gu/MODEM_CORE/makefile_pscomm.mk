...
OBC_LOCAL_INC_DIR += \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/common/ND/IPCOMM/Inc \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/ND/NDCLIENT/Inc
endif
...
ifeq ($(CFG_RAT_MODE),RAT_GU)
OBC_LOCAL_SRC_FILE += \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/common/STL/Src/LUPQueue.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsDebug.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsDlProc.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsEntity.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsIpfCtrl.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsMsgProc.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsUlProc.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsIpFragmentProc.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsSoftFilter.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/CdsImsProc.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/FcFlowCtrlMana.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/QosFcChannelFlowCtrl.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/QosFcOm.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/QosFcRabStatus.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/CDS/Src/QosFcStatus.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/common/ND/IPCOMM/Src/IpComm.c \
    $(BALONG_TOPDIR)/modem/ps/comm/comm/ccore/ND/NDCLIENT/Src/IpNdClient.c 
endif
endif
