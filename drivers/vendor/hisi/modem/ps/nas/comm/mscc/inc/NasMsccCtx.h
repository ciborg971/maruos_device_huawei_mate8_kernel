...
enum NAS_MSCC_SYS_ACQ_SCENE_ENUM
{
    ...
    NAS_MSCC_SYS_ACQ_SCENE_AVAILABLE_TIMER_EXPIRED,      /* available定时器超时*/
...
typedef struct
{
    ...
    NAS_MSCC_SYS_PRI_CLASS_ENUM_UINT8   enPrioClass;                    /* 当前系统对应的prio class,目前只在CL模式下有效，GUL下LTE下会赋值,其他模式可以忽略 */
...
{
    VOS_UINT8                           ucCampOnFlg;
    NAS_MSCC_SYS_PRI_CLASS_ENUM_UINT8   en1xPrioClass;  /* sys_type为CDMA2000_1X时的PRI class */
    NAS_MSCC_SYS_PRI_CLASS_ENUM_UINT8   enAIPrioClass;  /* sys_type为CDMA2000_AI时的PRI class */
    VOS_UINT8                           aucRsv[1];
    VOS_UINT16                          usSid;
    VOS_UINT16                          usNid;
...
{
    VOS_UINT8                           ucCampOnFlg;
    NAS_MSCC_SYS_PRI_CLASS_ENUM_UINT8   enHrpdPrioClass;  /* sys_type为CDMA2000_HRPD时的PRI class */
    NAS_MSCC_SYS_PRI_CLASS_ENUM_UINT8   enAIPrioClass;    /* sys_type为CDMA2000_AI时的PRI class */
...
typedef struct
{
    ...
    VOS_UINT8                           ucDataSrvSwitchTo1xFlg;    /* 数据业务切换到1X上标记 */
    VOS_UINT8                           aucRsv[3];
...
typedef struct
{
    VOS_UINT8                           ucSysAcqMoCallFlag;    /* 数据业务切换到1X上标记 */
    VOS_UINT8                           aucRsv[3];
...
typedef struct
{
    ...
    VOS_UINT32                          ulSendPid;      //发送PID
    VOS_UINT32                          ulReceivePid;   //接收PID
