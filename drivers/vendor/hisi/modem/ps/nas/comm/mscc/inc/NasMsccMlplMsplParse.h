...
*****************************************************************************/
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_MLPL_MSPL_SYSTEM_TYPE_ENUM
 Description         : The system Type used in MSPL/MLPL
 1.DATE              : 03/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_MSPL_SYS_PRI_CLASS_ENUM
 Description         : The system priority class Type for system used in MSPL/MLPL
 1.DATE              : 03/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_MSPL_SYS_PRI_ENUM
 Description         : The system priority Type for system used in MSPL/MLPL
 1.DATE              : 03/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_MSPL_HIGHER_PRI_SRCH_TIME_ENUM
 Description         : The higher priority search time used in MSPL
 1.DATE              : 03/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_MSPL_NETWORK_CAP_ENUM
 Description         : The network capability used in MSPL
 1.DATE              : 03/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_CRC_RSLT_ENUM
 Description         : MLPL/MSPL CRC check result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MLPL_RSLT_ENUM
 Description         : MLPL parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MLPL_HDR_RSLT_ENUM
 Description         : MLPL header parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MLPL_REC_RSLT_ENUM
 Description         : MLPL record parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MSPL_RSLT_ENUM
 Description         : MSPL parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MSPL_HDR_RSLT_ENUM
 Description         : MSPL header parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MSPL_ID_RSLT_ENUM
 Description         : MSPL ID parse result
 1.DATE              : 07/04/2015
   AUTHOR            : n00742771
   Modification      : Create
*****************************************************************************/
...
/*****************************************************************************
 Enumeration Name    : NAS_MSCC_PARSE_MSPL_REC_RSLT_ENUM
 Description         : MSPL ID parse result
 1.DATE              : 21/04/2015
   AUTHOR            : n00742771
   Modification      : Create
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_SYS_LOC_TAG_3GPP_STRU
 Description       : Info for system location tag in a MLPL record
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
*****************************************************************************/
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_SYS_LOC_TAG_CDMA2000_STRU
 Description       : Info for system location tag in a MLPL record
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_SYS_LOC_TAG_CDMA2000_HRPD_STRU
 Description       : Info for system location tag in a MLPL record
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
...
/*****************************************************************************
 Union Name        : NAS_MSCC_MLPL_SYS_LOC_TAG_UNION
 Description       : Info for system location tag in a MLPL record
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MSPL_REC_STRU
 Description       : Info for a single MSPL record in MSPL ID
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
*****************************************************************************/
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MSPL_ID_STRU
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MSPL_HEADER_STRU
 ...
 1.Date            : 08/07/2015
   Author          : t00323010
   Modification    : Iteration 16 modify spelling error
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MSPL_STRU
 Description       : Info for a MSPList
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
*****************************************************************************/
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_SYS_LOC_TAG_STRU
 Description       : Info for a system location tag in location param value
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
*****************************************************************************/
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_LOC_PARAM_STRU
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_RECORD_STRU
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_HEADER_STRU
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_LIST_STRU
 Description       : Info for MLPList
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
*****************************************************************************/
...
/*****************************************************************************
 Structure Name    : NAS_MSCC_MLPL_PARSE_CTX_STRU
 Description       : Info for MLPList
 1.Date            : 03/04/2015
   Author          : n00742771
   Modification    : Create
