 ...
 ******************************************************************************
File Name       :   NasMsccFsmBsrTbl.c
Author          :   y00307564
Version         :
Date            :   2015-04-02
Description     :   Contains State Table and Action Tables for better system
                    reselection(BSR) FSM of MSCC Module.
Function list   :
History         :
    1) Date :    2015-04-07
       Author:   x00314862
       Modification: add action table for BSR LTE
******************************************************************************/
...
*****************************************************************************/
/*****************************************************************************
Function Name   :   NAS_MSCC_GetBsrStaTblSize
Description     :   Returns size of bsr sta table
...
/*****************************************************************************
Function Name   :   NAS_MSCC_GetBsrFsmDescAddr
Description     :
Input parameters:   VOS_VOID
