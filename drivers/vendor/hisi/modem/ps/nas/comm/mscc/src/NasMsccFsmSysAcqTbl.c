 ...
 ******************************************************************************
File Name       :   NasMsccFsmSysAcqTbl.c
Author          :   m00312079
Version         :
Date            :   2015-4-3
Description     :   Contains FSM tables and act tables for System Acquire
Function list   :
History         :
    1) Date :
       Author:
...
/*****************************************************************************
Function Name   :   NAS_MSCC_GetSysAcqStaTblSize
Description     :
Input parameters:   VOS_VOID
Outout parameters:  None
Return Value    :   Size of FSM table
...
/*****************************************************************************
Function Name   :   NAS_MSCC_GetSysAcqFsmDescAddr
Description     :
Input parameters:   VOS_VOID
Outout parameters:  None
