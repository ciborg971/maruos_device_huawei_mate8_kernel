...
/*****************************************************************************
 函 数 名  : NAS_MML_GetPlmnSearchPhaseOneTotalTimerCfg
 功能描述  : 获取MML中用固定时长控制第一阶段搜网的配置信息
 输入参数  : 无
 输出参数  : 无
 返 回 值  : MML中用固定时长控制第一阶段搜网的配置信息
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MML_GetPlmnSearchPhaseOneTotalTimerActiveFlag
 功能描述  : 获取是否使用时间控制第一阶段搜网的标记
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_UINT8:是否使用时间控制第一阶段搜网的标记
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MML_GetPlmnSearchPhaseOneTotalTimerLen
 功能描述  : 用固定时长控制第一阶段搜网的配置时长， 单位 s
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_UINT32:用固定时长控制第一阶段搜网的配置时长
 调用函数  :
 被调函数  :
