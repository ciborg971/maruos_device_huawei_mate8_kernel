...
)
{
    ...
    /*LIFUXIN: TODO*/
    /*
     对OTDOA和ECID来说，定位能力信息一开机会报给LPP，而GNSS的能力信息需要请求GPS模块
     所以，这里需要转状态到等GNSS能力回复，后续迭代实现
    */
...
)
{
    ...
    /*判断是否需要补充申请其它辅助信息的:如果辅助数据的transaction 是UE自己创建的，就无需再申请了*/
