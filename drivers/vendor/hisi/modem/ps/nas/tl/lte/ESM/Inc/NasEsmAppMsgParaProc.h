...
extern VOS_VOID NAS_ESM_AppParaQueryPco( VOS_VOID *pRcvMsg );
...
extern VOS_VOID NAS_ESM_AppParaQueryBearType( VOS_VOID *pRcvMsg );
extern VOS_VOID NAS_ESM_AppParaQueryPdpManagType( VOS_VOID *pRcvMsg );
