...
/*****************************************************************************
 Function Name   : NAS_EMM_SndLppStartInd
 Description     : ???LPP???
 Input           : ulMsgId------------------??ID
                   enDataCnfRst-------------????
                   ulEstRst-----------------????
 ...
 Output          : None
 Return          : VOS_VOID
 History         : wangensheng  00324863   2015-08-01  Draft Enact
*****************************************************************************/
...
VOS_VOID    NAS_EMM_SendMrrcDataReq_LppData(LPP_LMM_DATA_REQ_STRU *pstLppLmmDataReq)
{
    ...
    NAS_LMM_MEM_CPY(pstUplinkMsg->stAdditionalInfo.aucMsg,
                    &(pstLppLmmDataReq->ulSessionId), 4);
