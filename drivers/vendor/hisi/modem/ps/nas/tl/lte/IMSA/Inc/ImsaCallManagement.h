...
#define IMSA_CALL_AVAILABILITY_CHECK_RESULT_CONTINUE    0
#define IMSA_CALL_AVAILABILITY_CHECK_RESULT_REJECT      1
#define IMSA_CALL_AVAILABILITY_CHECK_RESULT_CACHED      2
...
extern VOS_UINT32 IMSA_CallAvailabilityCheck(MN_CALL_TYPE_ENUM_UINT8 enCallType,
...
extern VOS_UINT32 IMSA_CallCmdRelAllEmc(VOS_UINT8 ucIsUserDisc);
extern VOS_UINT32 IMSA_CallCmdRelAllNormal(VOS_UINT8 ucIsUserDisc);
...
extern VOS_VOID IMSA_CallSendDsdsSessionMsg(VOS_VOID);
