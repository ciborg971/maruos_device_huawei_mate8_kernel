...
extern  VOS_UINT32  NAS_EMM_MsRegSsWaitAccessGrantIndMsgAppDetachReq(VOS_UINT32  ulMsgId,
                                                 VOS_VOID   *pMsgStru);
extern  VOS_UINT32  NAS_EMM_MsSomeStateSsWtRrcRelIndMsgAppDetachReq( VOS_UINT32  ulMsgId,
                                                 VOS_VOID   *pMsgStru);
...
/*add by lifuxin for Lnas rel process re-construct start*/
...
/*add by lifuxin for Lnas rel process re-construct end*/
/*****************************************************************************
  9 OTHERS
*****************************************************************************/
