 ...
 VOS_VOID  NAS_MMC_ReadDplmnNplmnInfoNvim(VOS_VOID)
{
    ...
    else if (NAS_MMC_HPLMN_TYPE_CT == ucHplmnType)
    {
        ...
        /* 读NV项en_NV_Item_CT_Cfg_Dplmn_Nplmn，失败，直接返回 */
...
/*****************************************************************************
 函 数 名  : NAS_MMC_ReadPlmnSearchPhaseOneTotalTimerCfgNvim
 功能描述  : 读取en_NV_Item_Plmn_Search_Phase_One_Total_Time_CFG
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
