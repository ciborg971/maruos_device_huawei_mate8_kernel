        ...
        struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    pdi = typec_chip_register(di->dev, &tusb320_ops, THIS_MODULE);
    if (NULL == pdi) {
