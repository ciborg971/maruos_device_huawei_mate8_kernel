...
void write_ramdump_info_to_sharemem(void)
{
...
int write_defualt_config_info_to_sharemem(void)
{
	...
	//fix me: compiler options does not support float, do not clear temporarily
	//pConfigOnDDr->gyro_offset[0] = 0.0;
	//pConfigOnDDr->gyro_offset[1] = 0.0;
	//pConfigOnDDr->gyro_offset[2] = 0.0;
