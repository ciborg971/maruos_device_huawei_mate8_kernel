...
{
    {WLAN_MEM_LOCAL_SIZE1 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE , WLAN_MEM_LOCAL_CNT1},  /* 第一级大小，块数 */
    {WLAN_MEM_LOCAL_SIZE2 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_LOCAL_CNT2},   /* 第二级大小，块数 */
    {WLAN_MEM_LOCAL_SIZE3 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_LOCAL_CNT3},
    {WLAN_MEM_LOCAL_SIZE4 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_LOCAL_CNT4},
    {WLAN_MEM_LOCAL_SIZE5 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_LOCAL_CNT5},
    {WLAN_MEM_LOCAL_SIZE6 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_LOCAL_CNT6},
};
...
{
    {WLAN_MEM_EVENT_SIZE1 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_EVENT_CNT1},
    {WLAN_MEM_EVENT_SIZE2 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_EVENT_CNT2},
};
...
{
    {WLAN_MEM_MIB_SIZE1 + OAL_MEM_INFO_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_MIB_CNT1},
};
...
{
    {WLAN_MEM_NETBUF_SIZE1 + OAL_NETBUF_MAINTAINS_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_NETBUF_CNT1},      /* 克隆用netbuf */
    {WLAN_MEM_NETBUF_SIZE2 + OAL_NETBUF_MAINTAINS_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_NETBUF_CNT2},
    {WLAN_MEM_NETBUF_SIZE3 + OAL_NETBUF_MAINTAINS_SIZE + OAL_DOG_TAG_SIZE, WLAN_MEM_NETBUF_CNT3}
};
...
{
    {WLAN_MEM_SDT_NETBUF_SIZE1 + OAL_MEM_INFO_SIZE, WLAN_MEM_SDT_NETBUF_SIZE1_CNT},
    {WLAN_MEM_SDT_NETBUF_SIZE2 + OAL_MEM_INFO_SIZE, WLAN_MEM_SDT_NETBUF_SIZE2_CNT},
    {WLAN_MEM_SDT_NETBUF_SIZE3 + OAL_MEM_INFO_SIZE, WLAN_MEM_SDT_NETBUF_SIZE3_CNT},
    {WLAN_MEM_SDT_NETBUF_SIZE4 + OAL_MEM_INFO_SIZE, WLAN_MEM_SDT_NETBUF_SIZE4_CNT},
};
											...
											oal_uint32 ul_add_tail_room)
{
    ...
    pst_dup_netbuf = OAL_MEM_NETBUF_ALLOC(uc_out_subpool_id, ul_dup_len,OAL_TRUE);
...
OAL_STATIC oal_uint32  oal_mem_create_sdt_netbuf_subpool(oal_mem_pool_id_enum_uint8 en_pool_id)
{
    ...
    for (uc_subpool_id = 0; uc_subpool_id < pst_mem_pool->uc_subpool_cnt; uc_subpool_id++)
    {
        ...
        for (ul_blk_id = 0; ul_blk_id < pst_mem_subpool->us_total_cnt; ul_blk_id++)
        {
            ...
            pst_netbuf = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, pst_mem_subpool->us_len, OAL_TRUE);
            if (OAL_UNLIKELY(OAL_PTR_NULL == pst_netbuf))
            {
...
oal_netbuf_stru* oal_mem_sdt_netbuf_alloc(oal_uint16 us_len, oal_uint8 uc_lock)
{
    ...
    for (uc_subpool_id = 0; uc_subpool_id < pst_mem_pool->uc_subpool_cnt; uc_subpool_id++)
    {
       ...
       // oal_irq_save(&ul_irq_flag, OAL_5115IRQ_OMSNA);
       // OAL_MEM_SPIN_LOCK_BH(pst_mem_subpool->st_spinlock);
        OAL_MEM_SPIN_LOCK_IRQSAVE(pst_mem_subpool->st_spinlock, ul_irq_flag)
        ...
        {
            //OAL_MEM_SPIN_UNLOCK_BH(pst_mem_subpool->st_spinlock);
            //oal_irq_restore(&ul_irq_flag, OAL_5115IRQ_OMSNA);
            OAL_MEM_SPIN_UNLOCK_IRQRESTORE(pst_mem_subpool->st_spinlock, ul_irq_flag)
            continue;
        }
...
oal_uint32  oal_mem_sdt_netbuf_free(oal_netbuf_stru *pst_netbuf, oal_uint8 uc_lock)
{
    ...
    //oal_irq_save(&ul_irq_flag, OAL_5115IRQ_OMSNF);
    //OAL_MEM_SPIN_LOCK_BH(pst_mem_subpool->st_spinlock);
    OAL_MEM_SPIN_LOCK_IRQSAVE(pst_mem_subpool->st_spinlock, ul_irq_flag)
    ...
    {
       // OAL_MEM_SPIN_UNLOCK_BH(pst_mem_subpool->st_spinlock);
       // oal_irq_restore(&ul_irq_flag, OAL_5115IRQ_OMSNF);
        OAL_MEM_SPIN_UNLOCK_IRQRESTORE(pst_mem_subpool->st_spinlock, ul_irq_flag)
