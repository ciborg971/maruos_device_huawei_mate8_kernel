...
#if ((_PRE_TARGET_PRODUCT_TYPE_5610DMB == _PRE_CONFIG_TARGET_PRODUCT) || (_PRE_TARGET_PRODUCT_TYPE_VSPM310DMB == _PRE_CONFIG_TARGET_PRODUCT))
...
oal_int32  sdt_drv_main_init(oal_void)
{
    ...
    oam_set_output_type(OAM_OUTPUT_TYPE_SDT);
    return OAL_SUCC;
}
