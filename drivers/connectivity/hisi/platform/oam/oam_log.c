        ...
        )
{
    ...
    ul_ret = snprintf(pc_buf,OAM_LOG_PRINT_DATA_LENGTH, KERN_DEBUG"[%s][vap:%d][fid:%3d][%s][%d]%s\n",
...
{   
	if (OAL_SWITCH_ON == oam_get_log_switch(uc_vap_id, en_feature_id, clog_level))
        OAL_PRINT2KERNEL(uc_vap_id, en_feature_id,clog_level,pfunc_local_name, us_line_no, pfunc_addr, fmt, p1, p2, p3, p4);
