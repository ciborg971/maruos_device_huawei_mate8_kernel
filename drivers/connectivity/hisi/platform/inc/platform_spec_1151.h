...
#define WLAN_MEM_LOCAL_CNT2                 (500 * WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) /* 500(杂用)，从200增大到500，proxysta是否需要从800增大到更多，待后续满规格用户关联测试后再定 */
#endif

#define WLAN_MEM_LOCAL_SIZE3                260             /* 存储hmac_vap_cfg_priv_stru，每个VAP一个 + 事件队列 14 *５  */
#define WLAN_MEM_LOCAL_CNT3                 (WLAN_VAP_SUPPORT_MAX_NUM_LIMIT + 500)

#define WLAN_MEM_LOCAL_SIZE4                500             /* 智能天线每个用户alg_smartant_per_user_info_stru */
#define WLAN_MEM_LOCAL_CNT4                 (32 * WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC)  /* 32个用户 */

#define WLAN_MEM_LOCAL_SIZE5                2200            /* ba句柄，核间通信接收消息，原大小由1500扩展为2200 */
#define WLAN_MEM_LOCAL_CNT5                 (320 * WLAN_DEVICE_SUPPORT_MAX_NUM_SPEC) /* ba会话32个 + 32扫描记录beacon帧 */
