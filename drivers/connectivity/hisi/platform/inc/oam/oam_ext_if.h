...
do{ \
        ...
        CHR_LOG(CHR_LOG_INFO, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_INFO, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id,_en_feature_id,p1); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_INFO, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_INFO, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_INFO, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3,p4); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_WARN, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_WARN, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_WARN, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_WARN, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_WARN, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3,p4); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_ERROR, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_ERROR, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_ERROR, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_ERROR, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3); \
	}while(0)
...
do{ \
        ...
        CHR_LOG(CHR_LOG_ERROR, CHR_LOG_TAG_WIFI,"vap_id[%d]:feature_id[%d]:"fmt,_uc_vap_id, _en_feature_id,p1,p2,p3,p4); \
	}while(0)
#else
#define OAM_INFO_LOG0(_uc_vap_id, _en_feature_id, fmt)   \
    OAL_PRINT_NLOGS(OAL_FUNC_NAME, (oal_uint16)THIS_FILE_ID, (oal_uint16)__LINE__, (void*)OAL_RET_ADDR,_uc_vap_id, _en_feature_id, OAM_LOG_LEVEL_INFO, fmt, 0, 0, 0, 0);
...
typedef enum
{
    ...
    OAM_SF_ANY,                             /* rifs protection shortgi frag datarate countrycode
                                            ...
                                            hidessid */
    OAM_SF_ROAM,                            /* roam module, #ifdef _PRE_WLAN_FEATURE_ROAM */
...
OAL_STATIC OAL_INLINE oal_uint32  oam_event_chan_report(oal_uint8 uc_channel_num)
{
    ...
    return oam_event_report(auc_macaddr, 0, OAM_MODULE_ID_HAL, OAM_EVENT_VAP_CHANGE_CHANNEL, auc_event);
}
