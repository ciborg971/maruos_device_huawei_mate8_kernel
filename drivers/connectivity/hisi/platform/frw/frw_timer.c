...
OAL_STATIC oal_void  frw_timer_dump(oal_uint32 ul_core_id)
{
    ...
    while ((pst_timeout_entry != OAL_PTR_NULL) && (pst_timeout_entry != &g_ast_timer_list[ul_core_id]))
    {
                            ...
                            oal_uint32 ul_core_id)
{
    ...
    {
        OAM_INFO_LOG0(0, OAM_SF_FRW, "{frw_timer_create_timer::TIMER has already been created,mod it}");
        return;
    }
    else
    {
