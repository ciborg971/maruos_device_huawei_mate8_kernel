...
#define MAC_HUAWEI_VENDER_IE                               0x00104c /* 打桩HW IE */
...
struct mac_vendor_ie_htinfo
{
    oal_uint8       bit_11ac2g                  :1,          /* 2.4G下11ac vht的能力*/
                    bit_reserve                 :7;
    oal_uint8                        auc_reserve[3];
};
typedef struct mac_vendor_ie_htinfo mac_vendor_ie_htinfo_stru;

struct mac_vendor_ie
{
    ...
    mac_vendor_ie_htinfo_stru		 st_ie;
};
typedef struct mac_vendor_ie mac_vendor_ie_stru;
...
extern oal_uint8* mac_get_bssload_ie(oal_uint8 *puc_frame_body, oal_uint32 us_frame_len, oal_uint16 us_offset);
