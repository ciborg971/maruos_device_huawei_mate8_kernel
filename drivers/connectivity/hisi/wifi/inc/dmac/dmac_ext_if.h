...
typedef struct
{
    oal_uint8    uc_dbb_num_event; /*消息号*/
    oal_uint8    uc_reserved[3];
    oal_uint32   ul_dbb_num;       /*DBB版本号*/

}dmac_atcmdsrv_dbb_num_response_event;

typedef struct
{
    oal_uint8    uc_fem_pa_event; /*消息号*/
    oal_uint8    uc_reserved[3];
    oal_uint32   ul_fem_pa_status;       /*DBB版本号*/
}dmac_atcmdsrv_fem_pa_response_event;
