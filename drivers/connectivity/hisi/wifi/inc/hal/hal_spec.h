...
#ifndef __HAL_SPEC_H__
#define __HAL_SPEC_H__
...
#endif
#ifdef _PRE_WLAN_FEATURE_BTCOEX
    HAL_EVENT_DMAC_MISC_BTCOEX,
    HAL_EVENT_DMAC_SCO_BTCOEX,
    HAL_EVENT_DMAC_AD2P_BTCOEX,
#endif
...
typedef struct
{
    ...
    oal_uint8                       auc_5g_cali_upc_code[2][WLAN_5G_SUB_BAND_NUM];  /* 5G校准的UPC Code */

    /*不同帧的tpc code*/
    oal_uint8                       auc_2g_dsss_ack_cts_tpc_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint8                       aul_2g_ofdm_ack_cts_tpc_code[WLAN_2G_SUB_BAND_NUM];
    ...
    oal_uint8                       aul_5g_ack_cts_tpc_code[WLAN_5G_SUB_BAND_NUM];
...
typedef struct tag_hal_to_dmac_device_stru
{
    ...
    oal_uint32                     uc_cali_check_fem_pa_status;    /*FEM&PA失效检测*/
...
extern oal_void hi1151_rx_init_dscr_queue(hal_to_dmac_device_stru * pst_hal_device);
...
#endif
extern oal_void  hi1151_get_fem_pa_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *ul_cali_check_fem_pa_status);
...
extern oal_void  hi1151_set_dac_lpc_pa_upc_level(oal_uint8 uc_dac_lpf_code, oal_int8 *pac_tpc_level_table,
        oal_uint8 uc_tpc_level_num, oal_uint8 *pauc_dac_lpf_pa_code_table, oal_int16 *pas_upc_gain_table, oal_int16 *pas_other_gain_table);
...
extern oal_void  hi1151_sta_tsf_save(hal_to_dmac_vap_stru *pst_hal_vap);
...
extern oal_void hi1151_tx_get_dscr_iv_ls_word(hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_iv_ls_val, oal_uint8 uc_chiper_type, oal_uint8 uc_chiper_keyid);
...
/************************  1102  DEVICE********************************************/
#define HAL_DEVICE_LEVEL_FUNC_EXTERN
extern oal_void hi1102_rx_init_dscr_queue(hal_to_dmac_device_stru * pst_hal_device);
...
extern oal_void  hi1102_sta_tsf_save(hal_to_dmac_vap_stru   *pst_hal_vap);
#ifdef _PRE_WLAN_FEATURE_P2P
...
#if (_PRE_MULTI_CORE_MODE==_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC)
extern oal_void  hi1102_get_fem_pa_status(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *ul_cali_check_fem_pa_status);
...
extern oal_void hi1102_get_btcoex_abort_cf_end_data_rate(oal_uint32 *ul_cfend_data_rate);
extern oal_void hi1102_get_btcoex_abort_cf_end_phy_mode(oal_uint32 *ul_cfend_phy_mode);
extern oal_void hi1102_get_btcoex_abort_done_cnt(oal_uint32 *ul_abort_done_cnt);
extern oal_void hi1102_get_btcoex_abort_end_cnt(oal_uint32 *ul_abort_end_cnt);
extern oal_void hi1102_get_btcoex_abort_null_data_rate(oal_uint32 *ul_null_data_rate);
extern oal_void hi1102_get_btcoex_abort_null_phy_mode(oal_uint32 *ul_null_phy_mode);
extern oal_void hi1102_get_btcoex_abort_qos_null_seq_num(oal_uint32 *ul_qosnull_seq_num);
extern oal_void hi1102_get_btcoex_abort_selfcts_data_rate(oal_uint32 *ul_selfcts_data_rate);
extern oal_void hi1102_get_btcoex_abort_selfcts_phy_mode(oal_uint32 *ul_selfcts_phy_mode);
extern oal_void hi1102_get_btcoex_abort_start_cnt(oal_uint32 *ul_abort_start_cnt);
extern oal_void hi1102_get_btcoex_all_abort_preempt_type(oal_uint8 *uc_preempt_type);
...
extern oal_void hi1102_get_btcoex_phy_tx_rx_status(oal_uint32 *ul_phy_tx_rx_status);
extern oal_void hi1102_get_btcoex_post_preempt_cnt(oal_uint32 *ul_post_preempt_cnt);
extern oal_void hi1102_get_btcoex_post_preempt_fail_cnt(oal_uint32 *ul_post_preempt_fail_cnt);
extern oal_void hi1102_get_btcoex_preempt_cnt(oal_uint32 *ul_preempt_cnt);
extern oal_void hi1102_get_btcoex_soc_bt_gpreg(oal_uint16 *pus_bt_status);
extern oal_void hi1102_get_btcoex_soc_ble_gpreg(oal_uint16 *pus_ble_status);
...
extern oal_void hi1102_get_btcoex_statistic(oal_void);
...
#endif
extern oal_void hi1102_set_blecoex_abort_timeout_val(oal_uint16 us_ble_time);
extern oal_void hi1102_set_btcoex_abort_cf_end_data_rate(oal_uint32 ul_cfend_data_rate);
extern oal_void hi1102_set_btcoex_abort_cf_end_phy_mode(oal_uint32 ul_cfend_phy_mode);
extern oal_void hi1102_set_btcoex_abort_cnt_clear(oal_void);
extern oal_void hi1102_set_btcoex_abort_null_buff_addr(oal_uint32 ul_abort_null_buff_addr);
extern oal_void hi1102_set_btcoex_abort_null_data_rate(oal_uint32 ul_null_data_rate);
extern oal_void hi1102_set_btcoex_abort_null_phy_mode(oal_uint32 ul_null_phy_mode);
extern oal_void hi1102_set_btcoex_abort_qos_null_seq_num(oal_uint32 ul_qosnull_seq_num);
extern oal_void hi1102_set_btcoex_abort_selfcts_data_rate(oal_uint32 ul_selfcts_data_rate);
extern oal_void hi1102_set_btcoex_abort_selfcts_duration(oal_uint32 ul_selfcts_duration);
extern oal_void hi1102_set_btcoex_abort_selfcts_phy_mode(oal_uint32 ul_selfcts_phy_mode);
extern oal_void hi1102_set_btcoex_abort_timeout_val(oal_uint16 us_bt_time);
extern oal_void hi1102_set_btcoex_all_abort_preempt_type(oal_uint8 uc_preempt_type);
...
extern oal_void hi1102_set_btcoex_max_cnt(oal_uint32 ul_abort_max_cnt);
extern oal_void hi1102_set_btcoex_occupied_period(oal_uint16 ul_occupied_period);
extern oal_void hi1102_set_btcoex_post_preempt_timeout_val(oal_uint32 ul_post_preempt_time);
extern oal_void hi1102_set_btcoex_post_preempt_tx_cnt(oal_uint8 uc_post_preempt_cnt);
extern oal_void hi1102_set_btcoex_rf_stable_time(oal_uint32 ul_rf_stable_time);
extern oal_void hi1102_set_btcoex_sw_all_abort_ctrl(oal_uint8 uc_sw_abort_ctrl);
extern oal_void hi1102_set_btcoex_sw_all_abort_mode(oal_uint8 uc_sw_abort_mode);
...
extern oal_void hi1102_tx_get_dscr_iv_ls_word(hal_tx_dscr_stru *pst_dscr, oal_uint32 *pul_iv_ls_val, oal_uint8 uc_chiper_type, oal_uint8 uc_chiper_keyid);


#ifdef _PRE_WLAN_DFT_STAT
extern oal_void  hi1102_dft_clear_machw_stat_info(hal_to_dmac_device_stru * pst_hal_device);
extern oal_void  hi1102_dft_get_machw_stat_info(hal_to_dmac_device_stru * pst_hal_device,oal_uint32 *pst_machw_stat,oal_uint8 us_bank_select);
...
extern oal_void  hi1102_dft_get_phyhw_stat_info(hal_to_dmac_device_stru * pst_hal_device,oal_uint32 *pst_phyhw_stat,oal_uint8 us_bank_select);
