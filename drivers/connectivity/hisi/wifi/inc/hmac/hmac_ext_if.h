...
typedef enum
{
    ...
    HMAC_HOST_CTX_EVENT_SUB_TYPE_STA_DISCONNET_AP,      /* AP 上报离开BSS的STA情况 */
...
typedef struct
{
    ...
    oal_bool_enum_uint8       en_wait_ack;                          /* 线程唤醒标志 */
...
struct mac_rx_ctl_cut
{
    ...
    oal_uint8                   bit_reserved1         :2;   /* 每个MPDU占用的buf数 */
    /*word 1*/
