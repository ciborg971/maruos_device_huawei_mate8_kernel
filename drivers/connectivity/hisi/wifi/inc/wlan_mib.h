...
typedef enum
{
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_SET_PSM_VOTE                 = 232,      /* 低功耗向平台投票接口 */
    WLAN_CFGID_SET_PSM_OPEN                 = 233,      /* STA低功耗开关接口 */
#endif
    ...
    WLAN_CFGID_DEVICE_MEM_LEAK                      = 497,  /* device 侧mem leak打印接口 */
    ...
    WLAN_CFGID_2040BSS_ENABLE           = 558,   /* 20/40 bss判断使能开关 */
#endif
    /************************************************************************
