...
OAL_STATIC oal_uint32  wal_config_set_pm_mode(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
...
OAL_STATIC oal_uint32  wal_config_set_pm_vote(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
OAL_STATIC oal_uint32  wal_config_set_pm_open(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
#endif
...
/*#ifdef _PRE_WLAN_CHIP_TEST  */
...
#endif
#ifdef _PRE_WLAN_FEATURE_STA_PM
    {WLAN_CFGID_SET_PS_MODE,           OAL_FALSE,  {0},   OAL_PTR_NULL,         wal_config_set_pm_mode},
#ifdef _PRE_PSM_DEBUG_MODE
    ...
    {WLAN_CFGID_SET_PSM_VOTE,          OAL_FALSE,  {0},   OAL_PTR_NULL,          wal_config_set_pm_vote},
    {WLAN_CFGID_SET_PSM_OPEN,          OAL_FALSE,  {0},   OAL_PTR_NULL,          wal_config_set_pm_open},
#endif
...
OAL_STATIC oal_uint32  wal_config_scan_abort(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    OAM_WARNING_LOG1(0, OAM_SF_SCAN, "{wal_config_scan_abort::vap_id[%d] scan abort.}", pst_mac_vap->uc_vap_id);
...
oal_uint32  wal_config_process_pkt(frw_event_mem_stru *pst_event_mem)
{
    ...
    pst_msg       = (wal_msg_stru *)(pst_event->auc_event_data);
    ...
    if (OAL_UNLIKELY(OAL_SUCC != ul_ret))
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_config_process_pkt::hmac_vap_get_priv_cfg return error code %d!}\r\n", ul_ret);
        return ul_ret;
    }

    /* 取返回消息 */
    pst_rsp_msg  = (wal_msg_stru *)pst_cfg_priv->ac_rsp_msg;
    ...
    if(OAL_UNLIKELY(OAL_DOG_TAG != pst_cfg_priv->dog_tag))
    {
        OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY,"{wal_config_process_pkt::pst_cfg_priv dog tag changed:%u!}",
                            pst_cfg_priv->dog_tag);
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
        oal_print_hex_dump((oal_uint8*)pst_msg->auc_msg_data, us_msg_len,
                                32, "msg_data: ");
        oal_print_hex_dump((oal_uint8*)pst_cfg_priv, OAL_SIZEOF(hmac_vap_cfg_priv_stru),
                                32, "pst_cfg_priv: ");
        OAL_BUG_ON(1);
#endif
    }
    ...
    /* 唤醒WAL等待的进程 */
    pst_cfg_priv->en_wait_ack = OAL_TRUE;
    OAL_WAIT_QUEUE_WAKE_UP(&(pst_cfg_priv->st_wait_queue));
...
oal_int32  wal_recv_config_cmd(oal_uint8 *puc_buf, oal_uint16 us_len)
{
    ...
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_event_mem))
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_recv_config_cmd::pst_event_mem null ptr error!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (WAL_MSG_TYPE_QUERY == pst_msg->st_msg_hdr.en_msg_type)
    {
        ...
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{wal_recv_config_cmd::hmac_vap_get_priv_cfg return null_ptr_err!}\r\n");
            return (oal_int32)ul_ret;
        }
        ...
        oal_memcopy(oal_netbuf_data(pst_netbuf) + 1, pst_rsp_msg->auc_msg_data, us_netbuf_len - 1);
...
OAL_STATIC oal_uint32  wal_config_set_pm_vote(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_sync_cmd_common(pst_mac_vap, WLAN_CFGID_SET_PSM_VOTE, us_len, puc_param);
}
OAL_STATIC oal_uint32  wal_config_set_pm_open(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    return hmac_config_sync_cmd_common(pst_mac_vap, WLAN_CFGID_SET_PSM_OPEN, us_len, puc_param);
}
