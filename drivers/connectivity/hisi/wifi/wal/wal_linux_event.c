                                ...
                                oal_bool_enum_uint8          en_need_rsp)
{
    ...
    ***************************************************************************/
    ...
    if(en_need_rsp && (OAL_PTR_NULL != pst_rsp_msg))
    {
        ...
        {
            OAM_WARNING_LOG2(0, OAM_SF_SCAN, "{wal_cfg80211_start_req::wal_send_cfg_event return err code:[%d],wid:[%d]}",
...
oal_uint32  wal_cfg80211_start_scan(oal_net_device_stru *pst_net_dev, mac_cfg80211_scan_param_stru *pst_scan_param)
{
    ...
    /* TBD:gong pst_mac_cfg80211_scan_param在哪释放? */
    ...
    return (oal_uint32)wal_cfg80211_start_req(pst_net_dev,
                                                &pst_mac_cfg80211_scan_param,
                                                OAL_SIZEOF(pst_mac_cfg80211_scan_param),
...
oal_uint32  wal_cfg80211_start_sched_scan(oal_net_device_stru *pst_net_dev, mac_pno_scan_stru *pst_pno_scan_info)
{
    ...
    {
        OAM_WARNING_LOG0(0, OAM_SF_SCAN, "{wal_cfg80211_start_scan::alloc pno scan param memory failed!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    return (oal_uint32)wal_cfg80211_start_req(pst_net_dev,
                                              ...
                                              WLAN_CFGID_CFG80211_START_SCHED_SCAN, OAL_FALSE);
}
