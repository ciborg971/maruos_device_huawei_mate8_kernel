...
oal_uint32  dmac_tid_tx_queue_enqueue_head(dmac_tid_stru *pst_tid_queue, oal_dlist_head_stru *pst_tx_dscr_list_hdr, oal_uint8 uc_mpdu_num)
{
    ...
    {
        OAM_ERROR_LOG0(pst_tid_queue->uc_vap_id, OAM_SF_TX, "{dmac_tid_tx_queue_enqueue_head::pst_user null.}");
    ...
    {
        OAM_ERROR_LOG0(pst_tid_queue->uc_vap_id, OAM_SF_TX, "{dmac_tid_tx_queue_enqueue_head::pst_device null.}");
        DMAC_TID_STATS_INCR(pst_tid_stats->ul_tid_enqueue_head_ptr_null_cnt, uc_mpdu_num);
                                     ...
                                     oal_uint8             uc_is_tid_paused)
{
    ...
    DMAC_EVENT_PAUSE_OR_RESUME_TID(auc_macaddr,
                                   pst_tid->uc_vap_id,
