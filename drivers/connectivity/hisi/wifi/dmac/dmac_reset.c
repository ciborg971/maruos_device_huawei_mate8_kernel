...
OAL_STATIC  oal_uint32 dmac_reset_lut_init(oal_void)
{
   ...
   us_size                     = (WLAN_SERVICE_AP_MAX_NUM_PER_DEVICE+WLAN_SERVICE_STA_MAX_NUM_PER_DEVICE)*2*OAL_SIZEOF(oal_uint32);
   g_st_dmac_reset_mng.pst_tsf = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
   ...
   {
       us_size                              = WLAN_ACTIVE_USER_MAX_NUM*WLAN_TID_MAX_NUM*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_sequence_qos = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
   ...
   {
       us_size                       = WLAN_MAX_RX_BA*WLAN_BA_LUT_ENTRY_SIZE*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_ba_rx = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
   ...
   {
       us_size                             = WLAN_TID_MAX_NUM*WLAN_ACTIVE_USER_MAX_NUM*2*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_rx_pn_ucast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
       ...
       us_size                             = WLAN_ACTIVE_USER_MAX_NUM*2*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_tx_pn_ucast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
       ...
       us_size                             = WLAN_ASSOC_AP_MAX_NUM*WLAN_TID_MAX_NUM*2*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_rx_pn_mcast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
       ...
       us_size          = WLAN_SERVICE_AP_MAX_NUM_PER_DEVICE*2*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_tx_pn_mcast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
   ...
   {
       us_size                      =  WLAN_ACTIVE_USER_MAX_NUM*OAL_SIZEOF(oal_uint32);
       g_st_dmac_reset_mng.pst_txbf = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,us_size,OAL_TRUE);
...
OAL_STATIC oal_uint32 dmac_reset_save_tx_queue(hal_to_dmac_device_stru *pst_hal_device)
{
    ...
    /* 申请fake_fifo_buff */
    pst_fake_buf = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, (HAL_TX_QUEUE_NUM * OAL_SIZEOF(hal_tx_dscr_queue_header_stru)), OAL_TRUE);
...
oal_void dmac_reset_rx_dscr_queue_flush(hal_to_dmac_device_stru* pst_hal)
{
    ...
    hal_rx_init_dscr_queue(pst_hal);
}
