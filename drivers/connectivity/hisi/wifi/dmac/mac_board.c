...
frw_event_sub_table_item_stru g_ast_hmac_hcc_test_event_sub_table[DMAC_HCC_TEST_EVENT_SUB_TYPE_BUTT];
#endif
/*****************************************************************************
DFX公用全局变量定义
*****************************************************************************/
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    frw_event_table_register(FRW_EVENT_TYPE_HMAC_HCC_TEST, FRW_EVENT_PIPELINE_STAGE_0, g_ast_hmac_hcc_test_event_sub_table);
    frw_event_table_register(FRW_EVENT_TYPE_HMAC_HCC_TEST, FRW_EVENT_PIPELINE_STAGE_1, g_ast_hmac_hcc_test_event_sub_table);
#endif
}
...
oal_void  event_fsm_unregister(oal_void)
{
    ...
    OAL_MEMZERO(g_ast_hmac_hcc_test_event_sub_table, OAL_SIZEOF(g_ast_hmac_hcc_test_event_sub_table));
#endif
}
/*lint -e19*/
...
#endif
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
oal_module_symbol(g_ast_hmac_hcc_test_event_sub_table);
#endif
