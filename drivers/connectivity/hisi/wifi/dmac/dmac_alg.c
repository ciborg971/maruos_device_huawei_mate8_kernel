...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_TX_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_TX_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_TX_COMPLETE_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_TX_COMPLETE_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_RX_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_RX_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
oal_uint32  dmac_alg_register_tx_schedule_func(p_alg_tx_schedule_func  p_func)
{
    ...
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "OAL_PTR_NULL == p_func");
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_ADD_VAP_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ADD_VAP_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_DEL_VAP_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_DEL_VAP_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_CHANNEL_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_CHANNEL_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY((en_notify_sub_type >= DMAC_ALG_CFG_USER_BANDWIDTH_NOTIFY_BUTT) || (OAL_PTR_NULL == p_func)))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT or p_func == OAL_PTR_NULL");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY((en_notify_sub_type >= DMAC_ALG_CFG_USER_PROTOCOL_NOTIFY_BUTT) || (OAL_PTR_NULL == p_func)))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_USER_PROTOCOL_NOTIFY_BUTT or p_func == OAL_PTR_NULL");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY((en_notify_sub_type >= DMAC_ALG_CFG_USER_SPATIAL_STREAM_NOTIFY_BUTT) || (OAL_PTR_NULL == p_func)))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{dmac_alg_register_cfg_user_spatial_stream_notify_func::en_notify_sub_type >= p_alg_cfg_user_spatial_stream_notify_func or p_func == OAL_PTR_NULL!}\r\n");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_ADD_USER_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ADD_USER_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_DEL_USER_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_DEL_USER_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_RX_MGMT_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_RX_MGMT_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CONFIG_ID_BUTT|| OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CONFIG_ID_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CONFIG_ID_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CONFIG_ID_BUTT");
        return OAL_FAIL;
    }
...
oal_uint32  dmac_alg_register_dmac_misc_event(hal_dmac_misc_sub_type_enum en_event_type, oal_uint32 (*p_func)(frw_event_mem_stru *))
{
    ...
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_register_dmac_misc_event fail");
        return  OAL_FAIL;
    }
...
oal_uint32  dmac_alg_unregister_dmac_misc_event(hal_dmac_misc_sub_type_enum en_event_type)
{
    ...
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_unregister_dmac_misc_event fail");
        return  OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_ENQUEUE_TID_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ENQUEUE_TID_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_ENQUEUE_TID_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ENQUEUE_TID_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_VAP_UP_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_VAP_UP_DBAC_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_VAP_UP_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_VAP_UP_DBAC_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_VAP_DOWN_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_VAP_DOWN_DBAC_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_VAP_DOWN_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_VAP_DOWN_DBAC_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_PROBE_REQ_RX_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_PROBE_REQ_RX_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_PROBE_REQ_RX_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_PROBE_REQ_RX_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_TX_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_TX_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_TX_COMPLETE_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_TX_COMPLETE_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_RX_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_RX_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_ADD_VAP_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ADD_VAP_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_CFG_CHANNEL_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_CHANNEL_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_USER_BANDWIDTH_NOTIFY_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_CFG_USER_PROTOCOL_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_USER_PROTOCOL_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_USER_SPATIAL_STREAM_NOTIFY_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{dmac_alg_unregister_cfg_user_spatial_stream_notify_func::en_notify_sub_type >= DMAC_ALG_CFG_USER_SPATIAL_STREAM_NOTIFY_BUTT!}\r\n");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_DEL_VAP_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_DEL_VAP_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_DEL_USER_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_DEL_USER_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_ADD_USER_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_ADD_USER_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
{
    if (en_notify_sub_type >= DMAC_ALG_RX_MGMT_NOTIFY_BUTT)
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_RX_MGMT_NOTIFY_BUTT");
        return OAL_FAIL;
    }
                                                       ...
                                                       oal_void                          *p_user_stru)
{
    ...
    pst_alg_info = pst_dmac_user->p_alg_priv;
                ...
                oal_void                           *p_tid_stru)
{
    ...
    pst_alg_info = pst_dmac_user->ast_tx_tid_queue[uc_tid_no].p_alg_priv;
                                        ...
                                        oal_void                     **pp_vap_stru)
{
    ...
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_alg_info))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_get_vap_priv_stru: OAL_PTR_NULL == pst_alg_info");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    *pp_vap_stru = pst_alg_info->p_alg_info[en_vap_stru_type];
    ...
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{dmac_alg_get_vap_priv_stru::pp_vap_stru is null, en_vap_stru_type=%d}", en_vap_stru_type);
        return OAL_ERR_CODE_PTR_NULL;
    }
                ...
                oal_void                          **pp_user_stru)
{
    ...
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_get_user_priv_stru, mac_res_get_dmac_user RETURN NULL PTR.");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    *pp_user_stru = pst_alg_info->p_alg_info[en_user_stru_type];
    ...
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{dmac_alg_get_user_priv_stru::pp_user_stru is null, en_user_stru_type=%d}", en_user_stru_type);
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  dmac_alg_cfg_channel_notify(mac_vap_stru *pst_vap, dmac_alg_channel_bw_chg_type_uint8 en_type)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_CHANNEL_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_channel_notify_func[uc_index](pst_vap, en_type);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_channel_notify::ul_ret=%d, uc_index=%d}", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_cfg_user_bandwidth_notify(mac_vap_stru *pst_vap, mac_user_stru *pst_mac_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_USER_BANDWIDTH_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_user_bandwidth_notify_func[uc_index](pst_vap, pst_mac_user);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_user_bandwidth_notify::ul_ret=%d, uc_index=%d}", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_cfg_user_protocol_notify(mac_vap_stru *pst_vap, mac_user_stru *pst_mac_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_USER_PROTOCOL_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_user_protocol_notify_func[uc_index](pst_vap, pst_mac_user);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_user_protocol_notify::ul_ret=%d, uc_index=%d}", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_cfg_bandwidth_notify(mac_vap_stru *pst_vap, dmac_alg_channel_bw_chg_type_uint8 en_type)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_BANDWIDTH_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_bandwidth_notify_func[uc_index](pst_vap, en_type);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_bandwidth_notify::ul_ret=%d, uc_index=%d}\r\n", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_cfg_user_spatial_stream_notify(mac_user_stru *pst_mac_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_USER_SPATIAL_STREAM_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_user_spatial_stream_notify_func[uc_index](pst_mac_user);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG1(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_user_spatial_stream_notify::pa_cfg_user_spatial_stream_notify_func != OAL_SUCC, uc_index = [%d]!}\r\n", uc_index);
            }
        }
    }
...
oal_uint32 dmac_alg_add_assoc_user_notify(dmac_vap_stru *pst_vap, dmac_user_stru *pst_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_ADD_USER_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_add_assoc_user_notify_func[uc_index](&(pst_vap->st_vap_base_info), &(pst_user->st_user_base_info));

            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG3(pst_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY,
                                 "{dmac_alg_add_assoc_user_notify::ul_ret=%d, user_index=%d, alg_index=%d.}",
                                 ul_ret, pst_user->st_user_base_info.us_assoc_id, uc_index);
                return ul_ret;
            }
        }
    }
...
oal_uint32 dmac_alg_del_assoc_user_notify(dmac_vap_stru *pst_vap, dmac_user_stru *pst_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_DEL_USER_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_delete_assoc_user_notify_func[uc_index](&(pst_vap->st_vap_base_info), &(pst_user->st_user_base_info));
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_alg_del_assoc_user_notify::ul_ret=%d, uc_index=%d}\r\n", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_rx_mgmt_notify(mac_vap_stru *pst_vap,  mac_user_stru *pst_user, oal_netbuf_stru *pst_buf)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_RX_MGMT_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->p_rx_mgmt_func[uc_index](pst_vap, pst_user, pst_buf);
            if ((OAL_SUCC != ul_ret) && (OAL_PTR_NULL != pst_user))
            {
                OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_rx_mgmt_notify:: ul_ret=%d uc_index=%d!}\r\n", ul_ret);
            }
        }
    }
...
oal_uint32  dmac_alg_txbf_rx_cntl_notify(mac_vap_stru *pst_vap,  mac_user_stru *pst_user, oal_netbuf_stru *pst_buf)
{
    ...
    {
        ul_ret = pst_alg_stru->p_txbf_rx_cntl_func(pst_vap, pst_user, pst_buf);
        if (OAL_SUCC != ul_ret)
        {
            OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_txbf_rx_cntl_notify::ul_ret=%d", ul_ret);
        }
    }
...
oal_uint32 dmac_alg_create_vap_notify(dmac_vap_stru *pst_vap)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_ADD_VAP_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_create_vap_notify_func[uc_index]((mac_vap_stru *)pst_vap);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG1(pst_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_alg_create_vap_notify::ul_ret=%d}\r\n", ul_ret);
            }
        }
    }
...
oal_uint32 dmac_alg_delete_vap_notify(dmac_vap_stru *pst_vap)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_DEL_VAP_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_delete_vap_notify_func[uc_index]((mac_vap_stru *)pst_vap);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_alg_delete_vap_notify::ul_ret=%d, uc_index=%d}\r\n", ul_ret, uc_index);
            }
        }
    }
...
oal_uint32  dmac_alg_syn_info(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user)
{
    ...
    if (OAL_PTR_NULL == pst_event_mem)
    {
        OAM_ERROR_LOG1(0, OAM_SF_ANY, "{dmac_alg_syn_info: alloc event failed! size=%d}", OAL_SIZEOF(dmac_to_hmac_syn_info_event_stru));
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_syn_info::frw_event_dispatch_event fail, ul_ret=%d}\r\n", ul_ret);
    }
...
{
    if (OAL_UNLIKELY(en_alg_id >= DMAC_ALG_ID_BUTT))
    {
         OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_unregister en_alg_id >= DMAC_ALG_ID_BUTT");
...
oal_uint32  dmac_alg_unregister(dmac_alg_id_enum_uint32 en_alg_id)
{
    if (OAL_UNLIKELY(en_alg_id >= DMAC_ALG_ID_BUTT))
    {
         OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_unregister OAL_PTR_NULL == p_mac_dev || en_alg_id >= DMAC_ALG_ID_BUTT");
         return OAL_ERR_CODE_ARRAY_OVERFLOW;
    }
...
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == pen_is_registered || en_alg_id >= DMAC_ALG_ID_BUTT))
    {
         OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_unregister en_alg_id >= DMAC_ALG_ID_BUTT");
         return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32   dmac_alg_get_hal_queue_ppdu_num(oal_uint16 us_assoc_id, oal_uint8 uc_ac_num, oal_uint8 *puc_ppdu_num)
{
    ...
    *puc_ppdu_num   = pst_hal_device->ast_tx_dscr_queue[HAL_AC_TO_Q_NUM(uc_ac_num)].uc_ppdu_cnt;
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_SMPS_NOTIFY_BUTT || OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG2(0, OAM_SF_ANY, "dmac_alg_register_cfg_smps_notify_func: en_notify_sub_type=%d, p_func=0x%x", en_notify_sub_type, p_func);
        return OAL_FAIL;
    }
...
{
    if (OAL_UNLIKELY(en_notify_sub_type >= DMAC_ALG_CFG_SMPS_NOTIFY_BUTT))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "en_notify_sub_type >= DMAC_ALG_CFG_SMPS_NOTIFY_BUTT");
        return OAL_FAIL;
    }
...
oal_uint32  dmac_alg_cfg_smps_notify(mac_vap_stru *pst_vap, mac_user_stru *pst_user)
{
    ...
    for (uc_index = 0; uc_index < DMAC_ALG_CFG_SMPS_NOTIFY_BUTT; uc_index++)
    {
        ...
        {
            ul_ret = pst_alg_stru->pa_cfg_smps_notify_func[uc_index](pst_vap, pst_user);
            if (OAL_SUCC != ul_ret)
            {
                OAM_WARNING_LOG2(pst_vap->uc_vap_id, OAM_SF_ANY, "{dmac_alg_cfg_smps_notify::ul_ret=%d, uc_index=%d}\r\n", ul_ret, uc_index);
            }
        }
    }
                                        ...
                                        p_alg_start_stat_rssi_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "register_start_stat_rssi OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  dmac_alg_register_get_rssi_notify(p_alg_get_rssi_func p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "register_get_rssi OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
                                        ...
                                        p_alg_stop_stat_rssi_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "p_alg_stop_stat_rssi_func OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
                                        ...
                                        p_alg_start_stat_rate_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "register_start_stat_rate OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  dmac_alg_register_get_rate_notify(p_alg_get_rate_func p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "register_get_rate OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
                                        ...
                                        p_alg_start_stat_rate_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "p_stop_stat_rate_func OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
                                        ...
                                        p_alg_start_stat_best_rate_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{dmac_alg_register_start_stat_best_rate_notify:: p_func is null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  dmac_alg_register_get_best_rate_notify(p_alg_get_best_rate_func p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{dmac_alg_register_get_best_rate_notify:: p_func is null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
                                        ...
                                        p_alg_stop_stat_best_rate_func   p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{dmac_alg_register_stop_stat_best_rate_notify:: p_func is null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  dmac_alg_register_get_rate_by_table_notify(p_alg_get_rate_by_table_func p_func)
{
    if (OAL_UNLIKELY(OAL_PTR_NULL == p_func))
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "dmac_alg_register_get_rate_by_table_notify OAL_PTR_NULL == p_func");
        return OAL_ERR_CODE_PTR_NULL;
    }
