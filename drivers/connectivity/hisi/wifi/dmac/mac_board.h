...
extern frw_event_sub_table_item_stru g_ast_dmac_hcc_test_event_sub_table[DMAC_HCC_TEST_EVENT_SUB_TYPE_BUTT];
#endif
...
extern frw_event_sub_table_item_stru g_ast_hmac_hcc_test_event_sub_table[DMAC_HCC_TEST_EVENT_SUB_TYPE_BUTT];
#endif
/*****************************************************************************
  5 消息头定义
*****************************************************************************/
