...
oal_uint32 mac_vap_get_smps_en(mac_vap_stru *pst_mac_vap, oal_uint16 *pus_len, oal_uint8 *puc_param)
{
    ...
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_SMPS, "{mac_vap_get_smps_en::pst_mac_device null.}");
...
{
    //pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11APSDOptionImplemented = uc_value;
...
oal_uint32  mac_vap_add_assoc_user(mac_vap_stru *pst_vap, oal_uint16 us_user_idx)
{
    ...
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_add_assoc_user::pst_user null.}");
    ...
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_add_assoc_user::pst_hash null.}");
    ...
    {
        mac_res_free_hash(us_hash_idx);
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_add_assoc_user::user already exist.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
oal_uint32  mac_vap_del_user(mac_vap_stru *pst_vap, oal_uint16 us_user_idx)
{
    ...
    OAL_DLIST_SEARCH_FOR_EACH_SAFE(pst_entry, pst_dlist_tmp, pst_hash_head)
    {
        ...
        if (!oal_compare_mac_addr(pst_user->auc_user_mac_addr, pst_user_temp->auc_user_mac_addr))
        {
            ...
            OAM_WARNING_LOG3(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_del_user::delete user success,mac(0-2)[%.2x:%.2x:%.2x] }",
                                pst_user->auc_user_mac_addr[0],
                                pst_user->auc_user_mac_addr[1],
                                pst_user->auc_user_mac_addr[2]);
            OAM_WARNING_LOG4(pst_vap->uc_vap_id, OAM_SF_ASSOC, "{mac_vap_del_user::mac(3-5)[%.2x:%.2x:%.2x],us_user_idx:%d}",
...
*****************************************************************************/
    ...
    OAL_INLINE oal_uint32  mac_vap_find_user_by_macaddr(
#else
    oal_uint32  mac_vap_find_user_by_macaddr(
#endif
    ...
    if (WLAN_VAP_MODE_BSS_STA == pst_vap->en_vap_mode)
    {
        ...
        if (!oal_compare_mac_addr(pst_mac_user->auc_user_mac_addr, puc_sta_mac_addr))
        {
            *pus_user_idx = pst_vap->uc_assoc_vap_id;
            return (*pus_user_idx != MAC_INVALID_USER_ID) ? OAL_SUCC : OAL_FAIL;
        }
        return OAL_FAIL;
    }
                ...
                oal_uint16          *pus_user_idx)
{
    ...
    {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "mac_res_get_dev return null ");
        return OAL_ERR_CODE_PTR_NULL;
    }
...
OAL_STATIC oal_void  mac_vap_init_mib_11n(mac_vap_stru  *pst_mac_vap)
{
    ...
    pst_mib_info->st_wlan_mib_operation.en_dot11FortyMHzIntolerant      = OAL_FALSE;
    ...
    /* txbf能力信息 */
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11ReceiveStaggerSoundingOptionImplemented  = OAL_TRUE;
    ...
    pst_mib_info->st_wlan_mib_txbf_config.uc_dot11ExplicitCompressedBeamformingFeedbackOptionImplemented = 1;
    ...
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11ReceiveNDPOptionImplemented                           = 0;
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11TransmitNDPOptionImplemented                          = 0;
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11ImplicitTransmitBeamformingOptionImplemented          = 0;
    pst_mib_info->st_wlan_mib_txbf_config.uc_dot11CalibrationOptionImplemented                          = 0;
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11ExplicitCSITransmitBeamformingOptionImplemented       = 0;
    pst_mib_info->st_wlan_mib_txbf_config.en_dot11ExplicitNonCompressedBeamformingMatrixOptionImplemented = 0;
    pst_mib_info->st_wlan_mib_txbf_config.uc_dot11ExplicitTransmitBeamformingCSIFeedbackOptionImplemented = 0;
    pst_mib_info->st_wlan_mib_txbf_config.uc_dot11ExplicitNonCompressedBeamformingFeedbackOptionImplemented = 0;
    ...
    pst_mib_info->st_wlan_mib_operation.en_dot112040BSSCoexistenceManagementSupport = OAL_FALSE;
    pst_mib_info->st_wlan_mib_sta_config.en_dot11SpectrumManagementImplemented      = OAL_FALSE;
}
...
OAL_STATIC oal_void  mac_vap_init_mib_11ac(mac_vap_stru  *pst_mac_vap)
{
    ...
    {
        MAC_ERR_LOG(0, "mac_vap_init_mib_11ac: pst_mac_dev are null!");
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_init_mib_11ac::pst_mac_dev null.}");

        return;
    }

    pst_mib_info = pst_mac_vap->pst_mib_info;
    pst_mib_info->st_wlan_mib_sta_config.en_dot11VHTOptionImplemented = OAL_FALSE;
...
OAL_STATIC oal_void mac_vap_init_11ac_rates(mac_vap_stru *pst_mac_vap,mac_device_stru *pst_mac_dev)
{
    ...
    {
        MAC_ERR_LOG1(pst_mac_vap->uc_vap_id, "mac_vap_init_11ac_rates: en_nss_num is invalid, the num = %d.",pst_mac_dev->en_nss_num);
...
oal_void mac_vap_init_p2p_rates(mac_vap_stru *pst_vap, wlan_protocol_enum_uint8 en_vap_protocol, mac_data_rate_stru  *pst_rates)
{
    ...
    if (OAL_PTR_NULL == pst_mac_dev)
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_init_p2p_rates::pst_mac_dev null.}");
...
oal_void mac_vap_init_rates_by_protocol(mac_vap_stru *pst_vap, wlan_protocol_enum_uint8 en_vap_protocol, mac_data_rate_stru *pst_rates)
{
    ...
    else if ((WLAN_VHT_ONLY_MODE == en_vap_protocol) || (WLAN_VHT_MODE == en_vap_protocol))
    {
        ...
        if (OAL_TRUE == pst_vap->st_cap_flag.bit_11ac2g)
        {
            mac_vap_init_11g_mixed_one_rates(pst_vap, pst_rates);
        }
        else
...
oal_void mac_vap_init_rates(mac_vap_stru *pst_vap)
{
    ...
    if (OAL_PTR_NULL == pst_mac_dev)
    {
        MAC_ERR_LOG(0, "mac_vap_init_rates: pst_mac_dev is null ptr.");
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_init_rates::pst_mac_dev null.}");
...
oal_void mac_dec_p2p_num(mac_vap_stru *pst_vap)
{
    ...
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_p2p_dec_num::pst_device null.}");
        return;
    }
...
oal_void mac_inc_p2p_num(mac_vap_stru *pst_vap)
{
    ...
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_CFG, "{hmac_inc_p2p_num::pst_dev null.}");
        return;
    }
...
oal_uint32 mac_vap_save_app_ie(mac_vap_stru *pst_mac_vap, oal_app_ie_stru *pst_app_ie, en_app_ie_type_uint8 en_type)
{
    ...
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_save_app_ie::scan failed, set ie failed, invalid en_type[%d].}", en_type);
        return OAL_ERR_CODE_INVALID_CONFIG;
    }

    ul_ie_len = pst_app_ie->ul_ie_len;

    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_save_app_ie::en_type[%d], len[%d]}", en_type, ul_ie_len);
    ...
    if ((pst_mac_vap->ast_app_ie[en_type].ul_ie_max_len < ul_ie_len) || (NULL == pst_mac_vap->ast_app_ie[en_type].puc_ie))
    {
        ...
        {
            OAM_ERROR_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_set_app_ie::scan failed, set ie failed, error ie len = %d.}",
        ...
        {
            OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_set_app_ie::scan failed, set ie failed, puc_ie null,len=%d, en_type=%d.}",
...
oal_uint32 mac_vap_exit(mac_vap_stru *pst_vap)
{
    ...
    {
        OAL_MEM_FREE(pst_vap->pst_mib_info, OAL_TRUE);
        pst_vap->pst_mib_info = OAL_PTR_NULL;
    }
#if 0
#ifdef _PRE_WLAN_DFT_STAT
    mac_vap_dft_stat_clear(pst_vap);
#endif
#endif
    /* 释放WPS信息元素内存 */
    ...
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_device))
    {
        OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_exit::pst_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /* 删除之后将vap的状态置位非法 */
    pst_vap->en_vap_state = MAC_VAP_STATE_BUTT;
...
OAL_STATIC oal_void  mac_init_mib(mac_vap_stru *pst_mac_vap)
{
    ...
    {
        MAC_ERR_LOG(0, "mac_init_mib: pst_mac_vap is null param");
...
oal_void  mac_vap_init_rx_nss_by_protocol(mac_vap_stru *pst_mac_vap)
{
    ...
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_init_rx_nss_by_protocol::pst_mac_device null.}");
        return;
    }
...
oal_void  mac_vap_change_mib_by_bandwidth(mac_vap_stru *pst_mac_vap, wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
    ...
    {
        MAC_ERR_LOG1(0, "pst_mib_info is null ptr. vap id is", pst_mac_vap->uc_vap_id);
                ...
                wlan_vap_mode_enum_uint8    en_vap_mode)
{
    ...
    pst_vap->en_vap_mode    = en_vap_mode;
    ...
    switch(pst_vap->en_vap_mode)
    {
        ...
        case WLAN_VAP_MODE_BSS_AP:
            ...
            /* 设置VAP状态为初始状态INIT */
            pst_vap->en_vap_state = MAC_VAP_STATE_INIT;
            ...
            /*将vap状态改变信息上报*/
            mac_vap_state_change_to_sdt(pst_vap, MAC_VAP_STATE_INIT);
...
/* 清mac vap下的uapsd的状态,否则状态会有残留，导致host device uapsd信息不同步 */
        ...
        (WLAN_VAP_MODE_WDS == pst_vap->en_vap_mode))
    {
        ...
        if (OAL_PTR_NULL == pst_vap->pst_mib_info)
        {
            OAM_ERROR_LOG0(pst_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_init::pst_mib_info null.}");
            return OAL_ERR_CODE_ALLOC_MEM_FAIL;
        }
        ...
        if (WLAN_VAP_MODE_BSS_STA == pst_vap->en_vap_mode)
        {
            ...
            switch(pst_mac_device->en_protocol_cap)
            {
                ...
                default:
                     OAM_WARNING_LOG0(0, OAM_SF_CFG, "{mac_vap_init::en_protocol_cap is not supportted.}");
            ...
            switch(pst_mac_device->en_bandwidth_cap)
            {
                ...
                default:
                     OAM_WARNING_LOG0(0, OAM_SF_CFG, "{mac_vap_init::en_bandwidth_cap is not supportted.}");
                     return OAL_ERR_CODE_CONFIG_UNSUPPORT;
            ...
            switch(pst_mac_device->en_band_cap)
            {
                ...
                default:
                     OAM_WARNING_LOG0(0, OAM_SF_CFG, "{mac_vap_init::en_band_cap is not supportted.}");
                     return OAL_ERR_CODE_CONFIG_UNSUPPORT;
...
oal_void  mac_vap_state_change_to_sdt(mac_vap_stru *pst_mac_vap, mac_vap_state_enum_uint8 en_vap_state)
{
...
#endif
    /* 获取vap之前状态以及将要变为的状态 */
    auc_event_info[0] = pst_mac_vap->en_vap_state;
    auc_event_info[1] = en_vap_state;
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_vap_state_change_to_sdt:from[%d]to[%d]}",pst_mac_vap->en_vap_state,en_vap_state);
    MAC_EVENT_STATE_CHANGE(auc_macaddr,
...
oal_void  mac_vap_add_proxysta_dev(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_msg)
{
    ...
    if (OAL_TRUE == pst_mac_vap->st_vap_proxysta.en_is_proxysta)
    {
        ...
        {
            OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_PROXYSTA, "{mac_vap_add_proxysta_dev::pst_event_mem null.}");
                                       ...
                                       mac_cfg80211_connect_security_stru *pst_mac_security_param)
{
    ...
    switch(pst_mac_security_param->en_pmf_cap)
    {
        ...
        default:
        {
            OAM_INFO_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_PMF,"mac_11w_init_privacy::Error pmf cap[%d]!!",pst_mac_security_param->en_pmf_cap);
            return OAL_FALSE;
        }
    }
    ...
    {
        OAM_INFO_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_PMF,"mac_11w_init_privacy::User(ap) pmf status[%d]!!",pst_mac_security_param->en_mgmt_proteced);
...
mac_user_stru  *mac_vap_get_user_by_addr(mac_vap_stru *pst_mac_vap, oal_uint8  *puc_mac_addr)
{
    ...
    MAC_11I_ASSERT_PRINTERR1((OAL_FAIL != ul_ret), OAL_PTR_NULL, pst_mac_vap,
                             "{mac_11i_get_mac_user::mac_vap_find_user_by_macaddr failed[%d].}",
                             ul_ret);

    /*根据sta索引找到user内存区域*/
    pst_mac_user = (mac_user_stru *)mac_res_get_mac_user(us_user_idx);
    MAC_11I_ASSERT_PRINTERR1((OAL_PTR_NULL != pst_mac_user), OAL_PTR_NULL, pst_mac_vap,
                            "{mac_11i_get_mac_user::pst_current_mac_user null, us_user_idx=%d.}",
                             us_user_idx);
...
oal_uint8 mac_vap_get_default_key_id(mac_vap_stru *pst_mac_vap)
{
    ...
    if (OAL_PTR_NULL == pst_multi_user)
    {
        ...
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_WPA, "{mac_vap_get_default_key_id::multi_user NULL}");
        return 0;
    }
...
oal_module_symbol(mac_vap_state_change_to_sdt);
#if 0
