                   ...
                   oal_uint16               *pus_amsdu_maxsize)
{
    ...
    {
        MAC_ERR_LOG(0, "pst_hmac_sta or puc_payload or pus_index or pst_hmac_user_ap or pus_ht_cap_info is NULL");
...
oal_uint8  mac_ie_get_chan_num(oal_uint8 *puc_frame_body, oal_uint16 us_frame_len, oal_uint16 us_offset,oal_uint8 uc_curr_chan)
{
    ...
    //puc_ie_start_addr = mac_get_ht_opern_ie(puc_frame_body, us_frame_len, us_offset);
    ...
    //OAM_INFO_LOG0(0, OAM_SF_ANY, "{mac_ie_get_chan_num::do not find HT operation ie.}");

    /* 在DSSS Param set ie中解析chan num */
    //puc_ie_start_addr = mac_get_dsss_param_ie(puc_frame_body, us_frame_len, us_offset);
    ...
    //OAM_INFO_LOG0(0, OAM_SF_ANY, "{mac_ie_get_chan_num::do not find Dsss param ie.}");
                ...
                oal_uint8                           *puc_output_len)
{
    ...
    *puc_output_len = 0;
    ...
    switch(en_bw)
    {
        ...
        default:
            OAM_ERROR_LOG0(0, OAM_SF_SCAN, "{mac_set_second_channel_offset_ie::invalid bandwidth.}");
                ...
                oal_uint8                           *puc_output_len)
{
    ...
    *puc_output_len  = 0;
    ...
    switch(en_bw)
    {
        ...
        default:
            OAM_ERROR_LOG0(0, OAM_SF_SCAN, "{mac_set_11ac_wideband_ie::invalid bandwidth.}");
