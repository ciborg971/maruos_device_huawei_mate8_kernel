...
typedef struct
{
    ...
    oal_uint32  ul_rssi_ignore;         /* 漫游触发器忽略rssi   */
...
typedef struct dmac_vap_tag
{
    ...
    oal_uint8                        uc_sta_pm_on   :4;                         /* sta 低功耗状态 */
    oal_uint8                        uc_cfg_pm_mode_manual   :4;                /* sta低功耗手动设置模式 */
    oal_uint8                        uc_cfg_manual_pm_mode;                     /* 手动挡保存的低功耗模式 */
    oal_uint8                        auc_resv0;
    /* 重传次数上限 */
    ...
    oal_uint8                        uc_p2pgo_scan_beacon_cnt;
    oal_uint16                       us_p2pgo_scan_time;                /* go背景扫描信道切离时间 */
