...
#define  DMAC_DFT_LINKLOSS_DATA_LEN              300
#endif
...
extern oal_uint32  dmac_dft_tid_stat_init(mac_user_stru  *pst_mac_user);
#endif
...
extern oal_uint32  dmac_dft_ampdu_stat_init(mac_user_stru  *pst_mac_user);
