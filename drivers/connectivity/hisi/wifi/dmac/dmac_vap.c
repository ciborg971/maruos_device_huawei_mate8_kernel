...
OAL_STATIC oal_uint32 dmac_keepalive_init(mac_vap_stru *pst_mac_vap)
{
    mac_device_stru    *pst_mac_device;

    if (OAL_PTR_NULL == pst_mac_vap)
    {
        OAM_ERROR_LOG0(0, OAM_SF_KEEPALIVE, "{dmac_keepalive_init::pst_mac_vap null.}");
    ...
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_KEEPALIVE, "{dmac_keepalive_init::pst_mac_device null.}");
        return OAL_ERR_CODE_KEEPALIVE_PTR_NULL;
    }

    pst_mac_device->st_keepalive_dev.ul_keepalive_limit        = WLAN_USER_AGING_TIME - WLAN_USER_KEEPALIVE_WAIT_TIME;
    pst_mac_device->st_keepalive_dev.us_keepalive_interval     = WLAN_USER_KEEPALIVE_INTERVAL;
    pst_mac_device->st_keepalive_dev.uc_keepalive_num          = (oal_uint8)(OAL_GET_KEEPALIVE_LIMIT(pst_mac_device) / WLAN_USER_KEEPALIVE_INTERVAL);
    pst_mac_device->st_keepalive_dev.uc_aging_to_keepalive_num = WLAN_USER_KEEPALIVE_INTERVAL / WLAN_USER_AGING_TRIGGER_TIME;
...
oal_void dmac_vap_linkloss_init(dmac_vap_stru *pst_dmac_vap)
{
    ...
    pst_dmac_vap->st_linkloss_info.ul_old_dot11BeaconPeriod = ul_dot11BeaconPeriod;
    ...
    {
        pst_dmac_vap->st_linkloss_info.us_linkloss_threshold  = (oal_uint16)(20); /* 2s */
    }
...
#endif
    /* 初始化保活间隔时间,单位ms */
    dmac_keepalive_init(&pst_dmac_vap->st_vap_base_info);
...
oal_void dmac_vap_init_tx_data_ucast(dmac_vap_stru *pst_dmac_vap,oal_uint8 uc_protocol_mode, oal_uint8 uc_legacy_rate)
{
    ...
    OAM_WARNING_LOG1(pst_dmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_vap_init_tx_data_ucast::bit_protocol_mode:%d.}",
                     uc_protocol_mode);
...
oal_uint32  dmac_vap_init_tx_ucast_data_frame(dmac_vap_stru *pst_dmac_vap)
{
    ...
    OAM_WARNING_LOG1(pst_dmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_TX,
                     "{dmac_vap_init_tx_ucast_data_frame::en_protocol[%d].}", en_protocol);
    ...
    switch(en_protocol)
    {
        ...
        default:
            OAM_WARNING_LOG1(pst_dmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_TX,
                             "{dmac_vap_init_tx_ucast_data_frame::invalid en_protocol[%d].}", en_protocol);
        return OAL_FAIL;
    }
