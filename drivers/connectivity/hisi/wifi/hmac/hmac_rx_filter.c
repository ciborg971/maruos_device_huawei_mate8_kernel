...
oal_uint32 g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BUTT][MAC_VAP_STATE_BUTT];
oal_uint32 g_ast_repeater_mode_rx_filter[WLAN_VAP_MODE_BUTT][MAC_VAP_STATE_BUTT];
oal_uint32 g_ast_p2p_mode_rx_filter[WLAN_VAP_MODE_BUTT][MAC_VAP_STATE_BUTT];
...
*****************************************************************************/
oal_void  hmac_rx_filter_init_normal(oal_void)
{
    oal_uint32  ul_state;
    ...
    {
        g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_CONFIG][ul_state] = 0;
    }

    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_CONFIG][MAC_VAP_STATE_INIT] = 0x37B9EEFA;
    ...
    for (ul_state = MAC_VAP_STATE_INIT; ul_state < MAC_VAP_STATE_BUTT; ul_state++)
    {
        g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][ul_state] = 0;
    }

    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_INIT]             = 0x37B9EEFA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_UP]               = 0x33B9EADA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_STA_FAKE_UP]      = 0x37B9EEFA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_STA_WAIT_SCAN]    = 0x37B9CEEA;

    for (ul_state = MAC_VAP_STATE_STA_SCAN_COMP; ul_state <= MAC_VAP_STATE_STA_AUTH_COMP; ul_state++)
    {
        g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][ul_state] = 0x37B9EEDA;
    }

    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_STA_WAIT_ASOC] = 0x33B9EEDA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_STA_OBSS_SCAN] = 0x37B9CEEA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_STA_BG_SCAN]   = 0x37B9CEEA;
    ...
    /* | MAC_VAP_STATE_AP_WAIT_START      | 0                        | */
    /* | MAC_VAP_STATE_AP_PAUSE           | 0                        | */
    /* +----------------------------------+--------------------------+ */
    for (ul_state = MAC_VAP_STATE_INIT; ul_state < MAC_VAP_STATE_BUTT; ul_state++)
    {
        g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_AP][ul_state] = 0;
    }

    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_AP][MAC_VAP_STATE_INIT]             = 0x37B9EEFA;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_AP][MAC_VAP_STATE_UP]               = 0x33B9EAEA;

    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_AP][MAC_VAP_STATE_AP_WAIT_START]    = 0x37B9EEEA;
    ...
    for (ul_state = MAC_VAP_STATE_INIT; ul_state < MAC_VAP_STATE_BUTT; ul_state++)
    {
        g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_MONITOER][ul_state] = 0x1;
    }

    /* 特殊特性相关寄存器控制位 */
#if(_PRE_WLAN_FEATURE_PMF == _PRE_PMF_HW_CCMP_BIP)
    /* bip帧接受过滤控制,bit31:bip重放攻击过滤(不过滤，基于兼容性考虑); bit30:bip mic校验失败过滤 */
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_UP]   |= 0x40000000;
    g_ast_normal_mode_rx_filter[WLAN_VAP_MODE_BSS_AP][MAC_VAP_STATE_UP]    |= 0x40000000;
#endif
}
...
oal_void  hmac_rx_filter_init_p2p(oal_void)
{
    ...
    g_ast_p2p_mode_rx_filter[WLAN_VAP_MODE_BSS_STA][MAC_VAP_STATE_P2P_LISTEN]       = 0x33ADEECA;/* listen 状态接收其他bss 组播管理帧(probe req) */
...
oal_uint32  hmac_set_status_rx_filter_val(oal_uint uc_dev_mode, oal_uint uc_vap_mode, oal_uint uc_vap_status, oal_uint32 uc_val)
{
    ...
    {
        case 0:
            g_ast_normal_mode_rx_filter[uc_vap_mode][uc_vap_status] = uc_val;
            break;

        case 1:
            g_ast_repeater_mode_rx_filter[uc_vap_mode][uc_vap_status] = uc_val;
            break;
...
oal_uint32  hmac_get_status_rx_filter_val(oal_uint uc_dev_mode, oal_uint uc_vap_mode, oal_uint uc_vap_status)
{
    ...
    {
        case 0:
            uc_val = g_ast_normal_mode_rx_filter[uc_vap_mode][uc_vap_status];
            break;

        case 1:
            uc_val = g_ast_repeater_mode_rx_filter[uc_vap_mode][uc_vap_status];
            break;
