...
extern oal_bool_enum_uint8  hmac_dfs_recalculate_channel(
...
{
    pst_mac_device->st_dfs.st_dfs_info.us_dfs_off_chan_cac_opern_chan_dwell_time = ul_time_ms;
}
...
{
    pst_mac_device->st_dfs.st_dfs_info.us_dfs_off_chan_cac_off_chan_dwell_time = ul_time_ms;
}
