...
oal_void hmac_tx_sched_info_init(oal_void)
{
    ...
    g_hcc_flowctrl_stat[FRW_EVENT_TYPE_HMAC_HCC_TEST] = HCC_FC_WAIT;
}
...
oal_void hmac_adjust_netbuf_data(oal_netbuf_stru *pst_netbuf, mac_tx_ctl_stru *pst_tx_ctrl, frw_event_type_enum_uint8  en_nest_type, oal_uint8  uc_nest_sub_type)
{
       ...
       ((DMAC_WLAN_CTX_EVENT_SUB_TYPE_MGMT == uc_nest_sub_type) || (DMAC_WLAN_CTX_EVENT_SUB_TYPE_ACTION == uc_nest_sub_type)))
    {
        ...
        if(DMAC_WLAN_CTX_EVENT_SUB_TYPE_ACTION == uc_nest_sub_type)
        {
            OAM_WARNING_LOG1(0, OAM_SF_ANY, "{hmac_adjust_netbuf_data:action frame id[%d] tx from hmac to dmac.}", pst_tx_ctrl->bit_mgmt_frame_id);
        }
    }
                                    ...
                                    oal_uint32 queue_id)
{
    ...
    if(ul_headroom_add > 0)
    {
        ...
        ret = oal_netbuf_expand_head(pst_netbuf, (oal_int32) ul_headroom_add, 0, GFP_ATOMIC);
    ...
    if(HMAC_TO_DMAC_SYN_CFG == pst_event_hdr->uc_sub_type)
    {
        ...
        OAM_WARNING_LOG3(pst_event_hdr->uc_vap_id, OAM_SF_ANY, "{hmac_hcc_tx_netbuf::host send event type[%d],subtype[%d],cfgid[%d]}",
...
#ifdef CONFIG_PRINTK
    ret = hcc_tx(hcc_get_default_handler(), pst_netbuf, &st_hcc_transfer_param);
    if(OAL_WARN_ON(OAL_SUCC != ret))
    {
        oal_netbuf_free(pst_netbuf);
    }
...
frw_event_mem_stru * hmac_hcc_rx_netbuf_convert_to_event_all(frw_event_mem_stru *pst_hcc_event_mem)
{
    hcc_event_stru                  *pst_hcc_event_payload;
...
frw_event_mem_stru * hmac_common_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,0);
}

frw_event_mem_stru * hmac_rx_dmac_tx_event_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    hcc_event_stru                  *pst_hcc_event_payload;
    ...
    OAM_INFO_LOG2(0, OAM_SF_ANY, "{hmac_rx_dmac_tx_event_adapt::netbuf = %p, frame len = %d.}",
                  pst_ctx_event->pst_netbuf, pst_ctx_event->us_frame_len);

    return pst_event_mem;
}

frw_event_mem_stru * hmac_init_event_process_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_rx_dmac_tx_event_adapt(pst_hcc_event_mem);
}
...
frw_event_mem_stru * hmac_rx_process_tkip_mic_fail_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(dmac_to_hmac_mic_event_stru));
}



frw_event_mem_stru * hmac_mgmt_tbtt_event_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_common_rx_adapt(pst_hcc_event_mem);
}

/*****************************************************************************
 函 数 名  : hmac_dfs_radar_detect_event_rx_adapt
 功能描述  : hmac_dfs_radar_detect_event_rx_adapt接收适配
 输入参数  : 无
 输出参数  : 无
 返 回 值  : OAL_SUCC
 调用函数  :
...
frw_event_mem_stru *hmac_dfs_radar_detect_event_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_common_rx_adapt(pst_hcc_event_mem);
}
...
frw_event_mem_stru* hmac_scan_proc_scan_comp_event_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    /* 扫描完成事件，携带扫描运行信息 */
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem, OAL_SIZEOF(mac_scan_rsp_stru));
}

#ifdef _PRE_WLAN_FEATURE_20_40_80_COEXIST
frw_event_mem_stru* hmac_scan_proc_obss_scan_comp_event_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event_all(pst_hcc_event_mem);
}
#endif
...
#endif
frw_event_mem_stru* hmac_chan_result_event_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    /* liuming add test code */
   OAM_WARNING_LOG0(0, OAM_SF_ANY, "{hmac_chan_result_event_rx_adapt::rx adapt.}");
   return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(dmac_crx_chan_result_stru));
}
frw_event_mem_stru* dmac_proc_event_del_ba_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event_all(pst_hcc_event_mem);
}

frw_event_mem_stru* hmac_proc_event_syn_info_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(dmac_to_hmac_syn_info_event_stru));
}


frw_event_mem_stru* hmac_proc_event_config_syn_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event_all(pst_hcc_event_mem);
}


frw_event_mem_stru* hmac_mgmt_send_disasoc_deauth_event_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event_all(pst_hcc_event_mem);
}
...
frw_event_mem_stru* hmac_alg_ct_result_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event_all(pst_hcc_event_mem);
}
#endif
...
frw_event_mem_stru* hmac_proc_event_log_syn_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_rx_dmac_tx_event_adapt(pst_hcc_event_mem);
}


frw_event_mem_stru* hmac_scan_proc_scanned_bss_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_rx_dmac_tx_event_adapt(pst_hcc_event_mem);
}

#ifdef _PRE_WLAN_RF_110X_CALI_DPD
frw_event_mem_stru *hmac_dpd_data_cali_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    OAM_ERROR_LOG0(0, OAM_SF_CALIBRATE, "{hmac_dpd_data_cali_rx_adapt function called.}");
    return hmac_rx_dmac_tx_event_adapt(pst_hcc_event_mem);
}
#endif

frw_event_mem_stru* hmac_mgmt_rx_delba_event_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(dmac_ctx_action_event_stru));
}
#ifdef _PRE_WLAN_FEATURE_DFS
/*****************************************************************************
 函 数 名  : hmac_chan_restart_network_after_switch_rx_adapt
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
*****************************************************************************/
frw_event_mem_stru* hmac_switch_to_new_chan_complete_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(dmac_set_chan_stru));
}
#endif
...
*****************************************************************************/
frw_event_mem_stru* hmac_dbac_status_notify_rx_adapt(frw_event_mem_stru *pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem,OAL_SIZEOF(oal_bool_enum_uint8));
}


frw_event_mem_stru* hmac_proc_disasoc_misc_event_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    frw_event_mem_stru * pst_return_event;
    dmac_disasoc_misc_stru          *pst_disasoc_event;
    ...
    pst_return_event = hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem, OAL_SIZEOF(dmac_disasoc_misc_stru));
    if(NULL != pst_return_event)
    {
        pst_disasoc_event = (dmac_disasoc_misc_stru *)frw_get_event_payload(pst_return_event);
        OAM_WARNING_LOG2(0, OAM_SF_ANY, "{hmac_proc_disasoc_misc_event_rx_adapt::user_id=%d reason=%d}",
                    pst_disasoc_event->us_user_idx, pst_disasoc_event->en_disasoc_reason);
    }

    return pst_return_event;
}

#ifdef _PRE_WLAN_FEATURE_ROAM

frw_event_mem_stru* hmac_proc_roam_trigger_event_rx_adapt(frw_event_mem_stru * pst_hcc_event_mem)
{
    return hmac_hcc_rx_netbuf_convert_to_event(pst_hcc_event_mem, OAL_SIZEOF(oal_int8));
}
...
oal_uint32 hmac_test_hcc_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    dmac_tx_event_stru              *pst_event_payload;
    hcc_event_stru                  *pst_hcc_event;

    /*取业务事件信息*/
    pst_event_payload = (dmac_tx_event_stru *)frw_get_event_payload(pst_event_mem);

    pst_hcc_event = (hcc_event_stru*)pst_event_payload;

    /*netbuf 失败由被调函数释放!*/
    return hmac_hcc_tx_netbuf_auto(pst_event_mem, (oal_netbuf_stru*)pst_hcc_event->pst_netbuf,0);
}
...
oal_uint32 hmac_send_connect_result_to_dmac_sta_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
...
/*****************************************************************************
 函 数 名  : dmac_psm_opmode_notify_process_tx_adapt
 功能描述  : 通过SDIO下发帧过滤配置参数
...
*****************************************************************************/
oal_uint32 hmac_psm_opmode_notify_process_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
...
oal_uint32 hmac_proc_set_rx_filter_value_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    OAM_INFO_LOG0(0, OAM_SF_ANY, "{hmac_proc_set_rx_filter_value_tx_adapt::tx adapt.}");
    return hmac_hcc_tx_event_payload_to_netbuf(pst_event_mem, OAL_SIZEOF(oal_uint32));
}
...
oal_uint32 hmac_proc_common_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    return hmac_hcc_tx_event_payload_to_netbuf(pst_event_mem, OAL_SIZEOF(oal_uint16));
}

oal_uint32 hmac_proc_init_event_process_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    OAM_INFO_LOG0(0, OAM_SF_ANY, "{hmac_proc_init_event_process_tx_adapt}");
    return hmac_proc_common_tx_adapt(pst_event_mem);
}

oal_uint32 hmac_cfg_vap_send_event_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    OAM_INFO_LOG0(0, OAM_SF_ANY, "{hmac_cfg_vap_send_event_tx_adapt}");
    return hmac_proc_common_tx_adapt(pst_event_mem);
}
...
/*****************************************************************************
 函 数 名  : hmac_chan_restart_network_after_switch_tx_adapt
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
*****************************************************************************/
oal_uint32 hmac_chan_restart_network_after_switch_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    return hmac_proc_common_tx_adapt(pst_event_mem);
}
oal_uint32 hmac_psm_reset_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    return hmac_hcc_tx_event_payload_to_netbuf(pst_event_mem, OAL_SIZEOF(oal_uint16));
}

/*****************************************************************************
 函 数 名  : hmac_chan_disable_machw_tx_adapt
 功能描述  :
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
...
*****************************************************************************/
oal_uint32 hmac_chan_disable_machw_tx_adapt(frw_event_mem_stru *pst_event_mem)
{
    return hmac_proc_common_tx_adapt(pst_event_mem);
}
                                             ...
                                             hcc_netbuf_stru* pst_hcc_netbuf, oal_uint8 *pst_context)
{
    ...
    //oal_print_hex_dump((oal_uint8*)OAL_NETBUF_DATA(pst_hcc_netbuf->pst_netbuf), OAL_NETBUF_LEN(pst_hcc_netbuf->pst_netbuf),
     //                       32, "hmac rx action: ");
