...
*****************************************************************************/
oal_bool_enum_uint8  hmac_dfs_recalculate_channel(
                    ...
                    wlan_channel_bandwidth_enum_uint8   *pen_bandwidth)
{
    ...
    mac_get_channel_idx_from_num(pst_mac_device->en_max_band, *puc_freq, &uc_chan_idx);
...
oal_void  hmac_dfs_cac_start(mac_device_stru *pst_mac_device, hmac_vap_stru *pst_hmac_vap)
{
    ...
    pst_mac_device->st_dfs.st_dfs_info.uc_timer_cnt     = 0;
    pst_mac_device->st_dfs.st_dfs_info.uc_timer_end_cnt = ul_scan_time / HMAC_DFS_ONE_MIN_IN_MS;
...
#define HMAC_80MHZ_BITMAP_MASK     0xFFFFFF
    ...
    uc_random = (oal_uint8)(OAL_TIME_GET_STAMP_MS() % uc_available_chan_cnt);
    uc_idx = auc_available_chan_idx[uc_random];
...
oal_bool_enum_uint8 hmac_dfs_try_cac(hmac_device_stru *pst_hmac_device, mac_vap_stru *pst_mac_vap)
{
    ...
    mac_channel_stru *pst_channel  = pst_hmac_device->ast_best_channel;
#endif
