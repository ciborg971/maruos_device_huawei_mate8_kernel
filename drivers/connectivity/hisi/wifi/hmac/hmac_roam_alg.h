...
#define ROAM_BLACKLIST_TIME_OUT           (10000)       /* 黑名单超时时间 */
#define ROAM_BLACKLIST_COUNT_LIMIT        (2)           /* 黑名单超时时间 */

#define ROAM_HISTORY_BSS_TIME_OUT         (10000)       /* 黑名单超时时间 */
...
#define ROAM_RSSI_LINKLOSS_TYPE           (0)
...
typedef struct
{
    hmac_roam_bss_list_stru      st_blacklist;
    hmac_roam_bss_list_stru      st_history;
    oal_uint32                   ul_max_capacity;
    mac_bss_dscr_stru           *pst_max_capacity_bss;
    oal_int8                     c_current_rssi;
    oal_int8                     c_max_rssi;
    oal_uint8                    uc_another_bss_scaned;
    oal_uint8                    uc_invalid_scan_cnt;
    mac_bss_dscr_stru           *pst_max_rssi_bss;
}hmac_roam_alg_stru;
