...
oal_uint16 g_as_aggr_rx_encap = WLAN_AMPDU_RX_BA_LUT_WSIZE;
                ...
                oal_uint8               uc_tid)
{
    ...
    {
        OAM_ERROR_LOG3(0, OAM_SF_BA, "{hmac_mgmt_encap_addba_req::null param, %d %d %d.}", pst_vap, puc_data, pst_tx_ba);
        return OAL_ERR_CODE_PTR_NULL;
    }
                ...
                oal_uint8           uc_status)
{
    ...
    {
        OAM_ERROR_LOG3(0, OAM_SF_BA, "{hmac_mgmt_encap_addba_req::null param, %d %d %d.}", pst_vap, puc_data, pst_addba_rsp);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    us_ba_param |= (uc_tid << 2);                                   /* BIT2 */
#ifdef _PRE_WLAN_FEATURE_BTCOEX
    if(pst_hmac_device->st_dmac_to_hmac_btcoex_rx_delba.uc_bt_on)
    {
                ...
                mac_action_mgmt_args_stru  *pst_action_args)
{
    ...
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_req::pst_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    /* 申请ADDBA_REQ管理帧内存 */
    pst_addba_req = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
    if (OAL_PTR_NULL == pst_addba_req)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_req::pst_addba_req null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_req::pst_event_mem null.}");
    ...
    if (ul_ret != OAL_SUCC)
    {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_req::frw_event_dispatch_event failed[%d].}", ul_ret);
        oal_netbuf_free(pst_addba_req);
                ...
                oal_uint8                   uc_status)
{
    ...
    if (OAL_PTR_NULL == pst_device)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_rsp::send addba rsp failed, pst_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    /* 申请ADDBA_RSP管理帧内存 */
    pst_addba_rsp = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
    if (OAL_PTR_NULL == pst_addba_rsp)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_rsp::send addba rsp failed, pst_addba_rsp mem alloc failed.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (OAL_PTR_NULL == pst_event_mem)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_rsp::send addba rsp failed, pst_event_mem mem alloc failed.}");
    ...
    if (ul_ret != OAL_SUCC)
    {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_addba_rsp::send addba rsp failed, frw_event_dispatch_event failed[%d].}", ul_ret);
        oal_netbuf_free(pst_addba_rsp);
    }
    else
    {
                ...
                mac_action_mgmt_args_stru  *pst_action_args)
{
    ...
    if (OAL_PTR_NULL == pst_device)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_delba::pst_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    /* 申请DEL_BA管理帧内存 */
    pst_delba = OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
    if (OAL_PTR_NULL == pst_delba)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_delba::pst_delba null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (OAL_PTR_NULL == pst_event_mem)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_delba::pst_event_mem null.}");
        /* 释放管理帧内存到netbuf内存池 */
    ...
    if (ul_ret != OAL_SUCC)
    {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_tx_delba::frw_event_dispatch_event failed[%d].}", ul_ret);
        oal_netbuf_free(pst_delba);
        FRW_EVENT_FREE(pst_event_mem);
                ...
                oal_uint8                  *puc_payload)
{
    ...
    /* 11n以上能力才可接收ampdu */
    if (!(pst_hmac_vap->st_vap_base_info.en_protocol >= WLAN_HT_MODE))
    {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA,
                      "{hmac_mgmt_rx_addba_req::ampdu is not supprot or not open,protocol mode=%d.}", pst_hmac_vap->st_vap_base_info.en_protocol);
        return OAL_SUCC;
    }
    ...
    if (OAL_PTR_NULL == pst_device)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::addba req receive failed, pst_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::addba req receive failed, tid %d overflow.}", uc_tid);
        return OAL_ERR_CODE_ARRAY_OVERFLOW;
    }

    if (OAL_PTR_NULL != pst_hmac_user->ast_tid_info[uc_tid].pst_ba_rx_info)
    {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::addba req received, but tid [%d] already set up.}", uc_tid);
    ...
    if (OAL_PTR_NULL == pst_hmac_user->ast_tid_info[uc_tid].pst_ba_rx_info)
    {
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::addba req receive failed, pst_ba_rx_hdl mem alloc failed.tid[%d]}", uc_tid);
    ...
    pst_ba_rx_stru->st_alarm_data.uc_vap_id        = pst_hmac_vap->st_vap_base_info.uc_vap_id;
    ...
    OAM_WARNING_LOG4(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::process addba req receive and send addba rsp, uc_tid[%d], uc_status[%d], baw_start[%d], baw_size[%d]}\r\n",
                ...
                oal_uint8                  *puc_payload)
{
    ...
    OAM_INFO_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::enter func.}");

    /* 获取device结构 */
    pst_mac_device = mac_res_get_dev(pst_hmac_vap->st_vap_base_info.uc_device_id);
    if (OAL_UNLIKELY(OAL_PTR_NULL == pst_mac_device))
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::pst_mac_device null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    {
        /* 对于tid > 7的resp直接忽略 */
        OAM_WARNING_LOG3(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::addba rsp tid[%d]} token[%d] state[%d]", uc_tidno, puc_payload[2], puc_payload[3]);
        return OAL_SUCC;
    }
    ...
    if (DMAC_BA_INIT == pst_tid->st_ba_tx_info.en_ba_status)
    {
        ...
        OAM_WARNING_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::addba rsp is received when ba status is DMAC_BA_INIT.tid[%d]}", uc_tidno);
        return OAL_SUCC;
    }

    if ((DMAC_BA_COMPLETE == pst_tid->st_ba_tx_info.en_ba_status) || (uc_dialog_token != pst_tid->st_ba_tx_info.uc_dialog_token))
    {
        OAM_WARNING_LOG4(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::addba rsp is received whne ba status is DMAC_BA_COMPLETE or uc_dialog_token wrong.tid[%d], status[%d], rsp dialog[%d], req dialog[%d]}",
    ...
    if (OAL_PTR_NULL == pst_event_mem)
    {
        OAM_ERROR_LOG0(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_rsp::pst_event_mem null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    else
    {
        ...
        pst_rx_addba_rsp_event->us_baw_size      = ((puc_payload[5] & 0xC0) >> 6) | (puc_payload[6] << 2);
        ...
        pst_rx_addba_rsp_event->uc_ampdu_max_num = (oal_uint8)pst_rx_addba_rsp_event->us_baw_size;

        /* 当对端设备BA Buffer Size = 1时，避免uc_ampdu_max_num变为0 */
        if (0 == pst_rx_addba_rsp_event->uc_ampdu_max_num)
        {
            pst_rx_addba_rsp_event->uc_ampdu_max_num = 1;
        }
...
OAL_STATIC oal_uint32  hmac_ie_check_proc_opmode_param(mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify)
{
    ...
    {
        OAM_ERROR_LOG1(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{mac_ie_check_proc_opmode_param::rx_nss_type is over limit!rx_nss_type = [%d]!}\r\n", pst_opmode_notify->bit_rx_nss_type);
        return OAL_FAIL;
    }
    ...
    {
        OAM_ERROR_LOG3(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{mac_ie_check_proc_opmode_param::bit_rx_nss is over limit!pst_mac_user->en_bandwidth_cap = [%d], pst_mac_user->en_bandwidth_cap = [%d],rx_nss_type = [%d]!}\r\n",
                       pst_mac_user->en_bandwidth_cap, pst_mac_user->uc_num_spatial_stream, pst_opmode_notify->bit_rx_nss);
        return OAL_FAIL;
    }
    ...
    if (1 == pst_opmode_notify->bit_rx_nss_type)
    {
        ...
        {
            OAM_ERROR_LOG2(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{mac_ie_check_proc_opmode_param::bit_rx_nss is over limit!bit_num_bf_ant_supported = [%d],bit_rx_nss = [%d]!}\r\n",
...
oal_uint32  hmac_ie_proc_opmode_field(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify, oal_uint8 uc_mgmt_frm_type)
{
    ...
    {
        OAM_ERROR_LOG0(pst_mac_user->uc_vap_id, OAM_SF_ANY, "{mac_ie_check_proc_opmode_param::mac_ie_check_proc_opmode_param return fail!}\r\n");
        return OAL_FAIL;
    }
    ...
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_ie_proc_opmode_field::pst_mac_dev is null.}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    {
        OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_rx_nss = [%x], pst_mac_user->uc_avail_num_spatial_stream = [%x]!}\r\n",
    ...
    {
        OAM_INFO_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{mac_ie_proc_opmode_field::pst_opmode_notify->bit_channel_width = [%x], pst_mac_user->en_avail_bandwidth = [%x]!}\r\n",
                                                     ...
                                                     oal_uint16 us_init_trans_id)
{
    ...
    /* 申请SA Query 帧空间 */
    pst_sa_query = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
...
oal_void  hmac_mgmt_send_deauth_frame(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_da, oal_uint16 us_err_code, oal_bool_enum_uint8 en_is_protected)
{
    ...
    pst_deauth = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
    ...
    {
        if(OAL_SUCC == mac_vap_find_user_by_macaddr(pst_mac_vap, puc_da, &us_user_idx))
        {
            pst_hmac_vap = (hmac_vap_stru *)mac_res_get_hmac_vap(pst_mac_vap->uc_vap_id);
            if (OAL_PTR_NULL == pst_hmac_vap)
            {
    ...
    if (OAL_TRUE == en_is_protected)
    {
        mac_set_protectedframe((oal_uint8 *)OAL_NETBUF_HEADER(pst_deauth));
    }
#endif
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_AUTH,
                     "{hmac_mgmt_send_deauth_frame::Because of err_code[%d], send deauth frame to dest addr, da[0-2] %2x:%2x:%2x.}",
                     us_err_code, puc_da[0], puc_da[1], puc_da[2]);
    OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_AUTH,
                     "{hmac_mgmt_send_deauth_frame::da[3-5] %2x:%2x:%2x.}",
                     puc_da[3], puc_da[4], puc_da[5]);
...
oal_uint32  hmac_config_send_deauth(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_da)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_AUTH, "{hmac_config_send_deauth::mac_vap_find_user_by_macaddr failed[%d].}", ul_ret);
        return ul_ret;
    }
...
oal_void  hmac_mgmt_send_disassoc_frame(mac_vap_stru *pst_mac_vap,oal_uint8 *puc_da, oal_uint16 us_err_code, oal_bool_enum_uint8 en_is_protected)
{
    ...
    pst_disassoc = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
    ...
    if(OAL_PTR_NULL == pst_mac_vap->pst_mib_info)
    {
        ...
        OAM_ERROR_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_ASSOC, "{hmac_mgmt_send_disassoc_frame::pst_mib_info null, vap mode[%d] state[%d] user num[%d].}",
    ...
    OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_ASSOC,
                     "{hmac_mgmt_send_disassoc_frame::Because of err_code[%d], send disassoc frame to dest addr, da[0-2] %2x:%2x:%2x.}",
                     us_err_code, puc_da[0], puc_da[1], puc_da[2]);
    OAM_WARNING_LOG3(pst_mac_vap->uc_vap_id, OAM_SF_ASSOC,
                     "{hmac_mgmt_send_disassoc_frame::da[3-5] %2x:%2x:%2x.}",
                     puc_da[3], puc_da[4], puc_da[5]);
                ...
                hmac_user_stru                 *pst_hmac_user)
{
    ...
    if (OAL_PTR_NULL == pst_event_mem)
    {
        OAM_ERROR_LOG0(pst_hmac_user->st_user_base_info.uc_vap_id, OAM_SF_ASSOC,
                      "{hmac_mgmt_update_assoc_user_qos_table::pst_event_mem null.}");
        return;
    }
...
oal_void hmac_mgmt_update_11ac2g_cap(
                oal_uint8                      *puc_payload,
                hmac_user_stru                 *pst_hmac_user)
{
    mac_vendor_ie_stru *puc_vendor_ie;
    ...
    /* 检测到vendor ie*/
    puc_vendor_ie = (mac_vendor_ie_stru *)puc_payload;
    pst_hmac_user->st_hmac_cap_info.bit_11ac2g = puc_vendor_ie->st_ie.bit_11ac2g;
    return ;
}
#endif /* #ifdef _PRE_WLAN_FEATURE_11AC2G */
...
oal_void  hmac_rx_sa_query_req(hmac_vap_stru *pst_hmac_vap, oal_netbuf_stru *pst_netbuf, oal_bool_enum_uint8 en_is_protected)
{
    ...
    ul_ret = mac_vap_find_user_by_macaddr(&pst_hmac_vap->st_vap_base_info, puc_sa, &us_user_idx);
    if (OAL_SUCC != ul_ret)
    {
        OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_RX,
                       "{hmac_rx_sa_query_req::mac_vap_find_user_by_macaddr failed[%d].}", ul_ret);
        return;
    }
...
oal_void  hmac_rx_sa_query_rsp(hmac_vap_stru *pst_hmac_vap, oal_netbuf_stru *pst_netbuf, oal_bool_enum_uint8 en_is_protected)
{
     ...
     if (OAL_SUCC != ul_ret)
     {
         OAM_ERROR_LOG1(pst_hmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_AMPDU,
                        "{hmac_rx_sa_query_rsp::mac_vap_find_user_by_macaddr failed[%d].}", ul_ret);
         return ;
     }
     pst_hmac_user = mac_res_get_hmac_user(us_user_idx);
     if (OAL_PTR_NULL == pst_hmac_user)
...
oal_void  hmac_rx_notify_channel_width(mac_vap_stru *pst_mac_vap, oal_netbuf_stru *pst_netbuf)
{
    ...
    /* 根据发送端地找到对应AP USER结构 */
    ul_ret = mac_vap_find_user_by_macaddr(pst_mac_vap, auc_sta_addr, &us_user_idx);
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_2040,
                         "{hmac_rx_notify_channel_width::mac_vap_find_user_by_macaddr failed[%d].}", ul_ret);
        return;
    }
    ...
    if (OAL_PTR_NULL == pst_mac_user)
    {
        OAM_ERROR_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_2040, "{hmac_rx_notify_channel_width::pst_mac_user null.}");
        return;
    }
...
oal_uint32 hmac_wpas_mgmt_tx(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
   ...
   // oal_uint8                      *puc_da;
    ...
    /*  申请netbuf 空间*/
    pst_netbuf_mgmt_tx = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF, pst_mgmt_tx->us_len, OAL_TRUE);

    if(OAL_PTR_NULL == pst_netbuf_mgmt_tx)
    {
        /* Reserved Memory pool tried for high priority deauth frames */
        pst_netbuf_mgmt_tx = (oal_netbuf_stru *)OAL_MEM_NETBUF_ALLOC(OAL_NORMAL_NETBUF,WLAN_MEM_NETBUF_SIZE2, OAL_TRUE);
        if(OAL_PTR_NULL == pst_netbuf_mgmt_tx)
        {
...
oal_uint32  hmac_mgmt_tx_event_status(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_P2P, "{hmac_mgmt_tx_event_status::dmac tx mgmt status report.userindx[%d], tx mgmt status[%d]}",
                           pst_mgmt_tx_status_param->uc_user_idx, pst_mgmt_tx_status_param->uc_dscr_status);
...
oal_uint32 hmac_proc_ht_cap_ie(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, oal_uint8 *puc_ht_cap_ie)
{
    ...
    us_offset += MAC_HT_TXBF_CAP_LEN;

    /********************************************/
    /*  解析 ASEL Field(天线选择能力)           */
    /********************************************/
    us_offset += MAC_HT_ASEL_LEN;
...
oal_uint32  hmac_proc_vht_cap_ie(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user, oal_uint8 *puc_vht_cap_ie)
{
    ...
    {
        OAM_ERROR_LOG3(0, OAM_SF_ANY, "{mac_ie_proc_vht_cap_ie::param null,mac_vap[0x%x], hmac_user[0x%x], vht_cap_ie[0x%x].}", pst_mac_vap, pst_hmac_user, puc_vht_cap_ie);
...
#ifdef _PRE_WLAN_FEATURE_11AC2G
     /*11ac2g模式下，发现user不支持vht，关掉vht cap */
    if((OAL_TRUE == pst_mac_vap->st_cap_flag.bit_11ac2g)
        && (OAL_TRUE != pst_hmac_user->st_hmac_cap_info.bit_11ac2g))
    {
