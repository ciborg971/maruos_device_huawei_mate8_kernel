...
oal_void device_main_init(oal_void)
{
    ...
    PM_WLAN_IsrRegister();
    PM_WLAN_FuncRegister(device_psm_main_function,dmac_psm_check_txrx_state,dmac_psm_save_ps_state,
                          dmac_psm_recover_no_powerdown, dmac_psm_recover_ps_start_dma,dmac_psm_recover_powerdown,
