...
#define DTS_COMP_LG_ER69006A_VNS "hisilicon,mipi_lg_eR69006A_VNS"
...
static char lg_pwm_freq[] = {
	...
	0x94, 0xA8, 0xE9, 0xCB, 0xDB, 0xE9, 0xF5, 0xFC,
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "lg_eR69006A 5.9' CMD TFT\n");
...
static int mipi_lg_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_LG_ER69006A_VNS);
	if (!np) {
		HISI_FB_ERR("NOT FOUND device node %s!\n", DTS_COMP_LG_ER69006A_VNS);
		goto err_return;
	}
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_LG_ER69006A_VNS,
		.data = NULL,
	},
	{},
};
