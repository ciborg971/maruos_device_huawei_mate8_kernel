...
*/
static char manufacturer_command[] = {
	0xB0,
	0x00,
};

static char pixel_format[] = {
	0xB3,
	0x04, 0x10, 0x00, 0x00, 0x00,
};

static char interface_id[] = {
	0xB4,
	0x0C, 0x00,
};
...
static char display_setting1[] = {
	0xC1,
	0x84, 0x00, 0x10, 0xEF, 0xCB,
	0xF8, 0xFF, 0xFF, 0xDF, 0x9C,
	0xC5, 0x9A, 0x73, 0x8D, 0xAD,
	0x63, 0xFE, 0xFF, 0xFF, 0x8B,
	0xF1, 0x01, 0x00, 0xAA, 0x40,
	0x00, 0xC2, 0x01, 0x08, 0x00,
	0x01,
};

static char display_setting2[] = {
	0xC2,
	0x01, 0xF7, 0x80, 0x04, 0x63,
	0x00, 0x60, 0x00, 0x01, 0x30,
};

static char display_setting3[] = {
	0xC3,
	0x55, 0x01, 0x00, 0x01, 0x00,
	0x00,
};

static char source_timing_setting[] = {
	0xC4,
...
static char LTPS_timing_setting[] = {
	0xC6,
...
static char gamma_setting[] = {
	0xC7,
	0x2E, 0x34, 0x39, 0x3D, 0x45,
	0x4E, 0x55, 0x60, 0x43, 0x49,
	0x55, 0x62, 0x6B, 0x73, 0x7F,
	0x2E, 0x34, 0x39, 0x3D, 0x45,
	0x4E, 0x55, 0x60, 0x43, 0x49,
	0x55, 0x62, 0x6B, 0x73, 0x7F,
};

static char ditital_gamma_setting[] = {
	0xC8,
...
static char vbank_ctl[] = {
	0xC9,
	0x1F, 0x68, 0x1F, 0x68, 0x4C,
	0x4C, 0xC4, 0x11,
};

static char panel_PIN_ctl[] = {
	0xCB,
	0x0D, 0xFE, 0x1F, 0x2C, 0x00,
	0x00, 0x00, 0x00, 0x00,
};

static char panel_interface_ctl[] = {
	0xCC,
	0x04,
};

// power supply set
static char power_setting[] = {
	0xD0,
	0x3B, 0x01, 0x91, 0x0B, 0xD9,
	0x19, 0x19, 0x00, 0x00, 0x00,
	0x99, 0x99, 0x00, 0x00, 0x00,
	0x00,
};

static char interface_power_setting[] = {
	0xD3,
	0x1B, 0x3B, 0xBB, 0xAD, 0xA5,
	0x33, 0x33, 0x33, 0x00, 0x80,
	0xA2, 0xA4, 0x6F, 0x6F, 0x33,
	0x33, 0x33, 0xF7, 0xF2, 0x1F,
	0x7D, 0x7C, 0xFF, 0x0F, 0x99,
	0x00, 0xFF, 0xFF,
};

static char driving_option[] = {
	0xD4,
	0x57, 0x33, 0x03,
};

static char vcom_setting[] = {
	0xD5,
	0x00, 0x00, 0x00, 0x01, 0x4A,
	0x01, 0x4A, 0x00, 0x6E, 0x00,
	0x6E,
};

static char NVM_load_setting[] = {
	0xD6,
	0x01,
};
...
static char stable_touch[] = {
	0xC1,
	0x84, 0x00, 0x10, 0xEF, 0xCB,
	0xF8, 0xFF, 0xFF, 0xDF, 0x9C,
	0xCF, 0x9A, 0x73, 0x8D, 0xFD,
	0x63, 0xFE, 0xFF, 0xFF, 0x8B,
	0xF1, 0x01, 0x00, 0xAA, 0x40,
	0x00, 0xC2, 0x01, 0x08, 0x00,
	0x01,
...
// Deep standby set
/*static char deep_standby[] = {
	0xB1,
	0x01,
};*/

static struct dsi_cmd_desc jdi_initial_set[] = {
	{DTYPE_GEN_WRITE2, 0, 10, WAIT_TYPE_US,
		sizeof(manufacturer_command), manufacturer_command},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(pixel_format), pixel_format},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(interface_id), interface_id},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(DSI_control), DSI_control},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(display_setting1), display_setting1},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(display_setting2), display_setting2},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(display_setting3), display_setting3},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(source_timing_setting), source_timing_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(LTPS_timing_setting), LTPS_timing_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(gamma_setting), gamma_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(ditital_gamma_setting), ditital_gamma_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(vbank_ctl), vbank_ctl},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(panel_PIN_ctl), panel_PIN_ctl},
	{DTYPE_GEN_WRITE2, 0, 10, WAIT_TYPE_US,
		sizeof(panel_interface_ctl), panel_interface_ctl},
};

static struct dsi_cmd_desc jdi_power_supply_set[] = {
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(power_setting), power_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(interface_power_setting), interface_power_setting},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(driving_option), driving_option},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(vcom_setting), vcom_setting},
	{DTYPE_GEN_WRITE2, 0, 10, WAIT_TYPE_US,
		sizeof(NVM_load_setting), NVM_load_setting},
};
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "jdi_eR69006A 5.5' CMD TFT\n");
...
err_gpio_request:
	...
	mipi_dsi_cmds_tx(jdi_initial_set, \
		ARRAY_SIZE(jdi_initial_set), mipi_dsi0_base);
	mipi_dsi_cmds_tx(jdi_power_supply_set, \
		ARRAY_SIZE(jdi_power_supply_set), mipi_dsi0_base);
	mipi_dsi_cmds_tx(jdi_display_on_cmds, \
		ARRAY_SIZE(jdi_display_on_cmds), mipi_dsi0_base);
...
static int mipi_jdi_probe(struct platform_device *pdev)
{
	...
	pinfo->dirty_region_info.w_align = 8;
