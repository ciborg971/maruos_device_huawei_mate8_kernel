...
static struct dsi_cmd_desc lcd_display_on_cmd[] = {
	...
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(set_ledpwm_duty), set_ledpwm_duty},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(bl_enable), bl_enable},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(cabc_off), cabc_off},
	{DTYPE_DCS_WRITE1, 0, 2, WAIT_TYPE_MS, sizeof(select_page_cmd1), select_page_cmd1},
