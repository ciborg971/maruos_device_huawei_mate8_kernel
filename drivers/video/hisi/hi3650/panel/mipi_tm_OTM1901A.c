...
#define DTS_COMP_TM_OTM1901A "hisilicon,mipi_tm_OTM1901A"
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "tm_OTM1901A 5.5' VIDEO TFT 1080 x 1920\n");
...
static ssize_t mipi_tm_panel_lcd_mipi_detect_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static ssize_t mipi_tm_panel_lcd_hkadc_debug_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
...
static ssize_t mipi_tm_panel_lcd_hkadc_debug_store(struct platform_device *pdev,
	const char *buf, size_t count)
{
	int ret = 0;
	int channel = 0;
...
static ssize_t mipi_tm_panel_lcd_gram_check_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static ssize_t mipi_tm_panel_lcd_gram_check_store(struct platform_device *pdev,
	const char *buf, size_t count)
{
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static struct hisi_fb_panel_data g_panel_data = {
	...
	.lcd_mipi_detect = mipi_tm_panel_lcd_mipi_detect_show,
	.lcd_hkadc_debug_show = mipi_tm_panel_lcd_hkadc_debug_show,
	.lcd_hkadc_debug_store = mipi_tm_panel_lcd_hkadc_debug_store,
	.lcd_gram_check_show = mipi_tm_panel_lcd_gram_check_show,
	.lcd_gram_check_store = mipi_tm_panel_lcd_gram_check_store,
...
static int mipi_tm_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_TM_OTM1901A);
	if (!np) {
		HISI_FB_ERR("not found device node %s!\n", DTS_COMP_TM_OTM1901A);
		goto err_return;
	}
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_TM_OTM1901A,
		.data = NULL,
	},
	{},
};
