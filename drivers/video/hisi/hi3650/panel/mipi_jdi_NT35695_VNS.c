...
#define DTS_COMP_JDI_NT35695_VNS "hisilicon,mipi_jdi_NT35695_VNS"
...
static int mipi_jdi_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_JDI_NT35695_VNS);
	if (!np) {
		HISI_FB_ERR("not found device node %s!\n", DTS_COMP_JDI_NT35695_VNS);
		goto err_return;
	}
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_JDI_NT35695_VNS,
		.data = NULL,
	},
	{},
};
