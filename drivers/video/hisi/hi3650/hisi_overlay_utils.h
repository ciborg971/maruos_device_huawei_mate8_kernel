...
extern uint32_t g_dss_module_cap[DSS_CHN_MAX][MODULE_CAP_MAX];
extern uint32_t g_dss_mif_sid_map[DSS_CHN_MAX];
extern uint32_t g_dss_smmu_smrx_idx[DSS_CHN_MAX];
extern int g_scf_lut_chn_coef_idx[DSS_CHN_MAX];
