...
typedef struct dss_smmu {
	...
	uint8_t smmu_smrx_used[DSS_CHN_MAX];
} dss_smmu_t;
...
typedef struct dss_module_reg {
	char __iomem *aif_ch_base[DSS_CHN_MAX];
	char __iomem *aif1_ch_base[DSS_CHN_MAX];
	char __iomem *mif_ch_base[DSS_CHN_MAX];
	char __iomem *dma_base[DSS_CHN_MAX];
	char __iomem *dfc_base[DSS_CHN_MAX];
	char __iomem *scl_base[DSS_CHN_MAX];
	char __iomem *sharp_base[DSS_CHN_MAX];
	char __iomem *post_clip_base[DSS_CHN_MAX];
	char __iomem *ce_base[DSS_CHN_MAX];
	char __iomem *csc_base[DSS_CHN_MAX];
	char __iomem *ov_base[DSS_OVL_IDX_MAX];
	char __iomem *mctl_base[DSS_OVL_IDX_MAX];
	dss_mctl_ch_base_t mctl_ch_base[DSS_CHN_MAX];
	char __iomem *mctl_sys_base;
	char __iomem *smmu_base;
	char __iomem *post_scf_base;

	dss_aif_t aif[DSS_CHN_MAX];
	dss_aif_t aif1[DSS_CHN_MAX];
	dss_aif_bw_t aif_bw[DSS_CHN_MAX];
	dss_aif_bw_t aif1_bw[DSS_CHN_MAX];
	dss_mif_t mif[DSS_CHN_MAX];
	dss_rdma_t rdma[DSS_CHN_MAX];
	dss_wdma_t wdma[DSS_CHN_MAX];
	dss_dfc_t dfc[DSS_CHN_MAX];
	dss_scl_t scl[DSS_CHN_MAX];
	dss_sharpness_t sharp[DSS_CHN_MAX];
	dss_post_clip_t post_clip[DSS_CHN_MAX];
	dss_ce_t ce[DSS_CHN_MAX];
	dss_csc_t csc[DSS_CHN_MAX];
	dss_ovl_t ov[DSS_OVL_IDX_MAX];
	dss_mctl_t mctl[DSS_OVL_IDX_MAX];
	dss_mctl_ch_t mctl_ch[DSS_CHN_MAX];
	dss_mctl_sys_t mctl_sys;
	dss_smmu_t smmu;
	dirty_region_updt_t dirty_region_updt;
	dss_scl_t post_scf;

	uint8_t aif_ch_used[DSS_CHN_MAX];
	uint8_t aif1_ch_used[DSS_CHN_MAX];
	uint8_t mif_used[DSS_CHN_MAX];
	uint8_t dma_used[DSS_CHN_MAX];
	uint8_t dfc_used[DSS_CHN_MAX];
	uint8_t scl_used[DSS_CHN_MAX];
	uint8_t sharp_used[DSS_CHN_MAX];
	uint8_t post_cilp_used[DSS_CHN_MAX];
	uint8_t ce_used[DSS_CHN_MAX];
	uint8_t csc_used[DSS_CHN_MAX];
	uint8_t ov_used[DSS_OVL_IDX_MAX];
	uint8_t ch_reg_default_used[DSS_CHN_MAX];
	uint8_t mctl_used[DSS_OVL_IDX_MAX];
	uint8_t mctl_ch_used[DSS_CHN_MAX];
...
typedef struct dss_mmbuf_info {
	uint32_t mm_base[DSS_CHN_MAX];
	uint32_t mm_size[DSS_CHN_MAX];

	uint8_t mm_used[DSS_CHN_MAX];
} dss_mmbuf_info_t;
