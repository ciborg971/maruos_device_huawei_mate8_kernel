...
static int wifipro_rtt_monitor_init(void);
...
static int __init wifipro_tcp_monitor_module_init(void)
{
    ...
    WIFIPRO_ERROR("wifipro_rtt_monitor_init started\n");
    if( 0 != wifipro_rtt_monitor_init() ) {
        WIFIPRO_ERROR("wifipro_rtt_monitor_init failed");
        return -1;
    }
...
int wifipro_get_srtt() {
    return wifipro_rtt_average;
}
