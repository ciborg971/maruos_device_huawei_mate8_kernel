...
#define PAGE_GPIO21                0xc000
#define PAGE_PERICRG               0xd000

#define PAGE_TYPE_MASK             0xF000
#define PAGE_VALUE_MASK            0x0FFF

/* codec page */
#define HI6555C_PAGE_0_START         (PAGE_SoCCODEC + 0x00)
#define HI6555C_PAGE_0_END           (PAGE_SoCCODEC + 0x88)
#define HI6555C_PAGE_0C_START        (PAGE_SoCCODEC + 0xE8)
#define HI6555C_PAGE_0C_END          (PAGE_SoCCODEC + 0xFC)
#define HI6555C_PAGE_1_START         (PAGE_SmartStarCODEC + 0x1b0)
#define HI6555C_PAGE_1_END           (PAGE_SmartStarCODEC + 0x1e4)
#define HI6555C_PAGE_2_START         (PAGE_SmartStarHKADC + 0x00)
#define HI6555C_PAGE_2_END           (PAGE_SmartStarHKADC + 0x09)
#define HI6555C_PAGE_4_START         (PAGE_PMCTRL + 0x29)
#define HI6555C_PAGE_4_END           (PAGE_PMCTRL + 0x31)
#define HI6555C_PAGE_4C_START        (PAGE_PMCTRL + 0x69)
#define HI6555C_PAGE_4C_END          (PAGE_PMCTRL + 0x6B)
#define HI6555C_PAGE_4L_START        (PAGE_PMCTRL + 0x71)
#define HI6555C_PAGE_4L_END          (PAGE_PMCTRL + 0x87)
#define HI6555C_PAGE_4L1             (PAGE_PMCTRL + 0x71)
#define HI6555C_PAGE_4L5             (PAGE_PMCTRL + 0x76)
#define HI6555C_PAGE_4L12            (PAGE_PMCTRL + 0x7D)
#define HI6555C_PAGE_4L15            (PAGE_PMCTRL + 0x80)
#define HI6555C_PAGE_4L18            (PAGE_PMCTRL + 0x83)
 ...
 ****************************************************************************/
/* 寄存器说明：版本寄存器 */
#define HI6555C_SMT_VERSION_ADDR                        ((PAGE_SmartStarCODEC) + (0x1B0))
/* 版本寄存器，表示版本为100 */
...
/* 寄存器说明：时钟使能配置寄存器 */
#define HI6555C_SMT_CLK_EN_CFG_ADDR                     ((PAGE_SmartStarCODEC) + (0x1B1))
/* DACL时钟使能：
0：关闭时钟；
1：打开时钟。 */
...
/* 寄存器说明：数模接口时钟沿选择 */
#define HI6555C_SMT_CLK_EDGE_CFG_ADDR                   ((PAGE_SmartStarCODEC) + (0x1B2))
/* DACL时钟沿选择：
0：反沿；
1：与模拟部分分频时钟同沿。 */
...
/* 寄存器说明：环回控制 */
#define HI6555C_SMT_LOOPBACK_CFG_ADDR                   ((PAGE_SmartStarCODEC) + (0x1B3))
/* DAC通道数据环回控制：
1'b0：数据来自于串行接口；
...
/* 寄存器说明：模拟中断原始状态寄存器 */
#define HI6555C_SMT_ANA_IRQ_SIG_STAT_ADDR               ((PAGE_SmartStarCODEC) + (0x1B4))
...
#define HI6555C_SMT_ANA_IRQM_REG0_ADDR                  ((PAGE_SmartStarCODEC) + (0x1B5))
/* [7]:耳机拔出检测中断屏蔽位：
[6]:耳机插入检测中断屏蔽位：
[5]:ECO模式下按键按下中断屏蔽位：
[4]:ECO模式下按键释放中断屏蔽位：
...
#define HI6555C_SMT_ANA_IRQ_REG0_ADDR                   ((PAGE_SmartStarCODEC) + (0x1B6))
/* 耳机按键释放中断，检测高电平有效；
1：写1时清除中断，查询时表示中断有效；
0：查询时表示中断无效。 */
...
#define HI6555C_SMT_DEB_CNT_HS_DET_CFG_ADDR             ((PAGE_SmartStarCODEC) + (0x1B7))
/* 去抖动周期计数器，以32k时钟计数
周期为1ms*计数值。
默认周期为20*1ms = 20ms
延时范围：0~32ms */
...
#define HI6555C_SMT_DEB_CNT_HS_MIC_CFG_ADDR             ((PAGE_SmartStarCODEC) + (0x1B8))
/* 去抖动周期计数器，以32k时钟计数
周期为1ms*计数值。
默认周期为10*1ms = 10ms
延时范围：0~32ms */
...
/* 寄存器说明：reserved */
#define HI6555C_SMT_CODEC_DIG_RES02_ADDR                ((PAGE_SmartStarCODEC) + (0x1B9))


/* 寄存器说明：reserved */
#define HI6555C_SMT_CODEC_DIG_RES03_ADDR                ((PAGE_SmartStarCODEC) + (0x1BA))


/* 寄存器说明：ADC通路PD信号 */
#define HI6555C_SMT_CODEC_ANA_RW01_ADDR                 ((PAGE_SmartStarCODEC) + (0x1BB))
...
#define HI6555C_SMT_CODEC_ANA_RW02_ADDR                 ((PAGE_SmartStarCODEC) + (0x1BC))
...
#define HI6555C_SMT_CODEC_ANA_RW03_ADDR                 ((PAGE_SmartStarCODEC) + (0x1BD))
...
/* 寄存器说明：VREF电阻选择信号 */
#define HI6555C_SMT_CODEC_ANA_RW04_ADDR                 ((PAGE_SmartStarCODEC) + (0x1BE))
...
#define HI6555C_SMT_CODEC_ANA_RW05_ADDR                 ((PAGE_SmartStarCODEC) + (0x1BF))
...
#define HI6555C_SMT_CODEC_ANA_RW06_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C0))
...
#define HI6555C_SMT_CODEC_ANA_RW07_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C1))
...
#define HI6555C_SMT_CODEC_ANA_RW08_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C2))
...
#define HI6555C_SMT_CODEC_ANA_RW09_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C3))
...
#define HI6555C_SMT_CODEC_ANA_RW10_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C4))
...
/* 寄存器说明：ADCL时序控制信号 */
#define HI6555C_SMT_CODEC_ANA_RW11_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C5))
...
/* 寄存器说明：ADCR时序控制信号 */
#define HI6555C_SMT_CODEC_ANA_RW12_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C6))
...
#define HI6555C_SMT_CODEC_ANA_RW13_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C7))
...
#define HI6555C_SMT_CODEC_ANA_RW14_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C8))
...
#define HI6555C_SMT_CODEC_ANA_RW15_ADDR                 ((PAGE_SmartStarCODEC) + (0x1C9))
...
#define HI6555C_SMT_CODEC_ANA_RW16_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CA))
...
#define HI6555C_SMT_CODEC_ANA_RW17_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CB))
...
#define HI6555C_SMT_CODEC_ANA_RW18_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CC))
...
#define HI6555C_SMT_CODEC_ANA_RW19_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CD))
...
#define HI6555C_SMT_CODEC_ANA_RW20_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CE))
...
/* 寄存器说明：防POP电路控制信号 */
#define HI6555C_SMT_CODEC_ANA_RW21_ADDR                 ((PAGE_SmartStarCODEC) + (0x1CF))
...
#define HI6555C_SMT_CODEC_ANA_RW22_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D0))
...
#define HI6555C_SMT_CODEC_ANA_RW23_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D1))
...
#define HI6555C_SMT_CODEC_ANA_RW24_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D2))
...
#define HI6555C_SMT_CODEC_ANA_RW25_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D3))
...
#define HI6555C_SMT_CODEC_ANA_RW26_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D4))
...
#define HI6555C_SMT_CODEC_ANA_RW27_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D5))
...
#define HI6555C_SMT_CODEC_ANA_RW28_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D6))
...
#define HI6555C_SMT_CODEC_ANA_RW29_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D7))
/* MIXER_HP的电流控制信号:
000: 2.5uA；
001: 3uA；
010: 3.5uA；
...
#define HI6555C_SMT_CODEC_ANA_RW30_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D8))
...
#define HI6555C_SMT_CODEC_ANA_RW31_ADDR                 ((PAGE_SmartStarCODEC) + (0x1D9))
...
#define HI6555C_SMT_CODEC_ANA_RW32_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DA))
...
#define HI6555C_SMT_CODEC_ANA_RW33_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DB))
...
#define HI6555C_SMT_CODEC_ANA_RW34_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DC))
...
#define HI6555C_SMT_CODEC_ANA_RW35_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DD))
...
#define HI6555C_SMT_CODEC_ANA_RW36_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DE))
...
#define HI6555C_SMT_CODEC_ANA_RW37_ADDR                 ((PAGE_SmartStarCODEC) + (0x1DF))
...
#define HI6555C_SMT_CODEC_ANA_RW38_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E0))
/* DACR上电控制信号(DACR_PD)：
0：PD；
1：正常工作; */
...
#define HI6555C_SMT_CODEC_ANA_RW39_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E1))
/* EAR上电控制信号(EAR_PD)：
0：PD；
1：正常工作; */
...
#define HI6555C_SMT_CODEC_ANA_RW40_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E2))
/*  */
...
#define HI6555C_SMT_CODEC_ANA_RO01_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E3))
/*  */
...
#define HI6555C_SMT_CODEC_ANA_RO02_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E4))
/*  */
#define    HI6555C_SMT_CODEC_ANA_RO02_BIT_START  (0)
#define    HI6555C_SMT_CODEC_ANA_RO02_BIT_END    (7)

/* 寄存器说明：CODEC_ANA_RW41 */
#define HI6555C_SMT_CODEC_ANA_RW41_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E5))

/* 寄存器说明：CODEC_ANA_RW42 */
#define HI6555C_SMT_CODEC_ANA_RW42_ADDR                 ((PAGE_SmartStarCODEC) + (0x1E6))

/* 寄存器说明：CODEC_CLASSD_CTRL3 */
#define HI6555C_PMU_CODEC_CLASSD_CTRL3_ADDR             ((PAGE_PMCTRL) + (0x6B))
#define    HI6555C_PMU_CODEC_CLASSD_DRV_EN_BIT  (4)
#define    HI6555C_PMU_CODEC_EN_CLASSD_INT_BIT  (3)


/* 寄存器说明：CODEC_CLASSD_CTRL1 */
#define HI6555C_PMU_CODEC_CLASSD_CTRL1_ADDR             ((PAGE_PMCTRL) + (0x69))
#define    HI6555C_PMU_CODEC_CLASSD_GAIN_BIT_START  (0)
#define    HI6555C_PMU_CODEC_CLASSD_GAIN_BIT_END    (1)
#define    HI6555C_PMU_CODEC_CLASSD_I_OCP_BIT_START (2)
#define    HI6555C_PMU_CODEC_CLASSD_I_OCP_BIT_END   (3)
#define    HI6555C_PMU_CODEC_CLASSD_MUTE_SEL_BIT    (4)
#define    HI6555C_PMU_CODEC_CLASSD_MUTE_BIT        (5)

/* */
//#define HI6555C_PSCTRL_CLKEN12_ADDR  ((PAGE_PeriSCTRL) + SOC_PERI_SCTRL_SC_PERIPH_CLKEN12_ADDR(0))
//#define HI6555C_CODEC_SOC_BIT_START  (SOC_PERI_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_codec_soc_START)

//#define HI6555C_PSCTRL_CLKEN1_ADDR  ((PAGE_PeriSCTRL) + SOC_PERI_SCTRL_SC_PERIPH_CLKEN1_ADDR(0))
//#define HI6555C_CLKEN1_DIGACODEC_BIT_START  (SOC_PERI_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_digacodec_START)

//#define HI6555C_PSCTRL_RSTDIS1_ADDR  ((PAGE_PeriSCTRL) + SOC_PERI_SCTRL_SC_PERIPH_RSTDIS1_ADDR(0))
//#define HI6555C_RSTDIS1_DIGACODE_BIT_START  (SOC_PERI_SCTRL_SC_PERIPH_RSTDIS1_periph_rstdis1_digacodec_START)

#define HI6555C_PSCTRL_RSTDIS2_ADDR    ((PAGE_PeriSCTRL) + SOC_CRGPERIPH_PEREN3_ADDR(0))
...
#define HI6555C_DBG_SIZE_PAGE         2048
