...
struct hi6402_priv {
	...
	track_state                  voiceup_8k_state;
	track_state                  voiceup_16k_state;
	track_state                  capture_state;
	s1s3_up_state_t              s1s3_up_state;
	track_state                  voicedown_state;
	int mic_num;
};
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		mdelay(2);
		slimbus_switch_framer(SLIMBUS_DEVICE_HI6402, SLIMBUS_DEVICE_HI6402);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* slimbus master framer is soc */
		slimbus_switch_framer(SLIMBUS_DEVICE_HI6402, SLIMBUS_DEVICE_SOC);
		mdelay(2);
...
static ssize_t hi6402_read(struct file *file, char __user *user_buf,
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	pr_info("[%s:%d], event:0x%x, \n", __FUNCTION__, __LINE__, event);

	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_0, HI6402_FS_SLIM_P01_48K);
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	struct hi6402_priv   *priv = snd_soc_codec_get_drvdata(codec);
	slimbus_track_param_t  *slimbus_params = &(priv->voice_params);
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (slimbus_params->rate == 8000) {
			/* sample rate  8K */
			hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_4, 0);
		} else if (slimbus_params->rate == 16000) {
			/* sample rate  16K */
			hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_4, 0x11);
		}
		...
		*/
		...
		hi6402_dapm_reg_clr_bit(codec, HI6402_DACL_MIXER_SEL_0, HI6402_DACL_MIXER_MDM_BIT);
		hi6402_dapm_reg_clr_bit(codec, HI6402_DACR_MIXER_SEL_0, HI6402_DACR_MIXER_MDM_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		...
		hi6402_dapm_reg_set_bit(codec, HI6402_DACL_MIXER_SEL_0, HI6402_DACL_MIXER_MDM_BIT);
		hi6402_dapm_reg_set_bit(codec, HI6402_DACR_MIXER_SEL_0, HI6402_DACR_MIXER_MDM_BIT);
		break;
	default :
		pr_warn("%s : power mode event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		/* sample rate  48k */
		hi6402_dapm_reg_write_bits(codec, HI6402_SC_FS_SLIM_CTRL_7, 0x44, 0x77);
		hi6402_dapm_reg_set_bit(codec, HI6402_SC_RES_RW_REG_2, 0x6);
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_S1_FS_CFG_L, HI6402_PORT_CLK_EN);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S1_FS_CFG_L, HI6402_PORT_CLK_EN);
		break;
	default :
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC1R_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC1R_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC1L_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC1L_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC0R_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC0R_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC0L_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_DAC_ADC_CLK_REG, HI6402_ADC0L_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_PGA_OL_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_PGA_OL_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_PGA_OR_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_PGA_OR_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_S3_MODULE_CLK_REG, HI6402_S3_PGA_OL_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S3_MODULE_CLK_REG, HI6402_S3_PGA_OL_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		hi6402_dapm_reg_set_bit(codec, HI6402_S3_MODULE_CLK_REG, HI6402_S3_PGA_OR_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S3_MODULE_CLK_REG, HI6402_S3_PGA_OR_EN_BIT);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
        ...
        struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		break;
	case SND_SOC_DAPM_POST_PMD:
		pr_info("%s: modem audio test finished, do nothing.\n", __FUNCTION__);
		break;
	default :
		pr_warn("%s : event err : %d\n", __FUNCTION__, event);
		break;
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		hi6402_dapm_reg_set_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_SRC_OL_EN_BIT);
		break;
	case SND_SOC_DAPM_POST_PMD:
		hi6402_dapm_reg_clr_bit(codec, HI6402_S1_MODULE_CLK_REG, HI6402_S1_SRC_OL_EN_BIT);
...
static void hi6402_s1s3_up_state_switch(struct snd_soc_codec *codec, struct hi6402_priv *priv)
{
	...
	case S1S3_UP_AUDIO_CAPTURE:
		...
		/* sample rate  48K */
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_1, HI6402_FS_SLIM_P23_48K);
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_5, 0x44);
		hi6402_dapm_reg_write_bits(codec, HI6402_SC_RES_RW_REG_2, 0x11, 0x11);
		hi6402_dapm_reg_set_bit(codec, HI6402_SLIM_CTRL3, HI6402_SLIM_CTRL3_BIT1);
	...
	case S1S3_UP_VOICEUP_16K:
		...
		/* sample rate  16k */
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_1, 0x11);
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_5, 0x11);
		hi6402_dapm_reg_write_bits(codec, HI6402_SC_RES_RW_REG_2, 0x11, 0x11);
	...
	case S1S3_UP_VOICEUP_8K:
		...
		/* sample rate  8k */
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_1, 0);
		hi6402_dapm_reg_write(codec, HI6402_SC_FS_SLIM_CTRL_5, 0);
		hi6402_dapm_reg_write_bits(codec, HI6402_SC_RES_RW_REG_2, 0x11, 0x11);
		slimbus_track_configure(SLIMBUS_DEVICE_HI6402, SLIMBUS_TRACK_VOICE_UP, NULL);
		slimbus_track_activate(SLIMBUS_DEVICE_HI6402, SLIMBUS_TRACK_VOICE_UP);
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	pr_info("[%s:%d] event:%#x ch:%d, audio:%#x, 16k:%#x, 8k:%#x !\n",__FUNCTION__, __LINE__,
		event, priv->mic_num, priv->capture_state, priv->voiceup_16k_state, priv->voiceup_8k_state);
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	BUG_ON(NULL == codec);
	BUG_ON(NULL == priv);
	pr_info("[%s:%d] event:%#x audio:%#x, 16k:%#x, 8k:%#x !\n",__FUNCTION__, __LINE__,
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if(check_anc_hs_support()) {
			anc_hs_5v_control(ANC_HS_ENABLE_5VOLTATE);
		}
#endif
...
#ifdef ANC_HEADSET
		if(check_anc_hs_support()) {
			anc_hs_5v_control(ANC_HS_DISABLE_5VOLTATE);
		}
#endif
		break;
	default :
...
{
	/* S1-S4 I2S INIT */
	hi6402_dapm_reg_write_bits(codec, 0x1000, 0x000000A0, 0x000000F0);
	hi6402_dapm_reg_set_bit(codec, HI6402_AUD_CLK_EN_PAGE, HI6402_AUD_CLK_EN_BIT);
	hi6402_dapm_reg_write(codec, HI6402_S_PORT_IN_SEL, 0x33);
	...
	hi6402_dapm_reg_write(codec, HI6402_CODEC_MUX_SEL4_0, 0x00);
	hi6402_dapm_reg_write(codec, HI6402_CODEC_MUX_SEL4_1, 0x11);
	hi6402_dapm_reg_write(codec, HI6402_CODEC_MUX_SEL4_2, 0x22);
	hi6402_dapm_reg_write(codec, HI6402_CODEC_MUX_SEL4_3, 0x33);
	...
	hi6402_dapm_reg_write(codec, HI6402_ANA_REG31, 0x7);
...
static int hi6402_soc_probe(struct snd_soc_codec *codec)
{
	...
	priv->voiceup_16k_state = TRACK_FREE;
	priv->s1s3_up_state = S1S3_UP_NULL;
	priv->voicedown_state = TRACK_FREE;
	...
	/* for sound triger */
	snd_jack_set_key(hs_jack.jack, SND_JACK_BTN_5, KEY_F14); /* F14 mapping SOUNDTRIGGER_1 EVENT in Generic.kl */
#endif
...
static int hi6402_codec_probe(struct platform_device *pdev)
{
	...
	if (!(priv->codec_reg_ref_delay_wq)) {
		pr_err("%s : codec_reg_ref_delay_wq create failed!\n", __FUNCTION__);
        HiLOGE("audio", "Hi6402", "%s : codec_reg_ref_delay_wq create failed!\n", __FUNCTION__);

		ret = -ENOMEM;
		goto delay_wq_err_exit;
	}
	...
	ret = snd_soc_register_codec(dev, &soc_codec_dev_hi6402,
			hi6402_dai, ARRAY_SIZE(hi6402_dai));

	if (0 != ret) {
		pr_err("%s : snd_soc_register_codec create failed!\n", __FUNCTION__);
		goto snd_soc_register_codec_exit;
	}

	return ret;

snd_soc_register_codec_exit:
	if(priv->codec_reg_ref_delay_wq) {
